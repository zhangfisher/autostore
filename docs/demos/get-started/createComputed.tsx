// docs\demos\get-started\createComputed.tsx
    ...
    orders: [
        {
            ...
            count: 1,
            // 小计
            total: (scope: any) => Math.floor(scope.price * scope.count),
        },
    ],
    // 总计
    total: (scope: any) => scope.orders.reduce((acc: any, cur: any) => acc + cur.total, 0),
});
export default () => {
