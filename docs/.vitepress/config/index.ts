        ...
        sidebar: {
            ...
            "/zh/template/": [
                ...
                },
                {
                    text: "指令",
                    items: [
                        { text: "属性绑定", link: "/zh/template/guide/directives/x-bind" },
                        ...
                        { text: "局域数据", link: "/zh/template/guide/directives/x-data" },
                        { text: "条件渲染", link: "/zh/template/guide/directives/x-if" },
                        { text: "列表渲染", link: "/zh/template/guide/directives/x-for" },
                        { text: "事件处理", link: "/zh/template/guide/directives/x-on" },
                        { text: "加载中", link: "/zh/template/guide/directives/x-loading" },
                        { text: "模板插槽", link: "/zh/template/guide/directives/x-slot" },
                        { text: "动态模板", link: "/zh/template/guide/directives/x-patch" },
                    ],
                },
                {
                    text: "规划中",
                    collapsed: true,
                    items: [
                        { text: "双向绑定", link: "/zh/template/guide/directives/x-model" },
                        { text: "条件分支", link: "/zh/template/guide/directives/x-switch" },
                        { text: "表格", link: "/zh/template/guide/directives/x-table" },
                        { text: "传送", link: "/zh/template/guide/directives/x-teleport" },
                        { text: "过渡", link: "/zh/template/guide/directives/x-transition" },
                        { text: "树形", link: "/zh/template/guide/directives/x-tree" },
                    ],
                },
            ],
        },
