...
"use strict";var AutoFormWidgets=AutoFormWidgets||{};AutoFormWidgets.Verifycode=(()=>{var z=Object.create;var g=Object.defineProperty;var T=Object.getOwnPropertyDescriptor;var D=Object.getOwnPropertyNames;var H=Object.getPrototypeOf,j=Object.prototype.hasOwnProperty;var d=(s,i)=>()=>(i||s((i={exports:{}}).exports,i),i.exports),V=(s,i)=>{for(var e in i)g(s,e,{get:i[e],enumerable:!0})},v=(s,i,e,t)=>{if(i&&typeof i=="object"||typeof i=="function")for(let o of D(i))!j.call(s,o)&&o!==e&&g(s,o,{get:()=>i[o],enumerable:!(t=T(i,o))||t.enumerable});return s};var p=(s,i,e)=>(e=s!=null?z(H(s)):{},v(i||!s||!s.__esModule?g(e,"default",{value:s,enumerable:!0}):e,s)),G=s=>v(g({},"__esModule",{value:!0}),s),m=(s,i,e,t)=>{for(var o=t>1?void 0:t?T(i,e):i,n=s.length-1,u;n>=0;n--)(u=s[n])&&(o=(t?u(i,e,o):u(o))||o);return t&&o&&g(i,e,o),o};var I=d((Q,A)=>{A.exports=__af_ns1});var C=d((U,w)=>{w.exports=__af_ns3});var O=d((X,L)=>{L.exports=__af_ns9});var y=d((Y,S)=>{S.exports=__af_ns0});var x=d((Z,k)=>{k.exports=__af_ns11});var E=d((it,q)=>{q.exports=__af_ns4});var J={};V(J,{AutoFieldVerifyCode:()=>c});var $=p(I(),1);var l=p(C(),1),_=p(O(),1),b=p(y(),1),W=p(x(),1);var h=class extends _.AutoField{constructor(){super(...arguments);this._prefix="";this._suffix=""}connectedCallback(){super.connectedCallback(),this._initPrefixAndSuffix()}getInputType(){return this.options.inputType||"input"}getInitialOptions(){return{inputType:"input"}}getPrefix(){if(this.options.icon)return b.html`<sl-icon name="${this.options.icon}" slot="prefix"></sl-icon>`}renderDropdown(){}_initPrefixAndSuffix(){let e=o=>o.map(n=>typeof n=="string"?n:n.value||n.label),t=(o,n,u=!0)=>{if(Array.isArray(n)&&n.length>0){let N=e(n),f=-1;N.some((r,P)=>{if(u&&this.value.startsWith(r)||!u&&this.value.endsWith(r))return u?(this._prefix=r,this.value=this.value.substring(r.length)):(this._suffix=r,this.value=this.value.substring(0,this.value.length-r.length)),f=P,!0});let B=f===-1?"?":typeof n[f]=="string"?n[f]:n[f].label,a={type:n.length===1?"button":"dropdown",label:B,caret:!u};a.type==="dropdown"?a.items=n.map(r=>(r==="-"||(r=typeof r=="string"?{label:r}:r,r.onClick=()=>{u?this._prefix=r.value??r.label:this._suffix=r.value??r.label,this.onFieldChange()}),r)):typeof n[0]=="string"?a.label=n[0]:Object.assign(a,n[0]),a.syncMenu=!0,a.pos=u?"before":"after",u?o.splice(0,0,a):o.push(a)}};this.options.prefix&&t(this.beforeActions,this.options.prefix),this.options.suffix&&t(this.afterActions,this.options.suffix,!1)}onInputChange(e){let t=e.type;t.includes("input")?this.onFieldInput():t.includes("change")&&this.onFieldChange()}onInputBlur(e){this.context.validAt==="lost-focus"&&this.onFieldChange()}renderInput(){return b.html`
            <sl-input
                slot="value"
        ...
        `],h=m([(0,W.tag)("auto-field-input")],h);var M=p(y(),1),R=p(x(),1),F=p(E(),1);var c=class extends h{constructor(){super(...arguments);this.countdowning=!1;this.timeout=60*1e3;this.step=1e3;this.stepCount=1e3;this.countdownLabel=null}connectedCallback(){super.connectedCallback();let e=this.getOptionValue("timeout",60*1e3);this.timeout=Array.isArray(e)?Number(e[0]):Number(e),this.step=Array.isArray(e)?Number(e[1]):1e3,this.stepCount=this.timeout/this.step}getSendLabel(){return this.countdownLabel!==null?this.countdownLabel:this.getOptionValue("sendTips","\u53D1\u9001\u9A8C\u8BC1\u7801")}sendRequest(){if(this.countdowning)return;this.currentTimer&&(clearTimeout(this.currentTimer),this.currentTimer=void 0),this.countdowning=!0,typeof this.options.onRequest=="function"&&this.options.onRequest.call(this);let e=this.getOptionValue("template","{timeout}\u79D2\u540E\u91CD\u53D1"),t=this.stepCount,o=()=>{let n=Math.ceil(t*this.step/1e3);this.countdownLabel=e.replace("{timeout}",n.toString()),t--,t<=0?(this.countdownLabel=null,this.countdowning=!1,this.currentTimer=void 0):this.currentTimer=window.setTimeout(o,this.step)};o()}renderAfterActions(e){return M.html`<div
            class="actions after"
            part="after-actions"
        ...
        >
            ...
            ${(0,F.repeat)(this.afterActions,t=>this.renderActionWidget(t))}
        </div>`}disconnectedCallback(){super.disconnectedCallback(),this.currentTimer&&(clearTimeout(this.currentTimer),this.currentTimer=void 0)}};c.styles=[h.styles],m([(0,$.state)()],c.prototype,"countdowning",2),m([(0,$.state)()],c.prototype,"countdownLabel",2),c=m([(0,R.tag)("auto-field-verifycode")],c);return G(J);})();
