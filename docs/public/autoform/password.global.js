...
"use strict";var AutoFormWidgets=AutoFormWidgets||{};AutoFormWidgets.Password=(()=>{var S=Object.create;var d=Object.defineProperty;var _=Object.getOwnPropertyDescriptor;var M=Object.getOwnPropertyNames;var P=Object.getPrototypeOf,q=Object.prototype.hasOwnProperty;var m=(i,e)=>()=>(e||i((e={exports:{}}).exports,e),e.exports),z=(i,e)=>{for(var n in e)d(i,n,{get:e[n],enumerable:!0})},$=(i,e,n,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of M(e))!q.call(i,r)&&r!==n&&d(i,r,{get:()=>e[r],enumerable:!(t=_(e,r))||t.enumerable});return i};var c=(i,e,n)=>(n=i!=null?S(P(i)):{},$(e||!i||!i.__esModule?d(n,"default",{value:i,enumerable:!0}):n,i)),B=i=>$(d({},"__esModule",{value:!0}),i),b=(i,e,n,t)=>{for(var r=t>1?void 0:t?_(e,n):e,s=i.length-1,p;s>=0;s--)(p=i[s])&&(r=(t?p(e,n,r):p(r))||r);return t&&r&&d(e,n,r),r};var y=m((N,I)=>{I.exports=__af_ns11});var A=m((j,v)=>{v.exports=__af_ns3});var O=m((R,T)=>{T.exports=__af_ns9});var F=m((G,C)=>{C.exports=__af_ns0});var D={};z(D,{AutoFieldPassword:()=>f});var L=c(y(),1);var l=c(A(),1),x=c(O(),1),g=c(F(),1),w=c(y(),1);var u=class extends x.AutoField{constructor(){super(...arguments);this._prefix="";this._suffix=""}connectedCallback(){super.connectedCallback(),this._initPrefixAndSuffix()}getInputType(){return this.options.inputType||"input"}getInitialOptions(){return{inputType:"input"}}getPrefix(){if(this.options.icon)return g.html`<sl-icon name="${this.options.icon}" slot="prefix"></sl-icon>`}renderDropdown(){}_initPrefixAndSuffix(){let n=r=>r.map(s=>typeof s=="string"?s:s.value||s.label),t=(r,s,p=!0)=>{if(Array.isArray(s)&&s.length>0){let W=n(s),h=-1;W.some((o,E)=>{if(p&&this.value.startsWith(o)||!p&&this.value.endsWith(o))return p?(this._prefix=o,this.value=this.value.substring(o.length)):(this._suffix=o,this.value=this.value.substring(0,this.value.length-o.length)),h=E,!0});let k=h===-1?"?":typeof s[h]=="string"?s[h]:s[h].label,a={type:s.length===1?"button":"dropdown",label:k,caret:!p};a.type==="dropdown"?a.items=s.map(o=>(o==="-"||(o=typeof o=="string"?{label:o}:o,o.onClick=()=>{p?this._prefix=o.value??o.label:this._suffix=o.value??o.label,this.onFieldChange()}),o)):typeof s[0]=="string"?a.label=s[0]:Object.assign(a,s[0]),a.syncMenu=!0,a.pos=p?"before":"after",p?r.splice(0,0,a):r.push(a)}};this.options.prefix&&t(this.beforeActions,this.options.prefix),this.options.suffix&&t(this.afterActions,this.options.suffix,!1)}onInputChange(n){let t=n.type;t.includes("input")?this.onFieldInput():t.includes("change")&&this.onFieldChange()}onInputBlur(n){this.context.validAt==="lost-focus"&&this.onFieldChange()}renderInput(){return g.html`
        ...
        `],u=b([(0,w.tag)("auto-field-input")],u);var f=class extends u{getInputType(){return"password"}getInitialOptions(){return{icon:"lock"}}};f=b([(0,L.tag)("auto-field-password")],f);return B(D);})();
//# sourceMappingURL=password.global.js.map
