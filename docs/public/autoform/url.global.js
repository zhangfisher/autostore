...
"use strict";var AutoFormWidgets=AutoFormWidgets||{};AutoFormWidgets.Url=(()=>{var W=Object.create;var c=Object.defineProperty;var _=Object.getOwnPropertyDescriptor;var E=Object.getOwnPropertyNames;var P=Object.getPrototypeOf,q=Object.prototype.hasOwnProperty;var m=(i,e)=>()=>(e||i((e={exports:{}}).exports,e),e.exports),z=(i,e)=>{for(var n in e)c(i,n,{get:e[n],enumerable:!0})},$=(i,e,n,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of E(e))!q.call(i,r)&&r!==n&&c(i,r,{get:()=>e[r],enumerable:!(t=_(e,r))||t.enumerable});return i};var g=(i,e,n)=>(n=i!=null?W(P(i)):{},$(e||!i||!i.__esModule?c(n,"default",{value:i,enumerable:!0}):n,i)),B=i=>$(c({},"__esModule",{value:!0}),i),b=(i,e,n,t)=>{for(var r=t>1?void 0:t?_(e,n):e,s=i.length-1,l;s>=0;s--)(l=i[s])&&(r=(t?l(e,n,r):l(r))||r);return t&&r&&c(e,n,r),r};var y=m((N,I)=>{I.exports=__af_ns11});var T=m((j,v)=>{v.exports=__af_ns3});var L=m((R,A)=>{A.exports=__af_ns9});var C=m((G,O)=>{O.exports=__af_ns0});var D={};z(D,{AutoFieldUrl:()=>f});var k=g(y(),1);var p=g(T(),1),x=g(L(),1),d=g(C(),1),F=g(y(),1);var u=class extends x.AutoField{constructor(){super(...arguments);this._prefix="";this._suffix=""}connectedCallback(){super.connectedCallback(),this._initPrefixAndSuffix()}getInputType(){return this.options.inputType||"input"}getInitialOptions(){return{inputType:"input"}}getPrefix(){if(this.options.icon)return d.html`<sl-icon name="${this.options.icon}" slot="prefix"></sl-icon>`}renderDropdown(){}_initPrefixAndSuffix(){let n=r=>r.map(s=>typeof s=="string"?s:s.value||s.label),t=(r,s,l=!0)=>{if(Array.isArray(s)&&s.length>0){let S=n(s),h=-1;S.some((o,M)=>{if(l&&this.value.startsWith(o)||!l&&this.value.endsWith(o))return l?(this._prefix=o,this.value=this.value.substring(o.length)):(this._suffix=o,this.value=this.value.substring(0,this.value.length-o.length)),h=M,!0});let w=h===-1?"?":typeof s[h]=="string"?s[h]:s[h].label,a={type:s.length===1?"button":"dropdown",label:w,caret:!l};a.type==="dropdown"?a.items=s.map(o=>(o==="-"||(o=typeof o=="string"?{label:o}:o,o.onClick=()=>{l?this._prefix=o.value??o.label:this._suffix=o.value??o.label,this.onFieldChange()}),o)):typeof s[0]=="string"?a.label=s[0]:Object.assign(a,s[0]),a.syncMenu=!0,a.pos=l?"before":"after",l?r.splice(0,0,a):r.push(a)}};this.options.prefix&&t(this.beforeActions,this.options.prefix),this.options.suffix&&t(this.afterActions,this.options.suffix,!1)}onInputChange(n){let t=n.type;t.includes("input")?this.onFieldInput():t.includes("change")&&this.onFieldChange()}onInputBlur(n){this.context.validAt==="lost-focus"&&this.onFieldChange()}renderInput(){return d.html`
            ...
            >
        `}toState(n){let t=super.toState(n);return typeof t=="string"&&(this._prefix&&(t=this._prefix+t),this._suffix&&(t=t+this._suffix)),t}toInput(n){let t=super.toInput(n);return typeof t=="string"&&(this._prefix&&t.startsWith(this._prefix)&&(t=t.substring(this._prefix.length)),this._suffix&&t.endsWith(this._suffix)&&(t=t.substring(0,t.length-this._suffix.length))),t}};u.styles=[x.AutoField.styles,d.css`
            .actions {
                margin-right: 0px;
                display: flex;
                flex-direction: row;
        ...
        `],u=b([(0,F.tag)("auto-field-input")],u);var f=class extends u{getInputType(){return"url"}getFieldOptions(){return this.schema?.icon||(this.schema.icon="globe"),super.getFieldOptions()}};f=b([(0,k.tag)("auto-field-url")],f);return B(D);})();
//# sourceMappingURL=url.global.js.map
