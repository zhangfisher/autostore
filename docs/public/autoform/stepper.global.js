...
"use strict";var AutoFormWidgets=AutoFormWidgets||{};AutoFormWidgets.Stepper=(()=>{var B=Object.create;var b=Object.defineProperty;var S=Object.getOwnPropertyDescriptor;var M=Object.getOwnPropertyNames;var W=Object.getPrototypeOf,D=Object.prototype.hasOwnProperty;var x=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),q=(n,t)=>{for(var e in t)b(n,e,{get:t[e],enumerable:!0})},A=(n,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of M(t))!D.call(n,s)&&s!==e&&b(n,s,{get:()=>t[s],enumerable:!(i=S(t,s))||i.enumerable});return n};var d=(n,t,e)=>(e=n!=null?B(W(n)):{},A(t||!n||!n.__esModule?b(e,"default",{value:n,enumerable:!0}):e,n)),E=n=>A(b({},"__esModule",{value:!0}),n),$=(n,t,e,i)=>{for(var s=i>1?void 0:i?S(t,e):t,o=n.length-1,p;o>=0;o--)(p=n[o])&&(s=(i?p(t,e,s):p(s))||s);return i&&s&&b(t,e,s),s};var y=x((H,O)=>{O.exports=__af_ns0});var _=x((j,w)=>{w.exports=__af_ns3});var N=x((R,L)=>{L.exports=__af_ns9});var v=x((G,T)=>{T.exports=__af_ns11});var U={};q(U,{AutoFieldStepper:()=>f});var a=d(y(),1),u=d(_(),1);var l=d(_(),1),I=d(N(),1),g=d(y(),1),k=d(v(),1);var c=class extends I.AutoField{constructor(){super(...arguments);this._prefix="";this._suffix=""}connectedCallback(){super.connectedCallback(),this._initPrefixAndSuffix()}getInputType(){return this.options.inputType||"input"}getInitialOptions(){return{inputType:"input"}}getPrefix(){if(this.options.icon)return g.html`<sl-icon name="${this.options.icon}" slot="prefix"></sl-icon>`}renderDropdown(){}_initPrefixAndSuffix(){let e=s=>s.map(o=>typeof o=="string"?o:o.value||o.label),i=(s,o,p=!0)=>{if(Array.isArray(o)&&o.length>0){let P=e(o),m=-1;P.some((r,F)=>{if(p&&this.value.startsWith(r)||!p&&this.value.endsWith(r))return p?(this._prefix=r,this.value=this.value.substring(r.length)):(this._suffix=r,this.value=this.value.substring(0,this.value.length-r.length)),m=F,!0});let z=m===-1?"?":typeof o[m]=="string"?o[m]:o[m].label,h={type:o.length===1?"button":"dropdown",label:z,caret:!p};h.type==="dropdown"?h.items=o.map(r=>(r==="-"||(r=typeof r=="string"?{label:r}:r,r.onClick=()=>{p?this._prefix=r.value??r.label:this._suffix=r.value??r.label,this.onFieldChange()}),r)):typeof o[0]=="string"?h.label=o[0]:Object.assign(h,o[0]),h.syncMenu=!0,h.pos=p?"before":"after",p?s.splice(0,0,h):s.push(h)}};this.options.prefix&&i(this.beforeActions,this.options.prefix),this.options.suffix&&i(this.afterActions,this.options.suffix,!1)}onInputChange(e){let i=e.type;i.includes("input")?this.onFieldInput():i.includes("change")&&this.onFieldChange()}onInputBlur(e){this.context.validAt==="lost-focus"&&this.onFieldChange()}renderInput(){return g.html`
            ...
            >
        `}toState(e){let i=super.toState(e);return typeof i=="string"&&(this._prefix&&(i=this._prefix+i),this._suffix&&(i=i+this._suffix)),i}toInput(e){let i=super.toInput(e);return typeof i=="string"&&(this._prefix&&i.startsWith(this._prefix)&&(i=i.substring(this._prefix.length)),this._suffix&&i.endsWith(this._suffix)&&(i=i.substring(0,i.length-this._suffix.length))),i}};c.styles=[I.AutoField.styles,g.css`
            .actions {
                margin-right: 0px;
                display: flex;
                flex-direction: row;
        ...
        >
            ...
            >
        `}renderView(){return a.html`<span>${this.options.prefix??""}${this.value}${this.options.suffix??""}</span>`}};f.styles=[c.styles,a.css`
        ...
        `],f=$([(0,C.tag)("auto-field-stepper")],f);return E(U);})();
