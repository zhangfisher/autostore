...
`;var vt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Dt=t=>(...i)=>({_$litDirective$:t,values:i}),At=class{constructor(i){}get _$AU(){return this._$AM._$AU}_$AT(i,e,r){this._$Ct=i,this._$AM=e,this._$Ci=r;}_$AS(i,e){return this.update(i,e)}update(i,e){return this.render(...e)}};var{I:Ql}=Bs;var cn=(t,i)=>t?._$litType$!==void 0;var zr=t=>t.strings===void 0,ln=()=>document.createComment(""),ci=(t,i,e)=>{let r=t._$AA.parentNode,o=i===void 0?t._$AB:i._$AA;if(e===void 0){let s=r.insertBefore(ln(),o),n=r.insertBefore(ln(),o);e=new Ql(s,n,t,t.options);}else {let s=e._$AB.nextSibling,n=e._$AM,c=n!==t;if(c){let l;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(l=t._$AU)!==n._$AU&&e._$AP(l);}if(s!==o||c){let l=e._$AA;for(;l!==s;){let h=l.nextSibling;r.insertBefore(l,o),l=h;}}}return e},Ae=(t,i,e=t)=>(t._$AI(i,e),t),Zl={},Dr=(t,i=Zl)=>t._$AH=i,pn=t=>t._$AH,Mr=t=>{t._$AP?.(false,true);let i=t._$AA,e=t._$AB.nextSibling;for(;i!==e;){let r=i.nextSibling;i.remove(),i=r;}};var dn=(t,i,e)=>{let r=new Map;for(let o=i;o<=e;o++)r.set(t[o],o);return r},et=Dt(class extends At{constructor(t){if(super(t),t.type!==vt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,i,e){let r;e===void 0?e=i:i!==void 0&&(r=i);let o=[],s=[],n=0;for(let c of t)o[n]=r?r(c,n):n,s[n]=e(c,n),n++;return {values:s,keys:o}}render(t,i,e){return this.dt(t,i,e).values}update(t,[i,e,r]){let o=pn(t),{values:s,keys:n}=this.dt(i,e,r);if(!Array.isArray(o))return this.ut=n,s;let c=this.ut??=[],l=[],h,m,d=0,f=o.length-1,g=0,b=s.length-1;for(;d<=f&&g<=b;)if(o[d]===null)d++;else if(o[f]===null)f--;else if(c[d]===n[g])l[g]=Ae(o[d],s[g]),d++,g++;else if(c[f]===n[b])l[b]=Ae(o[f],s[b]),f--,b--;else if(c[d]===n[b])l[b]=Ae(o[d],s[b]),ci(t,l[b+1],o[d]),d++,b--;else if(c[f]===n[g])l[g]=Ae(o[f],s[g]),ci(t,o[d],o[f]),f--,g++;else if(h===void 0&&(h=dn(n,g,b),m=dn(c,d,f)),h.has(c[d]))if(h.has(c[f])){let x=m.get(n[g]),T=x!==void 0?o[x]:null;if(T===null){let E=ci(t,o[d]);Ae(E,s[g]),l[g]=E;}else l[g]=Ae(T,s[g]),ci(t,o[d],T),o[x]=null;g++;}else Mr(o[f]),f--;else Mr(o[d]),d++;for(;g<=b;){let x=ci(t,l[b+1]);Ae(x,s[g]),l[g++]=x;}for(;d<=f;){let x=o[d++];x!==null&&Mr(x);}return this.ut=n,Dr(t,l),nt}});var pi=class{constructor(i){this.host=i,i.addController(this);}hostConnected(){let i=this.host;i.hasAttribute("dark")&&(i.classList.add("sl-theme-dark"),i.style.color="var(--sl-color-neutral-900,white)",i.shadowRoot.ownerDocument.style=i.style.color);}_toDark(){let i=this.host;i.classList.add("sl-theme-dark"),i.style.color="var(--sl-color-neutral-900,white)";}_toLight(){let i=this.host;i.classList.remove("sl-theme-dark"),i.style.color="var(--sl-color-neutral-1000)";}updateContext(){Object.assign(this.host.context,{labelPos:this.host.labelPos,labelWidth:this.host.labelWidth,readonly:this.host.readonly,viewonly:this.host.viewonly,viewAlign:this.host.viewAlign,compact:this.host.compact,border:this.host.border,group:this.host.group,layout:this.host.layout,advanced:this.host.advanced,validAt:this.host.validAt,size:this.host.size});}hostUpdate(){this.host.tagName==="AUTO-FORM"&&this.updateContext(),this.host.dark?this._toDark():this._toLight();}};var hn="important",Jl=" !"+hn,J=Dt(class extends At{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((i,e)=>{let r=t[e];return r==null?i:i+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(t,[i]){let{style:e}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(i)),this.render(i);for(let r of this.ft)i[r]==null&&(this.ft.delete(r),r.includes("-")?e.removeProperty(r):e[r]=null);for(let r in i){let o=i[r];if(o!=null){this.ft.add(r);let s=typeof o=="string"&&o.endsWith(Jl);r.includes("-")||s?e.setProperty(r,s?o.slice(0,-11):o,s?hn:""):e[r]=o;}}return nt}});function B(t,i,e){return t?i(t):e?.(t)}var Oe=class{constructor(i,...e){this.initialClasses=[];this.host=i,i.addController(this),this.initialClasses=e;}_forEachClasss(i,e){i&&i.forEach(r=>{typeof r=="string"?(e(r,true),this.host.classList.add(r)):Object.entries(r).forEach(([o,s])=>{e(o,s);});});}add(...i){this.host&&i&&this._forEachClasss(i,e=>{this.host.classList.add(e);});}remove(...i){this.host&&i&&this._forEachClasss(i,e=>{this.host.classList.remove(e);});}toggle(...i){this.host&&this._forEachClasss(i,e=>{this.host.classList.toggle(e);});}use(...i){this.host&&this._forEachClasss(i,(e,r)=>{r?this.host.classList.add(e):this.host.classList.remove(e);});}has(i){return this.host.classList.contains(i)}hostConnected(){this.add(...this.initialClasses);}hostDisconnected(){this.remove(...this.initialClasses);}hostUpdate(){}};var Bi=class extends At{constructor(i){if(super(i),this.it=Y,i.type!==vt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(i){if(i===Y||i==null)return this._t=void 0,this.it=i;if(i===nt)return i;if(typeof i!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(i===this.it)return this._t;this.it=i;let e=[i];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Bi.directiveName="unsafeHTML",Bi.resultType=1;var Ot=Dt(Bi);function un(t,i){i&&Object.entries(i).forEach(([e,r])=>{(e==="root"?[t]:Array.from(t.querySelectorAll(e))).forEach(s=>{typeof r=="string"?s.style.cssText=r:typeof r=="object"&&Object.assign(s.style,r);});});}function di(t,i,e){e?t.classList.add(i):t.classList.remove(i);}function mn(){return {widget:"input",name:"",path:[],visible:true,enable:true,required:false,order:0,advanced:false,actions:[]}}var R=class extends ut{constructor(){super(...arguments);this.theme=new pi(this);this.classs=new Oe(this);this.options=mn();this.value="";this.name="";this.path="";this.labelPos="top";this.dirty=false;this.noreactive=false;this.beforeActions=[];this.afterActions=[];this._subscribers=[];this.onFieldChange=()=>this._updateFieldValue();this.onFieldInput=()=>this._updateFieldValue();}static{this.styles=an;}get shadow(){return this.shadowRoot}getFieldOptions(){return Object.entries(this.schema||{}).reduce((e,[r,o])=>($e(o)?e[r]=o.value:e[r]=o,e),Object.assign({},mn(),this.getInitialOptions()))}getPrefix(){}getSuffix(){}renderActions(e=true){return u`${this.renderBeforeActions(e)}
        ...
        >
            ...
            <sl-menu>   
                ${et(e.items||[],r=>r==="-"?u`<sl-divider></sl-divider>`:(typeof r=="string"&&(r={label:r}),u`<sl-menu-item  @click=${this._onClickAction.call(this,r,()=>{e.syncMenu&&(e.label=r.label,e.icon=r.icon,e.tips=r.tips,this.requestUpdate());})}>
                    ${B(r.icon,()=>u`<sl-icon name=${w(r.icon)} slot="prefix"></sl-icon>`)}
    ...
    `}renderActionWidget(e){if(typeof e!="object")return;let r=e.type||"button";if(r==="dropdown")return this._renderDropdownAction(e);if(r==="button")return this._renderButtonAction(e);if(r==="image")return this._renderImageAction(e)}renderOption(e,r){let o=this.schema[e];if(o)return o.loading?u`<sl-spinner></sl-spinner>`:u`${r?r(this.options.required):this.options.required}</div>`}getLabel(){return this.getSchema().label||this.name}getSchema(){return this.schema}toView(e){return this.options.toView&&typeof this.options.toView=="function"?this.options.toView.call(this,e):e}toState(e){return this.options.toState&&typeof this.options.toState=="function"?this.options.toState.call(this,e):e}toInput(e){return this.options.toInput&&typeof this.options.toInput=="function"?this.options.toInput.call(this,e):e}getOptionValue(e,r){if(this.schema&&e in this.schema){let o=this.schema[e];return o===void 0?r:$e(o)?o.value:o}else return r}getOption(e){if(this.schema&&e in this.schema){let r=this.schema[e];return $e(r)?r:rn(r)}}getInputValue(){if(!this.input)return "";let e=this.input.value;if(typeof this.options.toState!="function"){let r=this.options.datatype||"string";r==="number"?e=Number(e):r==="boolean"&&(e=!!e);}return e}_renderRequiredOption(){return this.renderOption("required",e=>e?u`<span style='color:red;'>*</span>`:"")}renderHelp(e=false){let r=this.options.help;if(!r)return;let o=r.match(/\(([^)]+)\)[^)]*$/),s=o?o[1]:null,n=s?r.replace(`(${s})`,""):r;return u`<span class="help" part="field-help" title="${w(e?n:void 0)}">
            ...
            ${this.renderInput()}
            ${B(this.context.viewonly,()=>this.renderHelp())}         
            ${this.renderError()} 
...
`;var tp=0,Xt=class extends V{constructor(){super(...arguments),this.localize=new W(this),this.attrId=++tp,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=false,this.closable=false,this.disabled=false,this.tabIndex=0;}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab");}handleCloseClick(t){t.stopPropagation(),this.emit("sl-close");}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false");}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0;}render(){return this.id=this.id.length>0?this.id:this.componentId,u`
      <div
        part="base"
...
`;var re=class extends ut{constructor(){super(...arguments);this.groups=[];}static{this.styles=[wo,y`
        ...
        `];}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>this.onSlotChange());}bind(e){this.store=e,this.groups&&this.groups.forEach(r=>{r.el.bind(e);});}onSlotChange(){if(!this.slotElement||this.groups&&this.groups.length>0)return;let e=this.slotElement.assignedElements();this.groups=e.filter(r=>r.tagName.toLowerCase()==="auto-form").map((r,o)=>{let s=r;this.store&&s.bind(this.store),s.setAttribute("border","none");let n=s.getAttribute("icon")||s.dataset.icon,c=s.getAttribute("label")||s.dataset.label,l=s.getAttribute("title")||s.dataset.title,h=s.getAttribute("name")||s.dataset.name||"",m=this.active?this.active.split(",").includes(h):o===0;return {name:h,active:m,icon:n,title:l,label:c,el:s}}),this.requestUpdate();}renderGroups(){}render(){return u`
            ${this.renderGroups()}
            ...
            >
                ${this.groups.map((e,r)=>u`
                        <sl-tab
                            ?active=${e.active}
                            slot="nav"
                            title="${w(e.title||e.label)}"
                            panel="${r}"
                        >
                            ${e.icon?u`<sl-icon name="${e.icon}"></sl-icon>`:""}
                            ${B(e.label,()=>u`<span class="label">${e.label}</span>`)}
                        </sl-tab>
                    `)}
