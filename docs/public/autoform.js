var AutoForm=(function(exports){'use strict';var Kl=Object.defineProperty;var Gl=Object.getOwnPropertyDescriptor;var He=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var v=(t,r,e,o)=>{for(var i=o>1?void 0:o?Gl(r,e):r,s=t.length-1,n;s>=0;s--)(n=t[s])&&(i=(o?n(r,e,i):n(i))||i);return o&&i&&Kl(r,e,i),i};function Bs(t){let r=t.trim();if(r.startsWith("#")&&(r=r.slice(1)),r.length===3?r=r.replace(/(.)/g,"$1$1"):r.length===4&&(r=r.replace(/(.)/g,"$1$1")),r.length>6&&(r=r.slice(0,6)),!/^[0-9a-f]{6}$/i.test(r))throw new Error("Invalid hex color");let e=parseInt(r,16),o=e>>16&255,i=e>>8&255,s=e&255;return [o,i,s]}function Yl(t){let r=Bs(t);return (r[0]*2126+r[1]*7152+r[2]*722)/1e4<128}function Xl(t){let[r,e,o]=Array.isArray(t)?t:Bs(t),i=r/255,s=e/255,n=o/255,c=Math.max(i,s,n),a=Math.min(i,s,n),h=c-a,m=0,d=0,f=(c+a)/2;return h!==0&&(c===i?m=((s-n)/h+(s<n?6:0))/6:c===s?m=((n-i)/h+2)/6:m=((i-s)/h+4)/6),h!==0&&(d=h/(1-Math.abs(2*f-1))),[Math.round(m*360),Math.round(d*100),Math.round(f*100)]}function Hs(t){let[r,e,o]=t,i=r/360,s=e/100,n=o/100,c=(1-Math.abs(2*n-1))*s,a=c*(1-Math.abs(i*6%2-1)),h=n-c/2,m=0,d=0,f=0;0<=i&&i<1/6?(m=c,d=a,f=0):1/6<=i&&i<2/6?(m=a,d=c,f=0):2/6<=i&&i<3/6?(m=0,d=c,f=a):3/6<=i&&i<4/6?(m=0,d=a,f=c):4/6<=i&&i<5/6?(m=a,d=0,f=c):(m=c,d=0,f=a);let g=b=>Math.round((b+h)*255).toString(16).padStart(2,"0");return `#${g(m)}${g(d)}${g(f)}`}function Ql(t){let{color:r,range:e,dark:o,count:i}=Object.assign({range:[5,98],count:5},t),s=Xl(r),n=o??Yl(r),c=Array.from({length:2*i+1});c[i]=r;let a=Math.abs(s[2]-e[0]),h=a/i,m=s[2];for(let d=i-1;d>=0;d--)m=m+(n?-1:1)*h,m<0&&(m=0),m>100&&(m=100),c[d]=Hs([s[0],s[1],m]);m=s[2],a=Math.abs(s[2]-e[1]),h=a/i;for(let d=i+1;d<i*2+1;d++)m=m+(n?1:-1)*h,m<0&&(m=0),m>100&&(m=100),c[d]=Hs([s[0],s[1],m]);return {colors:c,dark:n}}function Be(t,r){let e=Object.assign({levels:[5,1,2,3,4,5],range:[10,98],count:5},typeof r=="string"?{color:r}:r),{colors:o,dark:i}=Ql(e),s={};o.reduce((c,a,h)=>(s[`${t}${h}`]=a,c),{});let n=`--t-${t.split("-")[4]}`;return e.levels&&(s[`${n}-color`]=`var(${t}${e.levels[0]})`,s[`${n}-bgcolor`]=`var(${t}${e.levels[1]})`,e.levels.slice(2).forEach((c,a)=>{s[`${n}-bgcolor-${a+1}`]=`var(${t}${c})`;})),{vars:s,colors:o,dark:i}}function Ri(t=10){return Math.random().toString(36).substring(2,t+2)}function Ws(t,r){if(globalThis.document==null)return;let{id:e,mode:o,location:i="head"}=Object.assign({mode:"default"},r),s=document.head.querySelector(`#${e}`),n=e||Ri();return s?(o=="replace"?s.innerHTML=t:o=="append"&&(s.innerHTML+=t),n):(s=document.createElement("style"),s.innerHTML=t,s.id=n,r?.el?r.el.appendChild(s):i=="head"?document.head.appendChild(s):document.body.appendChild(s),s)}function Zl(t){let r=Object.assign({name:Ri(),variants:{}},t),e=Object.assign({prefix:"--t-color-theme-",range:[10,100],levels:[10,1,2,3,4,5]},typeof r.theme=="string"?{color:r.theme}:r.theme),o=r.selector||":root,:host",{vars:i,dark:s}=Be("--t-color-theme-",e);r.variants.primary&&Be("--t-color-primary-",r.variants.primary),r.variants.danger&&Be("--t-color-danger-",r.variants.danger),r.variants.success&&Be("--t-color-success-",r.variants.success),r.variants.warning&&Be("--t-color-warning-",r.variants.warning),r.variants.info&&Be("--t-color-info-",r.variants.info);let n=`${o}[data-theme=${r.name}]{
        ${`color-schema: ${s?"dark":"light"}`};
        ${Object.entries(i).map(([c,a])=>`${c}:${a}`).join(`;
`)}}`;return Ws(n,{id:`theme-${r.name||Ri()}`,mode:"replace"}),n}var zi=class{root;constructor(){this.root=document.documentElement,document.addEventListener("DOMContentLoaded",this._onDomContentLoaded.bind(this));}get size(){return this.root.dataset.size||"medium"}set size(r){this.root.dataset.size=r;}get spacing(){return this.root.dataset.spacing||"medium"}set spacing(r){this.root.dataset.spacing=String(r);}get radius(){return this.root.dataset.radius||"medium"}set radius(r){this.root.dataset.radius=r;}get theme(){return this.root.dataset.theme||"light"}set theme(r){this.root.dataset.theme=r;}_onDomContentLoaded(){this.root=document.documentElement;}createVariant(r,e){let{vars:o}=Be(`--t-color-${r}-`,e),i=`${this.theme==="light"?":root,:host":`:host,
:root[data-theme=${this.theme}]`}{${Object.entries(o).map(([s,n])=>`${s}: ${n};`).join(`
`)}`;Ws(i,{id:`t-${this.theme}-${r}`,mode:"replace"});}create(r){Zl(r);}},Jl=new zi;globalThis.ThemePro=Jl;var Ro=globalThis,$o=Ro.trustedTypes,js=$o?$o.createPolicy("lit-html",{createHTML:t=>t}):void 0,Vi="$lit$",he=`lit$${Math.random().toFixed(9).slice(2)}$`,Pi="?"+he,tc=`<${Pi}>`,Ne=Ro.document===void 0?{createTreeWalker:()=>({})}:document,Pr=()=>Ne.createComment(""),Dr=t=>t===null||typeof t!="object"&&typeof t!="function",Di=Array.isArray,Ys=t=>Di(t)||typeof t?.[Symbol.iterator]=="function",Li=`[ 	
\f\r]`,Vr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ns=/-->/g,Us=/>/g,We=RegExp(`>|${Li}(?:([^\\s"'>=/]+)(${Li}*=${Li}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),qs=/'/g,Ks=/"/g,Xs=/^(?:script|style|textarea|title)$/i,Mi=t=>(r,...e)=>({_$litType$:t,strings:r,values:e}),u=Mi(1),at=Symbol.for("lit-noChange"),Y=Symbol.for("lit-nothing"),Gs=new WeakMap,je=Ne.createTreeWalker(Ne,129);function Js(t,r){if(!Di(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return js!==void 0?js.createHTML(r):r}var tn=(t,r)=>{let e=t.length-1,o=[],i,s=r===2?"<svg>":r===3?"<math>":"",n=Vr;for(let c=0;c<e;c++){let a=t[c],h,m,d=-1,f=0;for(;f<a.length&&(n.lastIndex=f,m=n.exec(a),m!==null);)f=n.lastIndex,n===Vr?m[1]==="!--"?n=Ns:m[1]!==void 0?n=Us:m[2]!==void 0?(Xs.test(m[2])&&(i=RegExp("</"+m[2],"g")),n=We):m[3]!==void 0&&(n=We):n===We?m[0]===">"?(n=i??Vr,d=-1):m[1]===void 0?d=-2:(d=n.lastIndex-m[2].length,h=m[1],n=m[3]===void 0?We:m[3]==='"'?Ks:qs):n===Ks||n===qs?n=We:n===Ns||n===Us?n=Vr:(n=We,i=void 0);let g=n===We&&t[c+1].startsWith("/>")?" ":"";s+=n===Vr?a+tc:d>=0?(o.push(h),a.slice(0,d)+Vi+a.slice(d)+he+g):a+he+(d===-2?c:g);}return [Js(t,s+(t[e]||"<?>")+(r===2?"</svg>":r===3?"</math>":"")),o]},Mr=class t{constructor({strings:r,_$litType$:e},o){let i;this.parts=[];let s=0,n=0,c=r.length-1,a=this.parts,[h,m]=tn(r,e);if(this.el=t.createElement(h,o),je.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes);}for(;(i=je.nextNode())!==null&&a.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Vi)){let f=m[n++],g=i.getAttribute(d).split(he),b=/([.?@])?(.*)/.exec(f);a.push({type:1,index:s,name:b[2],strings:g,ctor:b[1]==="."?Ao:b[1]==="?"?Oo:b[1]==="@"?To:qe}),i.removeAttribute(d);}else d.startsWith(he)&&(a.push({type:6,index:s}),i.removeAttribute(d));if(Xs.test(i.tagName)){let d=i.textContent.split(he),f=d.length-1;if(f>0){i.textContent=$o?$o.emptyScript:"";for(let g=0;g<f;g++)i.append(d[g],Pr()),je.nextNode(),a.push({type:2,index:++s});i.append(d[f],Pr());}}}else if(i.nodeType===8)if(i.data===Pi)a.push({type:2,index:s});else {let d=-1;for(;(d=i.data.indexOf(he,d+1))!==-1;)a.push({type:7,index:s}),d+=he.length-1;}s++;}}static createElement(r,e){let o=Ne.createElement("template");return o.innerHTML=r,o}};function Ue(t,r,e=t,o){if(r===at)return r;let i=o!==void 0?e._$Co?.[o]:e._$Cl,s=Dr(r)?void 0:r._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(false),s===void 0?i=void 0:(i=new s(t),i._$AT(t,e,o)),o!==void 0?(e._$Co??=[])[o]=i:e._$Cl=i),i!==void 0&&(r=Ue(t,i._$AS(t,r.values),i,o)),r}var Eo=class{constructor(r,e){this._$AV=[],this._$AN=void 0,this._$AD=r,this._$AM=e;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(r){let{el:{content:e},parts:o}=this._$AD,i=(r?.creationScope??Ne).importNode(e,true);je.currentNode=i;let s=je.nextNode(),n=0,c=0,a=o[0];for(;a!==void 0;){if(n===a.index){let h;a.type===2?h=new dr(s,s.nextSibling,this,r):a.type===1?h=new a.ctor(s,a.name,a.strings,this,r):a.type===6&&(h=new Io(s,this,r)),this._$AV.push(h),a=o[++c];}n!==a?.index&&(s=je.nextNode(),n++);}return je.currentNode=Ne,i}p(r){let e=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(r,o,e),e+=o.strings.length-2):o._$AI(r[e])),e++;}},dr=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(r,e,o,i){this.type=2,this._$AH=Y,this._$AN=void 0,this._$AA=r,this._$AB=e,this._$AM=o,this.options=i,this._$Cv=i?.isConnected??true;}get parentNode(){let r=this._$AA.parentNode,e=this._$AM;return e!==void 0&&r?.nodeType===11&&(r=e.parentNode),r}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(r,e=this){r=Ue(this,r,e),Dr(r)?r===Y||r==null||r===""?(this._$AH!==Y&&this._$AR(),this._$AH=Y):r!==this._$AH&&r!==at&&this._(r):r._$litType$!==void 0?this.$(r):r.nodeType!==void 0?this.T(r):Ys(r)?this.k(r):this._(r);}O(r){return this._$AA.parentNode.insertBefore(r,this._$AB)}T(r){this._$AH!==r&&(this._$AR(),this._$AH=this.O(r));}_(r){this._$AH!==Y&&Dr(this._$AH)?this._$AA.nextSibling.data=r:this.T(Ne.createTextNode(r)),this._$AH=r;}$(r){let{values:e,_$litType$:o}=r,i=typeof o=="number"?this._$AC(r):(o.el===void 0&&(o.el=Mr.createElement(Js(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===i)this._$AH.p(e);else {let s=new Eo(i,this),n=s.u(this.options);s.p(e),this.T(n),this._$AH=s;}}_$AC(r){let e=Gs.get(r.strings);return e===void 0&&Gs.set(r.strings,e=new Mr(r)),e}k(r){Di(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,o,i=0;for(let s of r)i===e.length?e.push(o=new t(this.O(Pr()),this.O(Pr()),this,this.options)):o=e[i],o._$AI(s),i++;i<e.length&&(this._$AR(o&&o._$AB.nextSibling,i),e.length=i);}_$AR(r=this._$AA.nextSibling,e){for(this._$AP?.(false,true,e);r!==this._$AB;){let o=r.nextSibling;r.remove(),r=o;}}setConnected(r){this._$AM===void 0&&(this._$Cv=r,this._$AP?.(r));}},qe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(r,e,o,i,s){this.type=1,this._$AH=Y,this._$AN=void 0,this.element=r,this.name=e,this._$AM=i,this.options=s,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=Y;}_$AI(r,e=this,o,i){let s=this.strings,n=false;if(s===void 0)r=Ue(this,r,e,0),n=!Dr(r)||r!==this._$AH&&r!==at,n&&(this._$AH=r);else {let c=r,a,h;for(r=s[0],a=0;a<s.length-1;a++)h=Ue(this,c[o+a],e,a),h===at&&(h=this._$AH[a]),n||=!Dr(h)||h!==this._$AH[a],h===Y?r=Y:r!==Y&&(r+=(h??"")+s[a+1]),this._$AH[a]=h;}n&&!i&&this.j(r);}j(r){r===Y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,r??"");}},Ao=class extends qe{constructor(){super(...arguments),this.type=3;}j(r){this.element[this.name]=r===Y?void 0:r;}},Oo=class extends qe{constructor(){super(...arguments),this.type=4;}j(r){this.element.toggleAttribute(this.name,!!r&&r!==Y);}},To=class extends qe{constructor(r,e,o,i,s){super(r,e,o,i,s),this.type=5;}_$AI(r,e=this){if((r=Ue(this,r,e,0)??Y)===at)return;let o=this._$AH,i=r===Y&&o!==Y||r.capture!==o.capture||r.once!==o.once||r.passive!==o.passive,s=r!==Y&&(o===Y||i);i&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,r),this._$AH=r;}handleEvent(r){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,r):this._$AH.handleEvent(r);}},Io=class{constructor(r,e,o){this.element=r,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o;}get _$AU(){return this._$AM._$AU}_$AI(r){Ue(this,r);}},en={I:dr},ec=Ro.litHtmlPolyfillSupport;ec?.(Mr,dr),(Ro.litHtmlVersions??=[]).push("3.3.1");var hr=(t,r,e)=>{let o=e?.renderBefore??r,i=o._$litPart$;if(i===void 0){let s=e?.renderBefore??null;o._$litPart$=i=new dr(r.insertBefore(Pr(),s),s,void 0,e??{});}return i._$AI(t),i};var w=t=>t??Y;var rn=class{get shadowRoot(){return this.__host.__shadowRoot}constructor(r){this.ariaAtomic="",this.ariaAutoComplete="",this.ariaBrailleLabel="",this.ariaBrailleRoleDescription="",this.ariaBusy="",this.ariaChecked="",this.ariaColCount="",this.ariaColIndex="",this.ariaColSpan="",this.ariaCurrent="",this.ariaDescription="",this.ariaDisabled="",this.ariaExpanded="",this.ariaHasPopup="",this.ariaHidden="",this.ariaInvalid="",this.ariaKeyShortcuts="",this.ariaLabel="",this.ariaLevel="",this.ariaLive="",this.ariaModal="",this.ariaMultiLine="",this.ariaMultiSelectable="",this.ariaOrientation="",this.ariaPlaceholder="",this.ariaPosInSet="",this.ariaPressed="",this.ariaReadOnly="",this.ariaRequired="",this.ariaRoleDescription="",this.ariaRowCount="",this.ariaRowIndex="",this.ariaRowSpan="",this.ariaSelected="",this.ariaSetSize="",this.ariaSort="",this.ariaValueMax="",this.ariaValueMin="",this.ariaValueNow="",this.ariaValueText="",this.role="",this.form=null,this.labels=[],this.states=new Set,this.validationMessage="",this.validity={},this.willValidate=true,this.__host=r;}checkValidity(){return console.warn("`ElementInternals.checkValidity()` was called on the server.This method always returns true."),true}reportValidity(){return  true}setFormValue(){}setValidity(){}};var ne=function(t,r,e,o,i){if(typeof r=="function"?t!==r||true:!r.has(t))throw new TypeError("Cannot write private member to an object whose class did not declare it");return r.set(t,e),e},vt=function(t,r,e,o){if(typeof r=="function"?t!==r||true:!r.has(t))throw new TypeError("Cannot read private member from an object whose class did not declare it");return e==="m"?o:e==="a"?o.call(t):o?o.value:r.get(t)},ur,zo,Lo,Fr,Fi,Hr,Vo,Ke,Br,we,Po,on,sn=t=>typeof t=="boolean"?t:t?.capture??false;var Hi=class{constructor(){this.__eventListeners=new Map,this.__captureEventListeners=new Map;}addEventListener(r,e,o){if(e==null)return;let i=sn(o)?this.__captureEventListeners:this.__eventListeners,s=i.get(r);if(s===void 0)s=new Map,i.set(r,s);else if(s.has(e))return;let n=typeof o=="object"&&o?o:{};n.signal?.addEventListener("abort",()=>this.removeEventListener(r,e,o)),s.set(e,n??{});}removeEventListener(r,e,o){if(e==null)return;let i=sn(o)?this.__captureEventListeners:this.__eventListeners,s=i.get(r);s!==void 0&&(s.delete(e),s.size||i.delete(r));}dispatchEvent(r){let e=[this],o=this.__eventTargetParent;if(r.composed)for(;o;)e.push(o),o=o.__eventTargetParent;else for(;o&&o!==this.__host;)e.push(o),o=o.__eventTargetParent;let i=false,s=false,n=0,c=null,a=null,h=null,m=r.stopPropagation,d=r.stopImmediatePropagation;Object.defineProperties(r,{target:{get(){return c??a},...Z},srcElement:{get(){return r.target},...Z},currentTarget:{get(){return h},...Z},eventPhase:{get(){return n},...Z},composedPath:{value:()=>e,...Z},stopPropagation:{value:()=>{i=true,m.call(r);},...Z},stopImmediatePropagation:{value:()=>{s=true,d.call(r);},...Z}});let f=(E,S,O)=>{typeof E=="function"?E(r):typeof E?.handleEvent=="function"&&E.handleEvent(r),S.once&&O.delete(E);},g=()=>(h=null,n=0,!r.defaultPrevented),b=e.slice().reverse();c=!this.__host||!r.composed?this:null;let x=E=>{for(a=this;a.__host&&E.includes(a.__host);)a=a.__host;};for(let E of b){!c&&(!a||a===E.__host)&&x(b.slice(b.indexOf(E))),h=E,n=E===r.target?2:1;let S=E.__captureEventListeners.get(r.type);if(S){for(let[O,_]of S)if(f(O,_,S),s)return g()}if(i)return g()}let I=r.bubbles?e:[this];a=null;for(let E of I){!c&&(!a||E===a.__host)&&x(I.slice(0,I.indexOf(E)+1)),h=E,n=E===r.target?2:3;let S=E.__eventListeners.get(r.type);if(S){for(let[O,_]of S)if(f(O,_,S),s)return g()}if(i)return g()}return g()}},Bi=Hi;var Z={__proto__:null};Z.enumerable=true;Object.freeze(Z);var Wi=(we=class{constructor(r,e={}){if(ur.set(this,false),zo.set(this,false),Lo.set(this,false),Fr.set(this,false),Fi.set(this,Date.now()),Hr.set(this,false),Vo.set(this,void 0),Ke.set(this,void 0),Br.set(this,void 0),this.NONE=0,this.CAPTURING_PHASE=1,this.AT_TARGET=2,this.BUBBLING_PHASE=3,arguments.length===0)throw new Error("The type argument must be specified");if(typeof e!="object"||!e)throw new Error('The "options" argument must be an object');let{bubbles:o,cancelable:i,composed:s}=e;ne(this,ur,!!i),ne(this,zo,!!o),ne(this,Lo,!!s),ne(this,Vo,`${r}`),ne(this,Ke,null),ne(this,Br,false);}initEvent(r,e,o){throw new Error("Method not implemented.")}stopImmediatePropagation(){this.stopPropagation();}preventDefault(){ne(this,Fr,true);}get target(){return vt(this,Ke,"f")}get currentTarget(){return vt(this,Ke,"f")}get srcElement(){return vt(this,Ke,"f")}get type(){return vt(this,Vo,"f")}get cancelable(){return vt(this,ur,"f")}get defaultPrevented(){return vt(this,ur,"f")&&vt(this,Fr,"f")}get timeStamp(){return vt(this,Fi,"f")}composedPath(){return vt(this,Br,"f")?[vt(this,Ke,"f")]:[]}get returnValue(){return !vt(this,ur,"f")||!vt(this,Fr,"f")}get bubbles(){return vt(this,zo,"f")}get composed(){return vt(this,Lo,"f")}get eventPhase(){return vt(this,Br,"f")?we.AT_TARGET:we.NONE}get cancelBubble(){return vt(this,Hr,"f")}set cancelBubble(r){r&&ne(this,Hr,true);}stopPropagation(){ne(this,Hr,true);}get isTrusted(){return  false}},ur=new WeakMap,zo=new WeakMap,Lo=new WeakMap,Fr=new WeakMap,Fi=new WeakMap,Hr=new WeakMap,Vo=new WeakMap,Ke=new WeakMap,Br=new WeakMap,we.NONE=0,we.CAPTURING_PHASE=1,we.AT_TARGET=2,we.BUBBLING_PHASE=3,we);Object.defineProperties(Wi.prototype,{initEvent:Z,stopImmediatePropagation:Z,preventDefault:Z,target:Z,currentTarget:Z,srcElement:Z,type:Z,cancelable:Z,defaultPrevented:Z,timeStamp:Z,composedPath:Z,returnValue:Z,bubbles:Z,composed:Z,eventPhase:Z,cancelBubble:Z,stopPropagation:Z,isTrusted:Z});var nn=(on=class extends Wi{constructor(r,e={}){super(r,e),Po.set(this,void 0),ne(this,Po,e?.detail??null);}initCustomEvent(r,e,o,i){throw new Error("Method not implemented.")}get detail(){return vt(this,Po,"f")}},Po=new WeakMap,on);Object.defineProperties(nn.prototype,{detail:Z});var ji=Wi,Ni=nn;globalThis.Event??=ji;globalThis.CustomEvent??=Ni;var an=new WeakMap,Wr=t=>{let r=an.get(t);return r===void 0&&an.set(t,r=new Map),r},rc=class extends Bi{constructor(){super(...arguments),this.__shadowRootMode=null,this.__shadowRoot=null,this.__internals=null;}get attributes(){return Array.from(Wr(this)).map(([r,e])=>({name:r,value:e}))}get shadowRoot(){return this.__shadowRootMode==="closed"?null:this.__shadowRoot}get localName(){return this.constructor.__localName}get tagName(){return this.localName?.toUpperCase()}setAttribute(r,e){Wr(this).set(r,String(e));}removeAttribute(r){Wr(this).delete(r);}toggleAttribute(r,e){if(this.hasAttribute(r)){if(e===void 0||!e)return this.removeAttribute(r),false}else return e===void 0||e?(this.setAttribute(r,""),true):false;return  true}hasAttribute(r){return Wr(this).has(r)}attachShadow(r){let e={host:this};return this.__shadowRootMode=r.mode,r&&r.mode==="open"&&(this.__shadowRoot=e),e}attachInternals(){if(this.__internals!==null)throw new Error("Failed to execute 'attachInternals' on 'HTMLElement': ElementInternals for the specified element was already attached.");let r=new rn(this);return this.__internals=r,r}getAttribute(r){return Wr(this).get(r)??null}};var oc=class extends rc{},qi=oc;globalThis.litServerRoot??=Object.defineProperty(new qi,"localName",{get(){return "lit-server-root"}});function ic(){let t,r;return {promise:new Promise((o,i)=>{t=o,r=i;}),resolve:t,reject:r}}var Ui=class{constructor(){this.__definitions=new Map,this.__reverseDefinitions=new Map,this.__pendingWhenDefineds=new Map;}define(r,e){if(this.__definitions.has(r))if(process.env.NODE_ENV==="development")console.warn(`'CustomElementRegistry' already has "${r}" defined. This may have been caused by live reload or hot module replacement in which case it can be safely ignored.
Make sure to test your application with a production build as repeat registrations will throw in production.`);else throw new Error(`Failed to execute 'define' on 'CustomElementRegistry': the name "${r}" has already been used with this registry`);if(this.__reverseDefinitions.has(e))throw new Error(`Failed to execute 'define' on 'CustomElementRegistry': the constructor has already been used with this registry for the tag name ${this.__reverseDefinitions.get(e)}`);e.__localName=r,this.__definitions.set(r,{ctor:e,observedAttributes:e.observedAttributes??[]}),this.__reverseDefinitions.set(e,r),this.__pendingWhenDefineds.get(r)?.resolve(e),this.__pendingWhenDefineds.delete(r);}get(r){return this.__definitions.get(r)?.ctor}getName(r){return this.__reverseDefinitions.get(r)??null}upgrade(r){throw new Error("customElements.upgrade is not currently supported in SSR. Please file a bug if you need it.")}async whenDefined(r){let e=this.__definitions.get(r);if(e)return e.ctor;let o=this.__pendingWhenDefineds.get(r);return o||(o=ic(),this.__pendingWhenDefineds.set(r,o)),o.promise}},sc=Ui;var ln=new sc;var jr=globalThis,Do=jr.ShadowRoot&&(jr.ShadyCSS===void 0||jr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ki=Symbol(),cn=new WeakMap,Nr=class{constructor(r,e,o){if(this._$cssResult$=true,o!==Ki)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=r,this.t=e;}get styleSheet(){let r=this.o,e=this.t;if(Do&&r===void 0){let o=e!==void 0&&e.length===1;o&&(r=cn.get(e)),r===void 0&&((this.o=r=new CSSStyleSheet).replaceSync(this.cssText),o&&cn.set(e,r));}return r}toString(){return this.cssText}},pn=t=>new Nr(typeof t=="string"?t:t+"",void 0,Ki),y=(t,...r)=>{let e=t.length===1?t[0]:r.reduce((o,i,s)=>o+(n=>{if(n._$cssResult$===true)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new Nr(e,t,Ki)},dn=(t,r)=>{if(Do)t.adoptedStyleSheets=r.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of r){let o=document.createElement("style"),i=jr.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=e.cssText,t.appendChild(o);}},Gi=Do||jr.CSSStyleSheet===void 0?t=>t:t=>t instanceof CSSStyleSheet?(r=>{let e="";for(let o of r.cssRules)e+=o.cssText;return pn(e)})(t):t;var{is:nc,defineProperty:ac,getOwnPropertyDescriptor:lc,getOwnPropertyNames:cc,getOwnPropertySymbols:pc,getPrototypeOf:dc}=Object,qr=globalThis;qr.customElements??=ln;var hn=qr.trustedTypes,hc=hn?hn.emptyScript:"",uc=qr.reactiveElementPolyfillSupport,Ur=(t,r)=>t,Se={toAttribute(t,r){switch(r){case Boolean:t=t?hc:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t);}return t},fromAttribute(t,r){let e=t;switch(r){case Boolean:e=t!==null;break;case Number:e=t===null?null:Number(t);break;case Object:case Array:try{e=JSON.parse(t);}catch{e=null;}}return e}},Mo=(t,r)=>!nc(t,r),un={attribute:true,type:String,converter:Se,reflect:false,useDefault:false,hasChanged:Mo};Symbol.metadata??=Symbol("metadata"),qr.litPropertyMetadata??=new WeakMap;var ue=class extends(globalThis.HTMLElement??qi){static addInitializer(r){this._$Ei(),(this.l??=[]).push(r);}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(r,e=un){if(e.state&&(e.attribute=false),this._$Ei(),this.prototype.hasOwnProperty(r)&&((e=Object.create(e)).wrapped=true),this.elementProperties.set(r,e),!e.noAccessor){let o=Symbol(),i=this.getPropertyDescriptor(r,o,e);i!==void 0&&ac(this.prototype,r,i);}}static getPropertyDescriptor(r,e,o){let{get:i,set:s}=lc(this.prototype,r)??{get(){return this[e]},set(n){this[e]=n;}};return {get:i,set(n){let c=i?.call(this);s?.call(this,n),this.requestUpdate(r,c,o);},configurable:true,enumerable:true}}static getPropertyOptions(r){return this.elementProperties.get(r)??un}static _$Ei(){if(this.hasOwnProperty(Ur("elementProperties")))return;let r=dc(this);r.finalize(),r.l!==void 0&&(this.l=[...r.l]),this.elementProperties=new Map(r.elementProperties);}static finalize(){if(this.hasOwnProperty(Ur("finalized")))return;if(this.finalized=true,this._$Ei(),this.hasOwnProperty(Ur("properties"))){let e=this.properties,o=[...cc(e),...pc(e)];for(let i of o)this.createProperty(i,e[i]);}let r=this[Symbol.metadata];if(r!==null){let e=litPropertyMetadata.get(r);if(e!==void 0)for(let[o,i]of e)this.elementProperties.set(o,i);}this._$Eh=new Map;for(let[e,o]of this.elementProperties){let i=this._$Eu(e,o);i!==void 0&&this._$Eh.set(i,e);}this.elementStyles=this.finalizeStyles(this.styles);}static finalizeStyles(r){let e=[];if(Array.isArray(r)){let o=new Set(r.flat(1/0).reverse());for(let i of o)e.unshift(Gi(i));}else r!==void 0&&e.push(Gi(r));return e}static _$Eu(r,e){let o=e.attribute;return o===false?void 0:typeof o=="string"?o:typeof r=="string"?r.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=false,this.hasUpdated=false,this._$Em=null,this._$Ev();}_$Ev(){this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(r=>r(this));}addController(r){(this._$EO??=new Set).add(r),this.renderRoot!==void 0&&this.isConnected&&r.hostConnected?.();}removeController(r){this._$EO?.delete(r);}_$E_(){let r=new Map,e=this.constructor.elementProperties;for(let o of e.keys())this.hasOwnProperty(o)&&(r.set(o,this[o]),delete this[o]);r.size>0&&(this._$Ep=r);}createRenderRoot(){let r=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return dn(r,this.constructor.elementStyles),r}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(true),this._$EO?.forEach(r=>r.hostConnected?.());}enableUpdating(r){}disconnectedCallback(){this._$EO?.forEach(r=>r.hostDisconnected?.());}attributeChangedCallback(r,e,o){this._$AK(r,o);}_$ET(r,e){let o=this.constructor.elementProperties.get(r),i=this.constructor._$Eu(r,o);if(i!==void 0&&o.reflect===true){let s=(o.converter?.toAttribute!==void 0?o.converter:Se).toAttribute(e,o.type);this._$Em=r,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null;}}_$AK(r,e){let o=this.constructor,i=o._$Eh.get(r);if(i!==void 0&&this._$Em!==i){let s=o.getPropertyOptions(i),n=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:Se;this._$Em=i;let c=n.fromAttribute(e,s.type);this[i]=c??this._$Ej?.get(i)??c,this._$Em=null;}}requestUpdate(r,e,o){if(r!==void 0){let i=this.constructor,s=this[r];if(o??=i.getPropertyOptions(r),!((o.hasChanged??Mo)(s,e)||o.useDefault&&o.reflect&&s===this._$Ej?.get(r)&&!this.hasAttribute(i._$Eu(r,o))))return;this.C(r,e,o);}this.isUpdatePending===false&&(this._$ES=this._$EP());}C(r,e,{useDefault:o,reflect:i,wrapped:s},n){o&&!(this._$Ej??=new Map).has(r)&&(this._$Ej.set(r,n??e??this[r]),s!==true||n!==void 0)||(this._$AL.has(r)||(this.hasUpdated||o||(e=void 0),this._$AL.set(r,e)),i===true&&this._$Em!==r&&(this._$Eq??=new Set).add(r));}async _$EP(){this.isUpdatePending=true;try{await this._$ES;}catch(e){Promise.reject(e);}let r=this.scheduleUpdate();return r!=null&&await r,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0;}let o=this.constructor.elementProperties;if(o.size>0)for(let[i,s]of o){let{wrapped:n}=s,c=this[i];n!==true||this._$AL.has(i)||c===void 0||this.C(i,void 0,s,c);}}let r=false,e=this._$AL;try{r=this.shouldUpdate(e),r?(this.willUpdate(e),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(e)):this._$EM();}catch(o){throw r=false,this._$EM(),o}r&&this._$AE(e);}willUpdate(r){}_$AE(r){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=true,this.firstUpdated(r)),this.updated(r);}_$EM(){this._$AL=new Map,this.isUpdatePending=false;}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(r){return  true}update(r){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM();}updated(r){}firstUpdated(r){}};ue.elementStyles=[],ue.shadowRootOptions={mode:"open"},ue[Ur("elementProperties")]=new Map,ue[Ur("finalized")]=new Map,uc?.({ReactiveElement:ue}),(qr.reactiveElementVersions??=[]).push("2.1.1");var Yi=globalThis,lt=class extends ue{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0;}createRenderRoot(){let r=super.createRenderRoot();return this.renderOptions.renderBefore??=r.firstChild,r}update(r){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(r),this._$Do=hr(e,this.renderRoot,this.renderOptions);}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(true);}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(false);}render(){return at}};lt._$litElement$=true,lt.finalized=true,Yi.litElementHydrateSupport?.({LitElement:lt});var mc=Yi.litElementPolyfillSupport;mc?.({LitElement:lt});(Yi.litElementVersions??=[]).push("4.2.1");var mn=t=>(r,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(t,r);}):customElements.define(t,r);};var fc={attribute:true,type:String,converter:Se,reflect:false,hasChanged:Mo},gc=(t=fc,r,e)=>{let{kind:o,metadata:i}=e,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),o==="setter"&&((t=Object.create(t)).wrapped=true),s.set(e.name,t),o==="accessor"){let{name:n}=e;return {set(c){let a=r.get.call(this);r.set.call(this,c),this.requestUpdate(n,a,t);},init(c){return c!==void 0&&this.C(n,void 0,t,c),c}}}if(o==="setter"){let{name:n}=e;return function(c){let a=this[n];r.call(this,c),this.requestUpdate(n,a,t);}}throw Error("Unsupported decorator location: "+o)};function p(t){return (r,e)=>typeof e=="object"?gc(t,r,e):((o,i,s)=>{let n=i.hasOwnProperty(s);return i.constructor.createProperty(s,o),n?Object.getOwnPropertyDescriptor(i,s):void 0})(t,r,e)}function k(t){return p({...t,state:true,attribute:false})}function Ce(t){return (r,e)=>{let o=typeof r=="function"?r:r[e];Object.assign(o,t);}}var me=(t,r,e)=>(e.configurable=true,e.enumerable=true,Reflect.decorate&&typeof r!="object"&&Object.defineProperty(t,r,e),e);function $(t,r){return (e,o,i)=>{let s=n=>n.renderRoot?.querySelector(t)??null;return me(e,o,{get(){return s(this)}})}}var bc;function fn(t){return (r,e)=>me(r,e,{get(){return (this.renderRoot??(bc??=document.createDocumentFragment())).querySelectorAll(t)}})}function gn(t){return (r,e)=>{let{slot:o,selector:i}=t??{},s="slot"+(o?`[name=${o}]`:":not([name])");return me(r,e,{get(){let n=this.renderRoot?.querySelector(s),c=n?.assignedElements(t)??[];return i===void 0?c:c.filter(a=>a.matches(i))}})}}function ke(t){return t&&typeof t=="object"&&t.hasOwnProperty("__AS_ASYNC_COMPUTED_VALUE__")}function bn(t,r){return ke(t)?Object.assign({},t,r):Object.assign({value:t,loading:false,retry:0,progress:0,timeout:0,error:null,run:()=>{},cancel:()=>{}},r)}var vc=".";function vn(t,r,e){if(!r||r.length===0)return t;let o=Array.isArray(r)?r:r.split(vc),i,s=t;for(let n=0;n<o.length;n++){let c=o[n];if(c in s)i=s[c];else return e;s=i;}return i}function Fo(t,r,e,o){if(!r||!t)return t;let i=r;if(i.length===0)return typeof t=="object"&&Object.assign(t,e),t;{let s=t,n=[],c=(a,h,m)=>{a[h]=m;};for(let a=0;a<i.length;a++){let h=i[a];if(n.push(h),s)if(Array.isArray(s)){let m=parseInt(h,10);if(Number.isNaN(m)||m<0)throw new Error(`setVal: invalid array index ${n.join(".")}`);a===i.length-1?c(s,m,e):s=s[m];}else s instanceof Map||s instanceof WeakMap?a===i.length-1?s.set(h,e):(s.has(h)||s.set(h,{}),s=s.get(h)):typeof s=="object"&&h in s?a===i.length-1?c(s,h,e):s=s[h]:(s[h]=a===i.length-1?e:{},s=s[h]);else s[h]=a===i.length-1?e:{},s=s[h];}}return t}function yc(t){if(t==null)return "";let r=typeof t;if(r==="boolean")return String(t);if(Array.isArray(t))return t.join(",");if(r==="object")try{return JSON.stringify(t)}catch{return "{}"}return String(t)}function yn(t,r){if(!r)return t;let e=r.datatype||"any";if(e==="any")return t;if(e==="string")return yc(t);if(e==="number")return Number(t);if(Array.isArray(t))return [...t];if(typeof t=="object")return {...t};if(typeof t=="string"){if(e==="boolean")return t.toLowerCase()==="true";if(e==="array")return t.split(",").map(o=>o.trim());if(e==="object")try{return JSON.parse(t)}catch{return {}}}return e==="boolean"?!!t:t}function xn(t,r,e){return t?e(r):r}var Xi="";function _n(t){Xi=t;}function wn(t=""){if(!Xi){let r=[...document.getElementsByTagName("script")],e=r.find(o=>o.hasAttribute("data-shoelace"));if(e)_n(e.getAttribute("data-shoelace"));else {let o=r.find(s=>/shoelace(\.min)?\.js($|\?)/.test(s.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(s.src)),i="";o&&(i=o.getAttribute("src")),_n(i.split("/").slice(0,-1).join("/"));}}return Xi.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var xc={name:"default",resolver:t=>wn(`assets/icons/${t}.svg`)},Sn=xc;var Cn={caret:`
...
`;var Oe=class extends L{constructor(){super(...arguments),this.disableRole=false,this.label="";}handleFocus(t){let r=Jr(t.target);r?.toggleAttribute("data-sl-button-group__button--focus",true);}handleBlur(t){let r=Jr(t.target);r?.toggleAttribute("data-sl-button-group__button--focus",false);}handleMouseOver(t){let r=Jr(t.target);r?.toggleAttribute("data-sl-button-group__button--hover",true);}handleMouseOut(t){let r=Jr(t.target);r?.toggleAttribute("data-sl-button-group__button--hover",false);}handleSlotChange(){let t=[...this.defaultSlot.assignedElements({flatten:true})];t.forEach(r=>{let e=t.indexOf(r),o=Jr(r);o&&(o.toggleAttribute("data-sl-button-group__button",true),o.toggleAttribute("data-sl-button-group__button--first",e===0),o.toggleAttribute("data-sl-button-group__button--inner",e>0&&e<t.length-1),o.toggleAttribute("data-sl-button-group__button--last",e===t.length-1),o.toggleAttribute("data-sl-button-group__button--radio",o.tagName.toLowerCase()==="sl-radio-button"));});}render(){return u`
      <div
        part="base"
        class="button-group"
...
`;var xt=class extends L{constructor(){super(...arguments),this.formControlController=new ft(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,r)=>t.checked=r}),this.hasSlotController=new ct(this,"help-text"),this.hasFocus=false,this.title="",this.name="",this.size="medium",this.disabled=false,this.checked=false,this.defaultChecked=false,this.form="",this.required=false,this.helpText="";}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity();}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleInput(){this.emit("sl-input");}handleInvalid(t){this.formControlController.setValidity(false),this.formControlController.emitInvalidEvent(t);}handleClick(){this.checked=!this.checked,this.emit("sl-change");}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=false,this.emit("sl-change"),this.emit("sl-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=true,this.emit("sl-change"),this.emit("sl-input"));}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity();}handleDisabledChange(){this.formControlController.setValidity(true);}click(){this.input.click();}focus(t){this.input.focus(t);}blur(){this.input.blur();}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity();}render(){let t=this.hasSlotController.test("help-text"),r=this.helpText?true:!!t;return u`
    ...
    `}};xt.styles=[V,Tt,ea];l([$('input[type="checkbox"]')],xt.prototype,"input",2);l([k()],xt.prototype,"hasFocus",2);l([p()],xt.prototype,"title",2);l([p()],xt.prototype,"name",2);l([p()],xt.prototype,"value",2);l([p({reflect:true})],xt.prototype,"size",2);l([p({type:Boolean,reflect:true})],xt.prototype,"disabled",2);l([p({type:Boolean,reflect:true})],xt.prototype,"checked",2);l([Ht("checked")],xt.prototype,"defaultChecked",2);l([p({reflect:true})],xt.prototype,"form",2);l([p({type:Boolean,reflect:true})],xt.prototype,"required",2);l([p({attribute:"help-text"})],xt.prototype,"helpText",2);l([A("checked",{waitUntilFirstUpdate:true})],xt.prototype,"handleCheckedChange",1);l([A("disabled",{waitUntilFirstUpdate:true})],xt.prototype,"handleDisabledChange",1);xt.define("sl-switch");exports.AutoFieldSwitch=class ro extends R{renderInput(){return u`
        ...
        `],exports.AutoFieldSwitch=v([T("auto-field-switch")],exports.AutoFieldSwitch);var Qo=y`
  :host {
    display: inline-block;
    position: relative;
    width: auto;
...
`;var pt=class extends L{constructor(){super(...arguments),this.hasFocus=false,this.label="",this.disabled=false;}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation());}click(){this.button.click();}focus(t){this.button.focus(t);}blur(){this.button.blur();}render(){let t=!!this.href,r=t?wr`a`:wr`button`;return Te`
      <${r}
        part="base"
...
`;var le=Math.min,$t=Math.max,lo=Math.round,co=Math.floor,ee=t=>({x:t,y:t}),Wc={left:"right",right:"left",bottom:"top",top:"bottom"},jc={start:"end",end:"start"};function pi(t,r,e){return $t(t,le(r,e))}function Ye(t,r){return typeof t=="function"?t(r):t}function ge(t){return t.split("-")[0]}function Xe(t){return t.split("-")[1]}function ms(t){return t==="x"?"y":"x"}function di(t){return t==="y"?"height":"width"}var Nc=new Set(["top","bottom"]);function ce(t){return Nc.has(ge(t))?"y":"x"}function hi(t){return ms(ce(t))}function fa(t,r,e){e===void 0&&(e=false);let o=Xe(t),i=hi(t),s=di(i),n=i==="x"?o===(e?"end":"start")?"right":"left":o==="start"?"bottom":"top";return r.reference[s]>r.floating[s]&&(n=ao(n)),[n,ao(n)]}function ga(t){let r=ao(t);return [ci(t),r,ci(r)]}function ci(t){return t.replace(/start|end/g,r=>jc[r])}var ua=["left","right"],ma=["right","left"],Uc=["top","bottom"],qc=["bottom","top"];function Kc(t,r,e){switch(t){case "top":case "bottom":return e?r?ma:ua:r?ua:ma;case "left":case "right":return r?Uc:qc;default:return []}}function ba(t,r,e,o){let i=Xe(t),s=Kc(ge(t),e==="start",o);return i&&(s=s.map(n=>n+"-"+i),r&&(s=s.concat(s.map(ci)))),s}function ao(t){return t.replace(/left|right|bottom|top/g,r=>Wc[r])}function Gc(t){return {top:0,right:0,bottom:0,left:0,...t}}function fs(t){return typeof t!="number"?Gc(t):{top:t,right:t,bottom:t,left:t}}function Qe(t){let{x:r,y:e,width:o,height:i}=t;return {width:o,height:i,top:e,left:r,right:r+o,bottom:e+i,x:r,y:e}}function va(t,r,e){let{reference:o,floating:i}=t,s=ce(r),n=hi(r),c=di(n),a=ge(r),h=s==="y",m=o.x+o.width/2-i.width/2,d=o.y+o.height/2-i.height/2,f=o[c]/2-i[c]/2,g;switch(a){case "top":g={x:m,y:o.y-i.height};break;case "bottom":g={x:m,y:o.y+o.height};break;case "right":g={x:o.x+o.width,y:d};break;case "left":g={x:o.x-i.width,y:d};break;default:g={x:o.x,y:o.y};}switch(Xe(r)){case "start":g[n]-=f*(e&&h?-1:1);break;case "end":g[n]+=f*(e&&h?-1:1);break}return g}var ya=async(t,r,e)=>{let{placement:o="bottom",strategy:i="absolute",middleware:s=[],platform:n}=e,c=s.filter(Boolean),a=await(n.isRTL==null?void 0:n.isRTL(r)),h=await n.getElementRects({reference:t,floating:r,strategy:i}),{x:m,y:d}=va(h,o,a),f=o,g={},b=0;for(let x=0;x<c.length;x++){let{name:I,fn:E}=c[x],{x:S,y:O,data:_,reset:C}=await E({x:m,y:d,initialPlacement:o,placement:f,strategy:i,middlewareData:g,rects:h,platform:n,elements:{reference:t,floating:r}});m=S??m,d=O??d,g={...g,[I]:{...g[I],..._}},C&&b<=50&&(b++,typeof C=="object"&&(C.placement&&(f=C.placement),C.rects&&(h=C.rects===true?await n.getElementRects({reference:t,floating:r,strategy:i}):C.rects),{x:m,y:d}=va(h,f,a)),x=-1);}return {x:m,y:d,placement:f,strategy:i,middlewareData:g}};async function ui(t,r){var e;r===void 0&&(r={});let{x:o,y:i,platform:s,rects:n,elements:c,strategy:a}=t,{boundary:h="clippingAncestors",rootBoundary:m="viewport",elementContext:d="floating",altBoundary:f=false,padding:g=0}=Ye(r,t),b=fs(g),I=c[f?d==="floating"?"reference":"floating":d],E=Qe(await s.getClippingRect({element:(e=await(s.isElement==null?void 0:s.isElement(I)))==null||e?I:I.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(c.floating)),boundary:h,rootBoundary:m,strategy:a})),S=d==="floating"?{x:o,y:i,width:n.floating.width,height:n.floating.height}:n.reference,O=await(s.getOffsetParent==null?void 0:s.getOffsetParent(c.floating)),_=await(s.isElement==null?void 0:s.isElement(O))?await(s.getScale==null?void 0:s.getScale(O))||{x:1,y:1}:{x:1,y:1},C=Qe(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:S,offsetParent:O,strategy:a}):S);return {top:(E.top-C.top+b.top)/_.y,bottom:(C.bottom-E.bottom+b.bottom)/_.y,left:(E.left-C.left+b.left)/_.x,right:(C.right-E.right+b.right)/_.x}}var xa=t=>({name:"arrow",options:t,async fn(r){let{x:e,y:o,placement:i,rects:s,platform:n,elements:c,middlewareData:a}=r,{element:h,padding:m=0}=Ye(t,r)||{};if(h==null)return {};let d=fs(m),f={x:e,y:o},g=hi(i),b=di(g),x=await n.getDimensions(h),I=g==="y",E=I?"top":"left",S=I?"bottom":"right",O=I?"clientHeight":"clientWidth",_=s.reference[b]+s.reference[g]-f[g]-s.floating[b],C=f[g]-s.reference[g],D=await(n.getOffsetParent==null?void 0:n.getOffsetParent(h)),H=D?D[O]:0;(!H||!await(n.isElement==null?void 0:n.isElement(D)))&&(H=c.floating[O]||s.floating[b]);let U=_/2-C/2,M=H/2-x[b]/2-1,P=le(d[E],M),ht=le(d[S],M),st=P,wt=H-x[b]-ht,nt=H/2-x[b]/2+U,Ft=pi(st,nt,wt),se=!a.arrow&&Xe(i)!=null&&nt!==Ft&&s.reference[b]/2-(nt<st?P:ht)-x[b]/2<0,Zt=se?nt<st?nt-st:nt-wt:0;return {[g]:f[g]+Zt,data:{[g]:Ft,centerOffset:nt-Ft-Zt,...se&&{alignmentOffset:Zt}},reset:se}}});var _a=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(r){var e,o;let{placement:i,middlewareData:s,rects:n,initialPlacement:c,platform:a,elements:h}=r,{mainAxis:m=true,crossAxis:d=true,fallbackPlacements:f,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:x=true,...I}=Ye(t,r);if((e=s.arrow)!=null&&e.alignmentOffset)return {};let E=ge(i),S=ce(c),O=ge(c)===c,_=await(a.isRTL==null?void 0:a.isRTL(h.floating)),C=f||(O||!x?[ao(c)]:ga(c)),D=b!=="none";!f&&D&&C.push(...ba(c,x,b,_));let H=[c,...C],U=await ui(r,I),M=[],P=((o=s.flip)==null?void 0:o.overflows)||[];if(m&&M.push(U[E]),d){let nt=fa(i,n,_);M.push(U[nt[0]],U[nt[1]]);}if(P=[...P,{placement:i,overflows:M}],!M.every(nt=>nt<=0)){var ht,st;let nt=(((ht=s.flip)==null?void 0:ht.index)||0)+1,Ft=H[nt];if(Ft&&(!(d==="alignment"?S!==ce(Ft):false)||P.every(Jt=>ce(Jt.placement)===S?Jt.overflows[0]>0:true)))return {data:{index:nt,overflows:P},reset:{placement:Ft}};let se=(st=P.filter(Zt=>Zt.overflows[0]<=0).sort((Zt,Jt)=>Zt.overflows[1]-Jt.overflows[1])[0])==null?void 0:st.placement;if(!se)switch(g){case "bestFit":{var wt;let Zt=(wt=P.filter(Jt=>{if(D){let _e=ce(Jt.placement);return _e===S||_e==="y"}return  true}).map(Jt=>[Jt.placement,Jt.overflows.filter(_e=>_e>0).reduce((_e,ql)=>_e+ql,0)]).sort((Jt,_e)=>Jt[1]-_e[1])[0])==null?void 0:wt[0];Zt&&(se=Zt);break}case "initialPlacement":se=c;break}if(i!==se)return {reset:{placement:se}}}return {}}}};var Yc=new Set(["left","top"]);async function Xc(t,r){let{placement:e,platform:o,elements:i}=t,s=await(o.isRTL==null?void 0:o.isRTL(i.floating)),n=ge(e),c=Xe(e),a=ce(e)==="y",h=Yc.has(n)?-1:1,m=s&&a?-1:1,d=Ye(r,t),{mainAxis:f,crossAxis:g,alignmentAxis:b}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return c&&typeof b=="number"&&(g=c==="end"?b*-1:b),a?{x:g*m,y:f*h}:{x:f*h,y:g*m}}var wa=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(r){var e,o;let{x:i,y:s,placement:n,middlewareData:c}=r,a=await Xc(r,t);return n===((e=c.offset)==null?void 0:e.placement)&&(o=c.arrow)!=null&&o.alignmentOffset?{}:{x:i+a.x,y:s+a.y,data:{...a,placement:n}}}}},Sa=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(r){let{x:e,y:o,placement:i}=r,{mainAxis:s=true,crossAxis:n=false,limiter:c={fn:I=>{let{x:E,y:S}=I;return {x:E,y:S}}},...a}=Ye(t,r),h={x:e,y:o},m=await ui(r,a),d=ce(ge(i)),f=ms(d),g=h[f],b=h[d];if(s){let I=f==="y"?"top":"left",E=f==="y"?"bottom":"right",S=g+m[I],O=g-m[E];g=pi(S,g,O);}if(n){let I=d==="y"?"top":"left",E=d==="y"?"bottom":"right",S=b+m[I],O=b-m[E];b=pi(S,b,O);}let x=c.fn({...r,[f]:g,[d]:b});return {...x,data:{x:x.x-e,y:x.y-o,enabled:{[f]:s,[d]:n}}}}}};var Ca=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(r){var e,o;let{placement:i,rects:s,platform:n,elements:c}=r,{apply:a=()=>{},...h}=Ye(t,r),m=await ui(r,h),d=ge(i),f=Xe(i),g=ce(i)==="y",{width:b,height:x}=s.floating,I,E;d==="top"||d==="bottom"?(I=d,E=f===(await(n.isRTL==null?void 0:n.isRTL(c.floating))?"start":"end")?"left":"right"):(E=d,I=f==="end"?"top":"bottom");let S=x-m.top-m.bottom,O=b-m.left-m.right,_=le(x-m[I],S),C=le(b-m[E],O),D=!r.middlewareData.shift,H=_,U=C;if((e=r.middlewareData.shift)!=null&&e.enabled.x&&(U=O),(o=r.middlewareData.shift)!=null&&o.enabled.y&&(H=S),D&&!f){let P=$t(m.left,0),ht=$t(m.right,0),st=$t(m.top,0),wt=$t(m.bottom,0);g?U=b-2*(P!==0||ht!==0?P+ht:$t(m.left,m.right)):H=x-2*(st!==0||wt!==0?st+wt:$t(m.top,m.bottom));}await a({...r,availableWidth:U,availableHeight:H});let M=await n.getDimensions(c.floating);return b!==M.width||x!==M.height?{reset:{rects:true}}:{}}}};function mi(){return typeof window<"u"}function Ze(t){return $a(t)?(t.nodeName||"").toLowerCase():"#document"}function It(t){var r;return (t==null||(r=t.ownerDocument)==null?void 0:r.defaultView)||window}function re(t){var r;return (r=($a(t)?t.ownerDocument:t.document)||window.document)==null?void 0:r.documentElement}function $a(t){return mi()?t instanceof Node||t instanceof It(t).Node:false}function Wt(t){return mi()?t instanceof Element||t instanceof It(t).Element:false}function oe(t){return mi()?t instanceof HTMLElement||t instanceof It(t).HTMLElement:false}function ka(t){return !mi()||typeof ShadowRoot>"u"?false:t instanceof ShadowRoot||t instanceof It(t).ShadowRoot}var Qc=new Set(["inline","contents"]);function $r(t){let{overflow:r,overflowX:e,overflowY:o,display:i}=jt(t);return /auto|scroll|overlay|hidden|clip/.test(r+o+e)&&!Qc.has(i)}var Zc=new Set(["table","td","th"]);function Ea(t){return Zc.has(Ze(t))}var Jc=[":popover-open",":modal"];function po(t){return Jc.some(r=>{try{return t.matches(r)}catch{return  false}})}var tp=["transform","translate","scale","rotate","perspective"],ep=["transform","translate","scale","rotate","perspective","filter"],rp=["paint","layout","strict","content"];function Er(t){let r=fi(),e=Wt(t)?jt(t):t;return tp.some(o=>e[o]?e[o]!=="none":false)||(e.containerType?e.containerType!=="normal":false)||!r&&(e.backdropFilter?e.backdropFilter!=="none":false)||!r&&(e.filter?e.filter!=="none":false)||ep.some(o=>(e.willChange||"").includes(o))||rp.some(o=>(e.contain||"").includes(o))}function Aa(t){let r=be(t);for(;oe(r)&&!Je(r);){if(Er(r))return r;if(po(r))return null;r=be(r);}return null}function fi(){return typeof CSS>"u"||!CSS.supports?false:CSS.supports("-webkit-backdrop-filter","none")}var op=new Set(["html","body","#document"]);function Je(t){return op.has(Ze(t))}function jt(t){return It(t).getComputedStyle(t)}function ho(t){return Wt(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function be(t){if(Ze(t)==="html")return t;let r=t.assignedSlot||t.parentNode||ka(t)&&t.host||re(t);return ka(r)?r.host:r}function Oa(t){let r=be(t);return Je(r)?t.ownerDocument?t.ownerDocument.body:t.body:oe(r)&&$r(r)?r:Oa(r)}function kr(t,r,e){var o;r===void 0&&(r=[]),e===void 0&&(e=true);let i=Oa(t),s=i===((o=t.ownerDocument)==null?void 0:o.body),n=It(i);if(s){let c=gi(n);return r.concat(n,n.visualViewport||[],$r(i)?i:[],c&&e?kr(c):[])}return r.concat(i,kr(i,[],e))}function gi(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function za(t){let r=jt(t),e=parseFloat(r.width)||0,o=parseFloat(r.height)||0,i=oe(t),s=i?t.offsetWidth:e,n=i?t.offsetHeight:o,c=lo(e)!==s||lo(o)!==n;return c&&(e=s,o=n),{width:e,height:o,$:c}}function bs(t){return Wt(t)?t:t.contextElement}function Ar(t){let r=bs(t);if(!oe(r))return ee(1);let e=r.getBoundingClientRect(),{width:o,height:i,$:s}=za(r),n=(s?lo(e.width):e.width)/o,c=(s?lo(e.height):e.height)/i;return (!n||!Number.isFinite(n))&&(n=1),(!c||!Number.isFinite(c))&&(c=1),{x:n,y:c}}var ip=ee(0);function La(t){let r=It(t);return !fi()||!r.visualViewport?ip:{x:r.visualViewport.offsetLeft,y:r.visualViewport.offsetTop}}function sp(t,r,e){return r===void 0&&(r=false),!e||r&&e!==It(t)?false:r}function tr(t,r,e,o){r===void 0&&(r=false),e===void 0&&(e=false);let i=t.getBoundingClientRect(),s=bs(t),n=ee(1);r&&(o?Wt(o)&&(n=Ar(o)):n=Ar(t));let c=sp(s,e,o)?La(s):ee(0),a=(i.left+c.x)/n.x,h=(i.top+c.y)/n.y,m=i.width/n.x,d=i.height/n.y;if(s){let f=It(s),g=o&&Wt(o)?It(o):o,b=f,x=gi(b);for(;x&&o&&g!==b;){let I=Ar(x),E=x.getBoundingClientRect(),S=jt(x),O=E.left+(x.clientLeft+parseFloat(S.paddingLeft))*I.x,_=E.top+(x.clientTop+parseFloat(S.paddingTop))*I.y;a*=I.x,h*=I.y,m*=I.x,d*=I.y,a+=O,h+=_,b=It(x),x=gi(b);}}return Qe({width:m,height:d,x:a,y:h})}function bi(t,r){let e=ho(t).scrollLeft;return r?r.left+e:tr(re(t)).left+e}function Va(t,r){let e=t.getBoundingClientRect(),o=e.left+r.scrollLeft-bi(t,e),i=e.top+r.scrollTop;return {x:o,y:i}}function np(t){let{elements:r,rect:e,offsetParent:o,strategy:i}=t,s=i==="fixed",n=re(o),c=r?po(r.floating):false;if(o===n||c&&s)return e;let a={scrollLeft:0,scrollTop:0},h=ee(1),m=ee(0),d=oe(o);if((d||!d&&!s)&&((Ze(o)!=="body"||$r(n))&&(a=ho(o)),oe(o))){let g=tr(o);h=Ar(o),m.x=g.x+o.clientLeft,m.y=g.y+o.clientTop;}let f=n&&!d&&!s?Va(n,a):ee(0);return {width:e.width*h.x,height:e.height*h.y,x:e.x*h.x-a.scrollLeft*h.x+m.x+f.x,y:e.y*h.y-a.scrollTop*h.y+m.y+f.y}}function ap(t){return Array.from(t.getClientRects())}function lp(t){let r=re(t),e=ho(t),o=t.ownerDocument.body,i=$t(r.scrollWidth,r.clientWidth,o.scrollWidth,o.clientWidth),s=$t(r.scrollHeight,r.clientHeight,o.scrollHeight,o.clientHeight),n=-e.scrollLeft+bi(t),c=-e.scrollTop;return jt(o).direction==="rtl"&&(n+=$t(r.clientWidth,o.clientWidth)-i),{width:i,height:s,x:n,y:c}}var Ta=25;function cp(t,r){let e=It(t),o=re(t),i=e.visualViewport,s=o.clientWidth,n=o.clientHeight,c=0,a=0;if(i){s=i.width,n=i.height;let m=fi();(!m||m&&r==="fixed")&&(c=i.offsetLeft,a=i.offsetTop);}let h=bi(o);if(h<=0){let m=o.ownerDocument,d=m.body,f=getComputedStyle(d),g=m.compatMode==="CSS1Compat"&&parseFloat(f.marginLeft)+parseFloat(f.marginRight)||0,b=Math.abs(o.clientWidth-d.clientWidth-g);b<=Ta&&(s-=b);}else h<=Ta&&(s+=h);return {width:s,height:n,x:c,y:a}}var pp=new Set(["absolute","fixed"]);function dp(t,r){let e=tr(t,true,r==="fixed"),o=e.top+t.clientTop,i=e.left+t.clientLeft,s=oe(t)?Ar(t):ee(1),n=t.clientWidth*s.x,c=t.clientHeight*s.y,a=i*s.x,h=o*s.y;return {width:n,height:c,x:a,y:h}}function Ia(t,r,e){let o;if(r==="viewport")o=cp(t,e);else if(r==="document")o=lp(re(t));else if(Wt(r))o=dp(r,e);else {let i=La(t);o={x:r.x-i.x,y:r.y-i.y,width:r.width,height:r.height};}return Qe(o)}function Pa(t,r){let e=be(t);return e===r||!Wt(e)||Je(e)?false:jt(e).position==="fixed"||Pa(e,r)}function hp(t,r){let e=r.get(t);if(e)return e;let o=kr(t,[],false).filter(c=>Wt(c)&&Ze(c)!=="body"),i=null,s=jt(t).position==="fixed",n=s?be(t):t;for(;Wt(n)&&!Je(n);){let c=jt(n),a=Er(n);!a&&c.position==="fixed"&&(i=null),(s?!a&&!i:!a&&c.position==="static"&&!!i&&pp.has(i.position)||$r(n)&&!a&&Pa(t,n))?o=o.filter(m=>m!==n):i=c,n=be(n);}return r.set(t,o),o}function up(t){let{element:r,boundary:e,rootBoundary:o,strategy:i}=t,n=[...e==="clippingAncestors"?po(r)?[]:hp(r,this._c):[].concat(e),o],c=n[0],a=n.reduce((h,m)=>{let d=Ia(r,m,i);return h.top=$t(d.top,h.top),h.right=le(d.right,h.right),h.bottom=le(d.bottom,h.bottom),h.left=$t(d.left,h.left),h},Ia(r,c,i));return {width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}}function mp(t){let{width:r,height:e}=za(t);return {width:r,height:e}}function fp(t,r,e){let o=oe(r),i=re(r),s=e==="fixed",n=tr(t,true,s,r),c={scrollLeft:0,scrollTop:0},a=ee(0);function h(){a.x=bi(i);}if(o||!o&&!s)if((Ze(r)!=="body"||$r(i))&&(c=ho(r)),o){let g=tr(r,true,s,r);a.x=g.x+r.clientLeft,a.y=g.y+r.clientTop;}else i&&h();s&&!o&&i&&h();let m=i&&!o&&!s?Va(i,c):ee(0),d=n.left+c.scrollLeft-a.x-m.x,f=n.top+c.scrollTop-a.y-m.y;return {x:d,y:f,width:n.width,height:n.height}}function gs(t){return jt(t).position==="static"}function Ra(t,r){if(!oe(t)||jt(t).position==="fixed")return null;if(r)return r(t);let e=t.offsetParent;return re(t)===e&&(e=e.ownerDocument.body),e}function Da(t,r){let e=It(t);if(po(t))return e;if(!oe(t)){let i=be(t);for(;i&&!Je(i);){if(Wt(i)&&!gs(i))return i;i=be(i);}return e}let o=Ra(t,r);for(;o&&Ea(o)&&gs(o);)o=Ra(o,r);return o&&Je(o)&&gs(o)&&!Er(o)?e:o||Aa(t)||e}var gp=async function(t){let r=this.getOffsetParent||Da,e=this.getDimensions,o=await e(t.floating);return {reference:fp(t.reference,await r(t.floating),t.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function bp(t){return jt(t).direction==="rtl"}var uo={convertOffsetParentRelativeRectToViewportRelativeRect:np,getDocumentElement:re,getClippingRect:up,getOffsetParent:Da,getElementRects:gp,getClientRects:ap,getDimensions:mp,getScale:Ar,isElement:Wt,isRTL:bp};function Ma(t,r){return t.x===r.x&&t.y===r.y&&t.width===r.width&&t.height===r.height}function vp(t,r){let e=null,o,i=re(t);function s(){var c;clearTimeout(o),(c=e)==null||c.disconnect(),e=null;}function n(c,a){c===void 0&&(c=false),a===void 0&&(a=1),s();let h=t.getBoundingClientRect(),{left:m,top:d,width:f,height:g}=h;if(c||r(),!f||!g)return;let b=co(d),x=co(i.clientWidth-(m+f)),I=co(i.clientHeight-(d+g)),E=co(m),O={rootMargin:-b+"px "+-x+"px "+-I+"px "+-E+"px",threshold:$t(0,le(1,a))||1},_=true;function C(D){let H=D[0].intersectionRatio;if(H!==a){if(!_)return n();H?n(false,H):o=setTimeout(()=>{n(false,1e-7);},1e3);}H===1&&!Ma(h,t.getBoundingClientRect())&&n(),_=false;}try{e=new IntersectionObserver(C,{...O,root:i.ownerDocument});}catch{e=new IntersectionObserver(C,O);}e.observe(t);}return n(true),s}function Fa(t,r,e,o){o===void 0&&(o={});let{ancestorScroll:i=true,ancestorResize:s=true,elementResize:n=typeof ResizeObserver=="function",layoutShift:c=typeof IntersectionObserver=="function",animationFrame:a=false}=o,h=bs(t),m=i||s?[...h?kr(h):[],...kr(r)]:[];m.forEach(E=>{i&&E.addEventListener("scroll",e,{passive:true}),s&&E.addEventListener("resize",e);});let d=h&&c?vp(h,e):null,f=-1,g=null;n&&(g=new ResizeObserver(E=>{let[S]=E;S&&S.target===h&&g&&(g.unobserve(r),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var O;(O=g)==null||O.observe(r);})),e();}),h&&!a&&g.observe(h),g.observe(r));let b,x=a?tr(t):null;a&&I();function I(){let E=tr(t);x&&!Ma(x,E)&&e(),x=E,b=requestAnimationFrame(I);}return e(),()=>{var E;m.forEach(S=>{i&&S.removeEventListener("scroll",e),s&&S.removeEventListener("resize",e);}),d?.(),(E=g)==null||E.disconnect(),g=null,a&&cancelAnimationFrame(b);}}var Ha=wa;var Ba=Sa,Wa=_a,vs=Ca;var ja=xa;var Na=(t,r,e)=>{let o=new Map,i={platform:uo,...e},s={...i.platform,_c:o};return ya(t,r,{...i,platform:s})};function Ua(t){return yp(t)}function ys(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function yp(t){for(let r=t;r;r=ys(r))if(r instanceof Element&&getComputedStyle(r).display==="none")return null;for(let r=ys(t);r;r=ys(r)){if(!(r instanceof Element))continue;let e=getComputedStyle(r);if(e.display!=="contents"&&(e.position!=="static"||Er(e)||r.tagName==="BODY"))return r}return null}function xp(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t.contextElement instanceof Element:true)}var X=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.active=false,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=false,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=false,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=false,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=false,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let t=this.anchorEl.getBoundingClientRect(),r=this.popup.getBoundingClientRect(),e=this.placement.includes("top")||this.placement.includes("bottom"),o=0,i=0,s=0,n=0,c=0,a=0,h=0,m=0;e?t.top<r.top?(o=t.left,i=t.bottom,s=t.right,n=t.bottom,c=r.left,a=r.top,h=r.right,m=r.top):(o=r.left,i=r.bottom,s=r.right,n=r.bottom,c=t.left,a=t.top,h=t.right,m=t.top):t.left<r.left?(o=t.right,i=t.top,s=r.left,n=r.top,c=t.right,a=t.bottom,h=r.left,m=r.bottom):(o=r.right,i=r.top,s=t.left,n=t.top,c=r.right,a=r.bottom,h=t.left,m=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${a}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${m}px`);}};}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start();}disconnectedCallback(){super.disconnectedCallback(),this.stop();}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition());}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor);}else this.anchor instanceof Element||xp(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:true})[0]),this.anchorEl&&this.active&&this.start();}start(){!this.anchorEl||!this.active||(this.cleanup=Fa(this.anchorEl,this.popup,()=>{this.reposition();}));}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t();})}reposition(){if(!this.active||!this.anchorEl)return;let t=[Ha({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(vs({apply:({rects:e})=>{let o=this.sync==="width"||this.sync==="both",i=this.sync==="height"||this.sync==="both";this.popup.style.width=o?`${e.reference.width}px`:"",this.popup.style.height=i?`${e.reference.height}px`:"";}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(Wa({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Ba({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(vs({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:o})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${o}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width");}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(ja({element:this.arrowEl,padding:this.arrowPadding}));let r=this.strategy==="absolute"?e=>uo.getOffsetParent(e,Ua):uo.getOffsetParent;Na(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:fe(St({},uo),{getOffsetParent:r})}).then(({x:e,y:o,middlewareData:i,placement:s})=>{let n=this.localize.dir()==="rtl",c={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${e}px`,top:`${o}px`}),this.arrow){let a=i.arrow.x,h=i.arrow.y,m="",d="",f="",g="";if(this.arrowPlacement==="start"){let b=typeof a=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";m=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",d=n?b:"",g=n?"":b;}else if(this.arrowPlacement==="end"){let b=typeof a=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";d=n?"":b,g=n?b:"",f=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";}else this.arrowPlacement==="center"?(g=typeof a=="number"?"calc(50% - var(--arrow-size-diagonal))":"",m=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(g=typeof a=="number"?`${a}px`:"",m=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:m,right:d,bottom:f,left:g,[c]:"calc(var(--arrow-size-diagonal) * -1)"});}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition");}render(){return u`
...
`;var Ct=".";var xs="__AS_ASYNC_COMPUTED_VALUE__";function xi(t){return toString.call(t)==="[object Map]"}function Re(t){return t&&typeof t=="object"&&t.hasOwnProperty(xs)}function Ss(t,r){let e=t.get(r);if(e!==void 0)return e;let o=t.get(Number(r)||r);if(o!==void 0)return o}function ye(t,r,e){if(!r||r.length===0)return t;let o=Array.isArray(r)?r:r.split(Ct),i,s=t;for(let n=0;n<o.length;n++){let c=o[n];if(xi(s))i=Ss(s,c);else if(c in s)i=s[c];else return e;s=i;}return i}function ks(t,r){return t.length>r.length?false:t.every((e,o)=>e===r[o])}(t=>typeof He<"u"?He:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof He<"u"?He:r)[e]}):t)(function(t){if(typeof He<"u")return He.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var ze=class{constructor(r,e,o){this.path=e;this.handle=o;this._loading=false;this._ready=false;this.host=r,r.addController(this);}get loading(){return this._loading}get value(){return this._value}load(){let r=this.host.schema,e=ye(r,this.path);Re(e)?e.loading?(this._loading=true,this._value=this.handle(void 0)):(this._ready=e.value!==void 0,this._value=this.handle(e.value),this._loading=false):(this._ready=true,this._value=this.handle(e),this._loading=false);}render(r){return u`
            ${B(this.loading,()=>u`<auto-loading></auto-loading>`,()=>r(this._value))}
        `}hostUpdate(){this._ready||this.load();}hostUpdated(){}};exports.AutoFieldSelect=class mo extends R{constructor(){super(...arguments);this.valueKey="value";this.labelKey="label";this.items=new ze(this,"select",e=>e?e.map(o=>{let i={};return typeof o=="object"?Object.assign(i,o):typeof o=="string"&&o.startsWith("-")?Object.assign(i,{type:"divider"}):Object.assign(i,{label:o}),i}):[]);}getInitialOptions(){return {valueKey:"value",labelKey:"label",select:[],multiple:false,clearable:true,maxOptionsVisible:0,placement:"top"}}_renderItem(e){let o=this.options.renderItem;return typeof o=="string"?u`${Ot(o.replace(/\{(.+?)\}/g,(i,s)=>e[s]))}`:typeof o=="function"?u`${Ot(o(e))}`:e.label||e.value}_onDropdownMenu(){}renderInput(){return u`
            <sl-select
                name="${this.name}"
                data-path="${this.path}"
                value="${this.getValue()}"
...
`;var xe=class extends L{constructor(){super(...arguments),this.localize=new W(this);}render(){return u`
    ...
    `}};N.styles=[V,hl];N.dependencies={"sl-button-group":Oe,"sl-button":G,"sl-dropdown":ut,"sl-icon":q,"sl-input":F,"sl-visually-hidden":Es};l([$('[part~="base"]')],N.prototype,"base",2);l([$('[part~="input"]')],N.prototype,"input",2);l([$(".color-dropdown")],N.prototype,"dropdown",2);l([$('[part~="preview"]')],N.prototype,"previewButton",2);l([$('[part~="trigger"]')],N.prototype,"trigger",2);l([k()],N.prototype,"hasFocus",2);l([k()],N.prototype,"isDraggingGridHandle",2);l([k()],N.prototype,"isEmpty",2);l([k()],N.prototype,"inputValue",2);l([k()],N.prototype,"hue",2);l([k()],N.prototype,"saturation",2);l([k()],N.prototype,"brightness",2);l([k()],N.prototype,"alpha",2);l([p()],N.prototype,"value",2);l([Ht()],N.prototype,"defaultValue",2);l([p()],N.prototype,"label",2);l([p()],N.prototype,"format",2);l([p({type:Boolean,reflect:true})],N.prototype,"inline",2);l([p({reflect:true})],N.prototype,"size",2);l([p({attribute:"no-format-toggle",type:Boolean})],N.prototype,"noFormatToggle",2);l([p()],N.prototype,"name",2);l([p({type:Boolean,reflect:true})],N.prototype,"disabled",2);l([p({type:Boolean})],N.prototype,"hoist",2);l([p({type:Boolean})],N.prototype,"opacity",2);l([p({type:Boolean})],N.prototype,"uppercase",2);l([p()],N.prototype,"swatches",2);l([p({reflect:true})],N.prototype,"form",2);l([p({type:Boolean,reflect:true})],N.prototype,"required",2);l([Ce({passive:false})],N.prototype,"handleTouchMove",1);l([A("format",{waitUntilFirstUpdate:true})],N.prototype,"handleFormatChange",1);l([A("opacity",{waitUntilFirstUpdate:true})],N.prototype,"handleOpacityChange",1);l([A("value")],N.prototype,"handleValueChange",1);N.define("sl-color-picker");var Zp=["#ffffff","#f1f1f1","#bfbfbf","#262626","#f5222d","#fa541c","#fa8c16","#faad14","#fadb14","#a0d911","#52c41a","#13c2c2","#1890ff","#2f54eb","#722ed1","#eb2f96"];exports.AutoFieldColorPicker=class xo extends R{getInitialOptions(){return {format:"hex",opacity:false,inline:false,swatches:Zp}}renderInput(){return u`
            ${this._renderColors()}
            <sl-color-picker
                name=${this.name}
                data-path=${this.path}
...
`;var Ci=class extends L{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu");}handleClick(t){let r=["menuitem","menuitemcheckbox"],e=t.composedPath(),o=e.find(c=>{var a;return r.includes(((a=c?.getAttribute)==null?void 0:a.call(c,"role"))||"")});if(!o||e.find(c=>{var a;return ((a=c?.getAttribute)==null?void 0:a.call(c,"role"))==="menu"})!==this)return;let n=o;n.type==="checkbox"&&(n.checked=!n.checked),this.emit("sl-select",{detail:{item:n}});}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){let r=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),r?.click();}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){let r=this.getAllItems(),e=this.getCurrentItem(),o=e?r.indexOf(e):0;r.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?o++:t.key==="ArrowUp"?o--:t.key==="Home"?o=0:t.key==="End"&&(o=r.length-1),o<0&&(o=r.length-1),o>r.length-1&&(o=0),this.setCurrentItem(r[o]),r[o].focus());}}handleMouseDown(t){let r=t.target;this.isMenuItem(r)&&this.setCurrentItem(r);}handleSlotChange(){let t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0]);}isMenuItem(t){var r;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((r=t.getAttribute("role"))!=null?r:"")}getAllItems(){return [...this.defaultSlot.assignedElements({flatten:true})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(e=>{e.setAttribute("tabindex",e===t?"0":"-1");});}render(){return u`
      ...
      ></slot>
    `}};Ci.styles=[V,wl];l([$("slot")],Ci.prototype,"defaultSlot",2);Ci.define("sl-menu");var Sl=y`
  :host {
    --submenu-offset: -2px;
...
`;var Ds=()=>null,Lt=class extends L{constructor(){super(...arguments),this.isCollapsed=false,this.localize=new W(this),this.positionBeforeCollapsing=0,this.position=50,this.vertical=false,this.disabled=false,this.snapValue="",this.snapFunction=Ds,this.snapThreshold=12;}toSnapFunction(t){let r=t.split(" ");return ({pos:e,size:o,snapThreshold:i,isRtl:s,vertical:n})=>{let c=e,a=Number.POSITIVE_INFINITY;return r.forEach(h=>{let m;if(h.startsWith("repeat(")){let f=t.substring(7,t.length-1),g=f.endsWith("%"),b=Number.parseFloat(f),x=g?o*(b/100):b;m=Math.round((s&&!n?o-e:e)/x)*x;}else h.endsWith("%")?m=o*(Number.parseFloat(h)/100):m=Number.parseFloat(h);s&&!n&&(m=o-m);let d=Math.abs(e-m);d<=i&&d<a&&(c=m,a=d);}),c}}set snap(t){this.snapValue=t??"",t?this.snapFunction=typeof t=="string"?this.toSnapFunction(t):t:this.snapFunction=Ds;}get snap(){return this.snapValue}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>this.handleResize(t)),this.updateComplete.then(()=>this.resizeObserver.observe(this)),this.detectSize(),this.cachedPositionInPixels=this.percentageToPixels(this.position);}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.resizeObserver)==null||t.unobserve(this);}detectSize(){let{width:t,height:r}=this.getBoundingClientRect();this.size=this.vertical?r:t;}percentageToPixels(t){return this.size*(t/100)}pixelsToPercentage(t){return t/this.size*100}handleDrag(t){let r=this.localize.dir()==="rtl";this.disabled||(t.cancelable&&t.preventDefault(),Tr(this,{onMove:(e,o)=>{var i;let s=this.vertical?o:e;this.primary==="end"&&(s=this.size-s),s=(i=this.snapFunction({pos:s,size:this.size,snapThreshold:this.snapThreshold,isRtl:r,vertical:this.vertical}))!=null?i:s,this.position=dt(this.pixelsToPercentage(s),0,100);},initialEvent:t}));}handleKeyDown(t){if(!this.disabled&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End","Enter"].includes(t.key)){let r=this.position,e=(t.shiftKey?10:1)*(this.primary==="end"?-1:1);if(t.preventDefault(),(t.key==="ArrowLeft"&&!this.vertical||t.key==="ArrowUp"&&this.vertical)&&(r-=e),(t.key==="ArrowRight"&&!this.vertical||t.key==="ArrowDown"&&this.vertical)&&(r+=e),t.key==="Home"&&(r=this.primary==="end"?100:0),t.key==="End"&&(r=this.primary==="end"?0:100),t.key==="Enter")if(this.isCollapsed)r=this.positionBeforeCollapsing,this.isCollapsed=false;else {let o=this.position;r=0,requestAnimationFrame(()=>{this.isCollapsed=true,this.positionBeforeCollapsing=o;});}this.position=dt(r,0,100);}}handleResize(t){let{width:r,height:e}=t[0].contentRect;this.size=this.vertical?e:r,(isNaN(this.cachedPositionInPixels)||this.position===1/0)&&(this.cachedPositionInPixels=Number(this.getAttribute("position-in-pixels")),this.positionInPixels=Number(this.getAttribute("position-in-pixels")),this.position=this.pixelsToPercentage(this.positionInPixels)),this.primary&&(this.position=this.pixelsToPercentage(this.cachedPositionInPixels));}handlePositionChange(){this.cachedPositionInPixels=this.percentageToPixels(this.position),this.isCollapsed=false,this.positionBeforeCollapsing=0,this.positionInPixels=this.percentageToPixels(this.position),this.emit("sl-reposition");}handlePositionInPixelsChange(){this.position=this.pixelsToPercentage(this.positionInPixels);}handleVerticalChange(){this.detectSize();}render(){let t=this.vertical?"gridTemplateRows":"gridTemplateColumns",r=this.vertical?"gridTemplateColumns":"gridTemplateRows",e=this.localize.dir()==="rtl",o=`
    ...
    `}};Lt.styles=[V,Al];l([$(".divider")],Lt.prototype,"divider",2);l([p({type:Number,reflect:true})],Lt.prototype,"position",2);l([p({attribute:"position-in-pixels",type:Number})],Lt.prototype,"positionInPixels",2);l([p({type:Boolean,reflect:true})],Lt.prototype,"vertical",2);l([p({type:Boolean,reflect:true})],Lt.prototype,"disabled",2);l([p()],Lt.prototype,"primary",2);l([p({reflect:true})],Lt.prototype,"snap",1);l([p({type:Number,attribute:"snap-threshold"})],Lt.prototype,"snapThreshold",2);l([A("position")],Lt.prototype,"handlePositionChange",1);l([A("positionInPixels")],Lt.prototype,"handlePositionInPixelsChange",1);l([A("vertical")],Lt.prototype,"handleVerticalChange",1);Lt.define("sl-split-panel");ae.define("sl-tag");exports.AutoFieldList=class ir extends R{constructor(){super(...arguments);this.selection=[];this.valueKey="id";this.labelKey="label";this.scrollbar=new Ie(this);this.scrollbars=[];this.items=new ze(this,"select",e=>e?(e.forEach(o=>{this.isItemSelected(o)&&this.selection.push(o[this.valueKey]);}),e):[]);this.selectedTips="";}getInitialOptions(){return {valueKey:"value",labelKey:"label",multiple:false,maxItems:0,minItems:0,showResults:false,itemTemplate:void 0,select:[]}}_createScrollbars(){this.shadowRoot?.querySelectorAll("sl-menu,.results")?.forEach(o=>{this.scrollbars.push(this.scrollbar.create(o,{width:"5px"}));});}_destoryScrollbars(){this.scrollbars?.forEach(e=>{e.destroy();});}connectedCallback(){super.connectedCallback(),this.options&&(this.valueKey=this.options.valueKey,this.labelKey=this.options.labelKey,this.setPresetActions()),this.style.height="auto";}firstUpdated(){this._createScrollbars();}disconnectedCallback(){super.disconnectedCallback(),this._destoryScrollbars();}isItemSelected(e){return this.value===void 0?false:this.options.multiple===false?this.value===e[this.valueKey]:this.value.includes(e[this.valueKey])}_addSecectItem(e){this.selection.findIndex(i=>i[this.valueKey]===e[this.valueKey])===-1&&(this.options.multiple===false&&this.selection.length>0&&this.selection.splice(0,this.selection.length),this.selection.push(e[this.valueKey]));}_removeSelectItem(e){for(let o=this.selection.length-1;o>=0;o--)this.selection[o]===e&&this.selection.splice(o,1);this.onFieldChange(),this.requestUpdate();}_onSelectItem(e){let o=e.detail.item,i=o.dataset.index,s=this.items.value[i];s&&(o.checked?this._addSecectItem(s):this._removeSelectItem(s[this.valueKey]),this.selectedTips=`${this.selection.length}/${this.items.value.length}`,this.onFieldChange());}_renderWithSplitPanel(e){return this.options.showResults&&this.options.multiple?u`<sl-split-panel position="60"> ${e} ${this.renderResults()} </sl-split-panel>`:e}_renderItem(e){let o=this.options.renderItem;return typeof o=="string"?u`${Ot(o.replace(/\{(.+?)\}/g,(i,s)=>e[s]))}`:typeof o=="function"?u`${Ot(o(e))}`:e.label}_onClickPresetAction(e){e==="all"?this.selection=this.items.value.map(o=>o[this.valueKey]):e==="reverse"?this.selection=this.items.value.filter(o=>!this.selection.includes(o[this.valueKey])).map(o=>o[this.valueKey]):e==="clear"&&(this.selection=[]),this.onFieldChange(),this.requestUpdate();}setPresetActions(){let e=[];this.options.multiple&&e.push({id:"all",label:"\u5168\u9009",onClick:()=>this._onClickPresetAction("all")},{id:"reverse",label:"\u53CD\u9009",onClick:()=>this._onClickPresetAction("reverse")},{id:"clear",label:"\u6E05\u7A7A",onClick:()=>this._onClickPresetAction("clear")});let o=i=>{for(let s=e.length-1;s>=0;s--)if(e[s].id===i.id){let n=i.onClick;i.onClick=()=>{e[s].onClick(),n&&n.call(this,this.getInputValue());},e.splice(s,1);}};this.beforeActions&&this.beforeActions.length>0&&this.beforeActions.forEach(i=>{o(i);}),this.afterActions&&this.afterActions.length>0&&this.afterActions.forEach(i=>{o(i);}),e.length>0&&(this.afterActions||(this.beforeActions=[]),this.afterActions.splice(0,0,...e));}getInputValue(){return this.options.multiple?this.selection:this.selection.length>0?this.selection[0]:void 0}getShowLabel(e){let o=this.options.labelKey;if(o){if(o in e)return e[o]}else return e.label}renderResults(){return u`<div
        ...
        >
            ...
            slot="start"
            class="mark-err ${z({multiple:this.options.multiple})}"
            style=${J({maxHeight:this.options.height})}
            @sl-select=${this._onSelectItem.bind(this)}
        >

            ${tt(this.items.value,(o,i)=>{let s=e.includes(o[this.valueKey]);return u`<sl-menu-item type="checkbox" data-index=${String(i)} .checked=${s}>
        ...
        `}};exports.AutoFieldList.styles=[R.styles,Ie.styles,y`
...
`;var Tl=null,Ei=class{};Ei.render=function(t,r){Tl(t,r);};self.QrCreator=Ei;(function(t){function r(c,a,h,m){var d={},f=t(h,a);f.u(c),f.J(),m=m||0;var g=f.h(),b=f.h()+2*m;return d.text=c,d.level=a,d.version=h,d.O=b,d.a=function(x,I){return x-=m,I-=m,0>x||x>=g||0>I||I>=g?false:f.a(x,I)},d}function e(c,a,h,m,d,f,g,b,x,I){function E(S,O,_,C,D,H,U){S?(c.lineTo(O+H,_+U),c.arcTo(O,_,C,D,f)):c.lineTo(O,_);}g?c.moveTo(a+f,h):c.moveTo(a,h),E(b,m,h,m,d,-f,0),E(x,m,d,a,d,0,-f),E(I,a,d,a,h,f,0),E(g,a,h,m,h,0,f);}function o(c,a,h,m,d,f,g,b,x,I){function E(S,O,_,C){c.moveTo(S+_,O),c.lineTo(S,O),c.lineTo(S,O+C),c.arcTo(S,O,S+_,O,f);}g&&E(a,h,f,f),b&&E(m,h,-f,f),x&&E(m,d,-f,-f),I&&E(a,d,f,-f);}function i(c,a){var h=a.fill;if(typeof h=="string")c.fillStyle=h;else {var m=h.type,d=h.colorStops;if(h=h.position.map(g=>Math.round(g*a.size)),m==="linear-gradient")var f=c.createLinearGradient.apply(c,h);else if(m==="radial-gradient")f=c.createRadialGradient.apply(c,h);else throw Error("Unsupported fill");d.forEach(([g,b])=>{f.addColorStop(g,b);}),c.fillStyle=f;}}function s(c,a){t:{var h=a.text,m=a.v,d=a.N,f=a.K,g=a.P;for(d=Math.max(1,d||1),f=Math.min(40,f||40);d<=f;d+=1)try{var b=r(h,m,d,g);break t}catch{}b=void 0;}if(!b)return null;for(h=c.getContext("2d"),a.background&&(h.fillStyle=a.background,h.fillRect(a.left,a.top,a.size,a.size)),m=b.O,f=a.size/m,h.beginPath(),g=0;g<m;g+=1)for(d=0;d<m;d+=1){var x=h,I=a.left+d*f,E=a.top+g*f,S=g,O=d,_=b.a,C=I+f,D=E+f,H=S-1,U=S+1,M=O-1,P=O+1,ht=Math.floor(Math.min(.5,Math.max(0,a.R))*f),st=_(S,O),wt=_(H,M),nt=_(H,O);H=_(H,P);var Ft=_(S,P);P=_(U,P),O=_(U,O),U=_(U,M),S=_(S,M),I=Math.round(I),E=Math.round(E),C=Math.round(C),D=Math.round(D),st?e(x,I,E,C,D,ht,!nt&&!S,!nt&&!Ft,!O&&!Ft,!O&&!S):o(x,I,E,C,D,ht,nt&&S&&wt,nt&&Ft&&H,O&&Ft&&P,O&&S&&U);}return i(h,a),h.fill(),c}var n={minVersion:1,maxVersion:40,ecLevel:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",radius:.5,quiet:0};Tl=function(c,a){var h={};Object.assign(h,n,c),h.N=h.minVersion,h.K=h.maxVersion,h.v=h.ecLevel,h.left=h.left,h.top=h.top,h.size=h.size,h.fill=h.fill,h.background=h.background,h.text=h.text,h.R=h.radius,h.P=h.quiet,a instanceof HTMLCanvasElement?((a.width!==h.size||a.height!==h.size)&&(a.width=h.size,a.height=h.size),a.getContext("2d").clearRect(0,0,a.width,a.height),s(a,h)):(c=document.createElement("canvas"),c.width=h.size,c.height=h.size,h=s(c,h),a.appendChild(h));};})(function(){function t(a){var h=e.s(a);return {S:function(){return 4},b:function(){return h.length},write:function(m){for(var d=0;d<h.length;d+=1)m.put(h[d],8);}}}function r(){var a=[],h=0,m={B:function(){return a},c:function(d){return (a[Math.floor(d/8)]>>>7-d%8&1)==1},put:function(d,f){for(var g=0;g<f;g+=1)m.m((d>>>f-g-1&1)==1);},f:function(){return h},m:function(d){var f=Math.floor(h/8);a.length<=f&&a.push(0),d&&(a[f]|=128>>>h%8),h+=1;}};return m}function e(a,h){function m(S,O){for(var _=-1;7>=_;_+=1)if(!(-1>=S+_||b<=S+_))for(var C=-1;7>=C;C+=1) -1>=O+C||b<=O+C||(g[S+_][O+C]=0<=_&&6>=_&&(C==0||C==6)||0<=C&&6>=C&&(_==0||_==6)||2<=_&&4>=_&&2<=C&&4>=C);}function d(S,O){for(var _=b=4*a+17,C=Array(_),D=0;D<_;D+=1){C[D]=Array(_);for(var H=0;H<_;H+=1)C[D][H]=null;}for(g=C,m(0,0),m(b-7,0),m(0,b-7),_=s.G(a),C=0;C<_.length;C+=1)for(D=0;D<_.length;D+=1){H=_[C];var U=_[D];if(g[H][U]==null)for(var M=-2;2>=M;M+=1)for(var P=-2;2>=P;P+=1)g[H+M][U+P]=M==-2||M==2||P==-2||P==2||M==0&&P==0;}for(_=8;_<b-8;_+=1)g[_][6]==null&&(g[_][6]=_%2==0);for(_=8;_<b-8;_+=1)g[6][_]==null&&(g[6][_]=_%2==0);for(_=s.w(f<<3|O),C=0;15>C;C+=1)D=!S&&(_>>C&1)==1,g[6>C?C:8>C?C+1:b-15+C][8]=D,g[8][8>C?b-C-1:9>C?15-C:14-C]=D;if(g[b-8][8]=!S,7<=a){for(_=s.A(a),C=0;18>C;C+=1)D=!S&&(_>>C&1)==1,g[Math.floor(C/3)][C%3+b-8-3]=D;for(C=0;18>C;C+=1)D=!S&&(_>>C&1)==1,g[C%3+b-8-3][Math.floor(C/3)]=D;}if(x==null){for(S=c.I(a,f),_=r(),C=0;C<I.length;C+=1)D=I[C],_.put(4,4),_.put(D.b(),s.f(4,a)),D.write(_);for(C=D=0;C<S.length;C+=1)D+=S[C].j;if(_.f()>8*D)throw Error("code length overflow. ("+_.f()+">"+8*D+")");for(_.f()+4<=8*D&&_.put(0,4);_.f()%8!=0;)_.m(false);for(;!(_.f()>=8*D)&&(_.put(236,8),!(_.f()>=8*D));)_.put(17,8);var ht=0;for(D=C=0,H=Array(S.length),U=Array(S.length),M=0;M<S.length;M+=1){var st=S[M].j,wt=S[M].o-st;for(C=Math.max(C,st),D=Math.max(D,wt),H[M]=Array(st),P=0;P<H[M].length;P+=1)H[M][P]=255&_.B()[P+ht];for(ht+=st,P=s.C(wt),st=o(H[M],P.b()-1).l(P),U[M]=Array(P.b()-1),P=0;P<U[M].length;P+=1)wt=P+st.b()-U[M].length,U[M][P]=0<=wt?st.c(wt):0;}for(P=_=0;P<S.length;P+=1)_+=S[P].o;for(_=Array(_),P=ht=0;P<C;P+=1)for(M=0;M<S.length;M+=1)P<H[M].length&&(_[ht]=H[M][P],ht+=1);for(P=0;P<D;P+=1)for(M=0;M<S.length;M+=1)P<U[M].length&&(_[ht]=U[M][P],ht+=1);x=_;}for(S=x,_=-1,C=b-1,D=7,H=0,O=s.F(O),U=b-1;0<U;U-=2)for(U==6&&--U;;){for(M=0;2>M;M+=1)g[C][U-M]==null&&(P=false,H<S.length&&(P=(S[H]>>>D&1)==1),O(C,U-M)&&(P=!P),g[C][U-M]=P,--D,D==-1&&(H+=1,D=7));if(C+=_,0>C||b<=C){C-=_,_=-_;break}}}var f=i[h],g=null,b=0,x=null,I=[],E={u:function(S){S=t(S),I.push(S),x=null;},a:function(S,O){if(0>S||b<=S||0>O||b<=O)throw Error(S+","+O);return g[S][O]},h:function(){return b},J:function(){for(var S=0,O=0,_=0;8>_;_+=1){d(true,_);var C=s.D(E);(_==0||S>C)&&(S=C,O=_);}d(false,O);}};return E}function o(a,h){if(typeof a.length>"u")throw Error(a.length+"/"+h);var m=function(){for(var f=0;f<a.length&&a[f]==0;)f+=1;for(var g=Array(a.length-f+h),b=0;b<a.length-f;b+=1)g[b]=a[b+f];return g}(),d={c:function(f){return m[f]},b:function(){return m.length},multiply:function(f){for(var g=Array(d.b()+f.b()-1),b=0;b<d.b();b+=1)for(var x=0;x<f.b();x+=1)g[b+x]^=n.i(n.g(d.c(b))+n.g(f.c(x)));return o(g,0)},l:function(f){if(0>d.b()-f.b())return d;for(var g=n.g(d.c(0))-n.g(f.c(0)),b=Array(d.b()),x=0;x<d.b();x+=1)b[x]=d.c(x);for(x=0;x<f.b();x+=1)b[x]^=n.i(n.g(f.c(x))+g);return o(b,0).l(f)}};return d}e.s=function(a){for(var h=[],m=0;m<a.length;m++){var d=a.charCodeAt(m);128>d?h.push(d):2048>d?h.push(192|d>>6,128|d&63):55296>d||57344<=d?h.push(224|d>>12,128|d>>6&63,128|d&63):(m++,d=65536+((d&1023)<<10|a.charCodeAt(m)&1023),h.push(240|d>>18,128|d>>12&63,128|d>>6&63,128|d&63));}return h};var i={L:1,M:0,Q:3,H:2},s=function(){function a(d){for(var f=0;d!=0;)f+=1,d>>>=1;return f}var h=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],m={w:function(d){for(var f=d<<10;0<=a(f)-a(1335);)f^=1335<<a(f)-a(1335);return (d<<10|f)^21522},A:function(d){for(var f=d<<12;0<=a(f)-a(7973);)f^=7973<<a(f)-a(7973);return d<<12|f},G:function(d){return h[d-1]},F:function(d){switch(d){case 0:return function(f,g){return (f+g)%2==0};case 1:return function(f){return f%2==0};case 2:return function(f,g){return g%3==0};case 3:return function(f,g){return (f+g)%3==0};case 4:return function(f,g){return (Math.floor(f/2)+Math.floor(g/3))%2==0};case 5:return function(f,g){return f*g%2+f*g%3==0};case 6:return function(f,g){return (f*g%2+f*g%3)%2==0};case 7:return function(f,g){return (f*g%3+(f+g)%2)%2==0};default:throw Error("bad maskPattern:"+d)}},C:function(d){for(var f=o([1],0),g=0;g<d;g+=1)f=f.multiply(o([1,n.i(g)],0));return f},f:function(d,f){if(d!=4||1>f||40<f)throw Error("mode: "+d+"; type: "+f);return 10>f?8:16},D:function(d){for(var f=d.h(),g=0,b=0;b<f;b+=1)for(var x=0;x<f;x+=1){for(var I=0,E=d.a(b,x),S=-1;1>=S;S+=1)if(!(0>b+S||f<=b+S))for(var O=-1;1>=O;O+=1)0>x+O||f<=x+O||(S!=0||O!=0)&&E==d.a(b+S,x+O)&&(I+=1);5<I&&(g+=3+I-5);}for(b=0;b<f-1;b+=1)for(x=0;x<f-1;x+=1)I=0,d.a(b,x)&&(I+=1),d.a(b+1,x)&&(I+=1),d.a(b,x+1)&&(I+=1),d.a(b+1,x+1)&&(I+=1),(I==0||I==4)&&(g+=3);for(b=0;b<f;b+=1)for(x=0;x<f-6;x+=1)d.a(b,x)&&!d.a(b,x+1)&&d.a(b,x+2)&&d.a(b,x+3)&&d.a(b,x+4)&&!d.a(b,x+5)&&d.a(b,x+6)&&(g+=40);for(x=0;x<f;x+=1)for(b=0;b<f-6;b+=1)d.a(b,x)&&!d.a(b+1,x)&&d.a(b+2,x)&&d.a(b+3,x)&&d.a(b+4,x)&&!d.a(b+5,x)&&d.a(b+6,x)&&(g+=40);for(x=I=0;x<f;x+=1)for(b=0;b<f;b+=1)d.a(b,x)&&(I+=1);return g+=Math.abs(100*I/f/f-50)/5*10}};return m}(),n=function(){for(var a=Array(256),h=Array(256),m=0;8>m;m+=1)a[m]=1<<m;for(m=8;256>m;m+=1)a[m]=a[m-4]^a[m-5]^a[m-6]^a[m-8];for(m=0;255>m;m+=1)h[a[m]]=m;return {g:function(d){if(1>d)throw Error("glog("+d+")");return h[d]},i:function(d){for(;0>d;)d+=255;for(;256<=d;)d-=255;return a[d]}}}(),c=function(){function a(d,f){switch(f){case i.L:return h[4*(d-1)];case i.M:return h[4*(d-1)+1];case i.Q:return h[4*(d-1)+2];case i.H:return h[4*(d-1)+3]}}var h=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],m={I:function(d,f){var g=a(d,f);if(typeof g>"u")throw Error("bad rs block @ typeNumber:"+d+"/errorCorrectLevel:"+f);d=g.length/3,f=[];for(var b=0;b<d;b+=1)for(var x=g[3*b],I=g[3*b+1],E=g[3*b+2],S=0;S<x;S+=1){var O=E,_={};_.o=I,_.j=O,f.push(_);}return f}};return m}();return e}());var Il=QrCreator;var Yt=class extends L{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H";}firstUpdated(){this.generate();}generate(){this.hasUpdated&&Il.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:this.background,size:this.size*2},this.canvas);}render(){var t;return u`
      ...
      ></canvas>
    `}};Yt.styles=[V,Ol];l([$("canvas")],Yt.prototype,"canvas",2);l([p()],Yt.prototype,"value",2);l([p()],Yt.prototype,"label",2);l([p({type:Number})],Yt.prototype,"size",2);l([p()],Yt.prototype,"fill",2);l([p()],Yt.prototype,"background",2);l([p({type:Number})],Yt.prototype,"radius",2);l([p({attribute:"error-correction"})],Yt.prototype,"errorCorrection",2);l([A(["background","errorCorrection","fill","radius","size","value"])],Yt.prototype,"generate",1);Yt.define("sl-qr-code");exports.AutoFieldQRCode=class Ai extends R{getInitialOptions(){return {fill:"black",background:"white",radius:0,errorCorrection:"L",size:64}}renderInput(){return u`
            <sl-qr-code
                slot="value"
                name=${this.name}
                data-path=${this.path}
...
`;function Ll(t,r=false){function e(s){let n=s.getChildrenItems({includeDisabled:false});if(n.length){let c=n.every(h=>h.selected),a=n.every(h=>!h.selected&&!h.indeterminate);s.selected=c,s.indeterminate=!c&&!a;}}function o(s){let n=s.parentElement;ar.isTreeItem(n)&&(e(n),o(n));}function i(s){for(let n of s.getChildrenItems())n.selected=r?s.selected||n.selected:!n.disabled&&s.selected,i(n);r&&e(s);}i(t),o(t);}var Pe=class extends L{constructor(){super(),this.selection="single",this.clickTarget=null,this.localize=new W(this),this.initTreeItem=t=>{t.selectable=this.selection==="multiple",["expand","collapse"].filter(r=>!!this.querySelector(`[slot="${r}-icon"]`)).forEach(r=>{let e=t.querySelector(`[slot="${r}-icon"]`),o=this.getExpandButtonIcon(r);o&&(e===null?t.append(o):e.hasAttribute("data-default")&&e.replaceWith(o));});},this.handleTreeChanged=t=>{for(let r of t){let e=[...r.addedNodes].filter(ar.isTreeItem),o=[...r.removedNodes].filter(ar.isTreeItem);e.forEach(this.initTreeItem),this.lastFocusedItem&&o.includes(this.lastFocusedItem)&&(this.lastFocusedItem=null);}},this.handleFocusOut=t=>{let r=t.relatedTarget;(!r||!this.contains(r))&&(this.tabIndex=0);},this.handleFocusIn=t=>{let r=t.target;t.target===this&&this.focusItem(this.lastFocusedItem||this.getAllTreeItems()[0]),ar.isTreeItem(r)&&!r.disabled&&(this.lastFocusedItem&&(this.lastFocusedItem.tabIndex=-1),this.lastFocusedItem=r,this.tabIndex=-1,r.tabIndex=0);},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut),this.addEventListener("sl-lazy-change",this.handleSlotChange);}async connectedCallback(){super.connectedCallback(),this.setAttribute("role","tree"),this.setAttribute("tabindex","0"),await this.updateComplete,this.mutationObserver=new MutationObserver(this.handleTreeChanged),this.mutationObserver.observe(this,{childList:true,subtree:true});}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.mutationObserver)==null||t.disconnect();}getExpandButtonIcon(t){let e=(t==="expand"?this.expandedIconSlot:this.collapsedIconSlot).assignedElements({flatten:true})[0];if(e){let o=e.cloneNode(true);return [o,...o.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),o.setAttribute("data-default",""),o.slot=`${t}-icon`,o}return null}selectItem(t){let r=[...this.selectedItems];if(this.selection==="multiple")t.selected=!t.selected,t.lazy&&(t.expanded=true),Ll(t);else if(this.selection==="single"||t.isLeaf){let o=this.getAllTreeItems();for(let i of o)i.selected=i===t;}else this.selection==="leaf"&&(t.expanded=!t.expanded);let e=this.selectedItems;(r.length!==e.length||e.some(o=>!r.includes(o)))&&Promise.all(e.map(o=>o.updateComplete)).then(()=>{this.emit("sl-selection-change",{detail:{selection:e}});});}getAllTreeItems(){return [...this.querySelectorAll("sl-tree-item")]}focusItem(t){t?.focus();}handleKeyDown(t){if(!["ArrowDown","ArrowUp","ArrowRight","ArrowLeft","Home","End","Enter"," "].includes(t.key)||t.composedPath().some(i=>{var s;return ["input","textarea"].includes((s=i?.tagName)==null?void 0:s.toLowerCase())}))return;let r=this.getFocusableItems(),e=this.localize.dir()==="ltr",o=this.localize.dir()==="rtl";if(r.length>0){t.preventDefault();let i=r.findIndex(a=>a.matches(":focus")),s=r[i],n=a=>{let h=r[dt(a,0,r.length-1)];this.focusItem(h);},c=a=>{s.expanded=a;};t.key==="ArrowDown"?n(i+1):t.key==="ArrowUp"?n(i-1):e&&t.key==="ArrowRight"||o&&t.key==="ArrowLeft"?!s||s.disabled||s.expanded||s.isLeaf&&!s.lazy?n(i+1):c(true):e&&t.key==="ArrowLeft"||o&&t.key==="ArrowRight"?!s||s.disabled||s.isLeaf||!s.expanded?n(i-1):c(false):t.key==="Home"?n(0):t.key==="End"?n(r.length-1):(t.key==="Enter"||t.key===" ")&&(s.disabled||this.selectItem(s));}}handleClick(t){let r=t.target,e=r.closest("sl-tree-item"),o=t.composedPath().some(i=>{var s;return (s=i?.classList)==null?void 0:s.contains("tree-item__expand-button")});!e||e.disabled||r!==this.clickTarget||(o?e.expanded=!e.expanded:this.selectItem(e));}handleMouseDown(t){this.clickTarget=t.target;}handleSlotChange(){this.getAllTreeItems().forEach(this.initTreeItem);}async handleSelectionChange(){let t=this.selection==="multiple",r=this.getAllTreeItems();this.setAttribute("aria-multiselectable",t?"true":"false");for(let e of r)e.selectable=t;t&&(await this.updateComplete,[...this.querySelectorAll(":scope > sl-tree-item")].forEach(e=>Ll(e,true)));}get selectedItems(){let t=this.getAllTreeItems(),r=e=>e.selected;return t.filter(r)}getFocusableItems(){let t=this.getAllTreeItems(),r=new Set;return t.filter(e=>{var o;if(e.disabled)return  false;let i=(o=e.parentElement)==null?void 0:o.closest("[role=treeitem]");return i&&(!i.expanded||i.loading||r.has(i))&&r.add(e),!r.has(e)})}render(){return u`
    ...
    `}};Pe.styles=[V,zl];l([$("slot:not([name])")],Pe.prototype,"defaultSlot",2);l([$("slot[name=expand-icon]")],Pe.prototype,"expandedIconSlot",2);l([$("slot[name=collapse-icon]")],Pe.prototype,"collapsedIconSlot",2);l([p()],Pe.prototype,"selection",2);l([A("selection")],Pe.prototype,"handleSelectionChange",1);Pe.define("sl-tree");ar.define("sl-tree-item");exports.AutoFieldTreeSelect=class De extends R{constructor(){super(...arguments);this.nodes=new ze(this,"items",e=>e?(this._forEachTree(e,(o,i,s,n)=>{this.isItemSelected(o)&&(o.selected=true,this.selection.push({id:o[this.options.idKey],value:o[this.options.valueKey],path:n.join("/")}));}),e):[]);this.selection=[];this.idKey="id";this.valueKey="id";this.labelKey="label";}getInitialOptions(){return {items:[],idKey:"id",valueKey:"id",labelKey:"label",multiple:false,maxItems:0,minItems:0,defaultExpandLevel:2,onlySelectLeaf:false,showAsPath:false,onSelectionChange:()=>{}}}isItemSelected(e){return this.value===void 0?false:this.options.multiple===false?this.value===e[this.options.valueKey]:this.value.includes(e[this.options.valueKey])}getStateValue(){let e=super.getStateValue();return this.options.multiple?Array.isArray(e)?e:[e]:e}_forEachTree(e,o){let i=(s,n,c,a)=>{let h=[...a,s[this.options.labelKey]];if(this.options.defaultExpandLevel>0&&c<this.options.defaultExpandLevel-1&&s.expanded===void 0&&(s.expanded=true),o(s,n,c,h),s.children){let m=c+1;s.children.forEach(d=>{i(d,s,m,[...h]);});}};(Array.isArray(e)?e:[e]).forEach(s=>{i(s,void 0,0,[]);});}onSelectionChange(e){let o=Array.from(e.detail.selection);o&&(this.selection=o.map(i=>({id:i.dataset.id,value:i.dataset.value,path:i.dataset.path})),this.options&&typeof this.options.onSelectionChange=="function"&&this.options.onSelectionChange(this.selection),this.onFieldChange());}getInputValue(){return this.options.multiple?this.selection.map(e=>e.value):this.selection.length>0?this.selection[0].value:void 0}_renderNode(e,o,i){let s=o.includes(e[this.options.valueKey]),n=[...i,e[this.options.labelKey]];return u`<sl-tree-item
        ...
        `],v([$(".selection>.select-value")],exports.AutoFieldCombine.prototype,"selection",2),exports.AutoFieldCombine=v([T("auto-field-combine")],exports.AutoFieldCombine);var rd=["help","error","email","search","lock","user","globe","date","time","phone","copy","remove","refresh","datetime"];exports.AutoFieldIcons=class cr extends Et{constructor(){super(...arguments);this.active=false;this.selected=[];this.icons=[];}getInitialOptions(){return {icons:[],size:"24px",multiple:false,dropdown:false,builtIn:true}}connectedCallback(){super.connectedCallback(),this.icons=Array.isArray(this.options.icons)?this.options.icons:this.options.icons.split(","),this.options.builtIn&&rd.forEach(e=>{this.icons.includes(e)||this.icons.push(e);}),this.selected=Array.isArray(this.value)?this.value:this.value.split(",");}renderView(){return this.renderIcons(this.selected)}_isSelected(e){return this.options.multiple?this.selected.includes(e):this.selected[0]===e}_onClickIcon(e){if(!this.context.viewonly)if(this.options.multiple){let o=this.selected.findIndex(i=>i===e);o>-1?this.selected.splice(o,1):this.selected.push(e),this.onFieldInput();}else this.selected.length===0?this.selected.push(e):this.selected[0]=e,this.onFieldInput();}getInputValue(){return this.options.multiple?this.selected:this.selected[0]}renderIcons(e,o=true){return u`<div class="icons" style="font-size:${this.options.size}">
...
`;var sd=0,Lr=class extends L{constructor(){super(...arguments),this.attrId=++sd,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=false;}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel");}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true");}render(){return u`
      <slot
        part="base"
        class=${z({"tab-panel":true,"tab-panel--active":this.active})}
      ></slot>
    `}};Lr.styles=[V,Hl];l([p({reflect:true})],Lr.prototype,"name",2);l([p({type:Boolean,reflect:true})],Lr.prototype,"active",2);l([A("active")],Lr.prototype,"handleActiveChange",1);Lr.define("sl-tab-panel");q.define("sl-icon");var Bl=y`
:root,
:host,
.sl-theme-light {
    color-scheme: light;
...
`;var ie=class extends lt{constructor(){super();this.forms=[];fr();}static{this.styles=[Ti,Ii,y`
            :host {
                display: block;
                width: 100%;
                background-color: var(--auto-bgcolor);
...
`;var Qt=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.open=false,this.disabled=false;}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=true),this.detailsObserver=new MutationObserver(t=>{for(let r of t)r.type==="attributes"&&r.attributeName==="open"&&(this.details.open?this.show():this.hide());}),this.detailsObserver.observe(this.details,{attributes:true});}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.detailsObserver)==null||t.disconnect();}handleSummaryClick(t){t.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus());}handleSummaryKeyDown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.open?this.hide():this.show()),(t.key==="ArrowUp"||t.key==="ArrowLeft")&&(t.preventDefault(),this.hide()),(t.key==="ArrowDown"||t.key==="ArrowRight")&&(t.preventDefault(),this.show());}async handleOpenChange(){if(this.open){if(this.details.open=true,this.emit("sl-show",{cancelable:true}).defaultPrevented){this.open=false,this.details.open=false;return}await Kt(this.body);let{keyframes:r,options:e}=Ut(this,"details.show",{dir:this.localize.dir()});await qt(this.body,Or(r,this.body.scrollHeight),e),this.body.style.height="auto",this.emit("sl-after-show");}else {if(this.emit("sl-hide",{cancelable:true}).defaultPrevented){this.details.open=true,this.open=true;return}await Kt(this.body);let{keyframes:r,options:e}=Ut(this,"details.hide",{dir:this.localize.dir()});await qt(this.body,Or(r,this.body.scrollHeight),e),this.body.style.height="auto",this.details.open=false,this.emit("sl-after-hide");}}async show(){if(!(this.open||this.disabled))return this.open=true,ve(this,"sl-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=false,ve(this,"sl-after-hide")}render(){let t=this.localize.dir()==="rtl";return u`
    ...
    ${Ii}
`;exports.AutoCollapse=class de extends lt{constructor(){super(...arguments);this.active="";this.accordion=false;this.panels=[];this._activeArray=[];}firstUpdated(){this.panels=this.getPanels();}connectedCallback(){super.connectedCallback(),fr(),this._activeArray=this.active?this.active.split(","):[];}getPanels(){let e=this.shadowRoot.querySelector("slot");return e?e.assignedElements({flatten:true}):[]}updated(e){e.has("active")&&typeof this.active=="string"&&(this._activeArray=this.active?this.active.split(","):[]),super.updated(e);}togglePanel(e){let o=this._activeArray.indexOf(e);if(o===-1)this.accordion?this._activeArray=[e]:this._activeArray=[...this._activeArray,e];else {let i=[...this._activeArray];i.splice(o,1),this._activeArray=i;}this.active=this._activeArray.join(","),this.dispatchEvent(new CustomEvent("change",{detail:{active:this.active}}));}isPanelActive(e){return this._activeArray.includes(e)}_onActionClick(e,o){let i=new CustomEvent("action-click",{detail:{name:e},composed:true,bubbles:true});o.stopPropagation(),this.dispatchEvent(i);}_renderHeaderActions(e){let o=(e.getAttribute("data-actions")||"").split(",");if(o.length>0)return tt(o,i=>{let[s,n]=i.split(":");return u`<sl-icon
                    part="action"
                    class="icon action"
                    name=${s}
                    title=${n}
...
`;var ko=class extends L{constructor(){super(...arguments),this.vertical=false;}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator");}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal");}};ko.styles=[V,Ul];l([p({type:Boolean,reflect:true})],ko.prototype,"vertical",2);l([A("vertical")],ko.prototype,"handleVerticalChange",1);ko.define("sl-divider");ut.define("sl-dropdown");xe.define("sl-spinner");pt.define("sl-icon-button");var ot=class ot extends lt{constructor(){super(...arguments);this.classs=new Ae(this);this.ctxController=new yr(this);this.seq=++ot.seq;this.context={};this.schemas=[];this.validAtInit=false;this.compact=false;this.validAt="lost-focus";this.border="grid";this.size="medium";this.labelPos="top";this.labelWidth="7em";this.dark=false;this.readonly=false;this.viewonly=false;this.viewAlign="right";this.layout="auto";this._loading=false;}static{this.seq=0;}static{this.styles=Ti;}get dirty(){return this.context.dirty}get invalid(){return this.context.invalid}connectedCallback(){super.connectedCallback(),this.bind(this.store),fr();}shouldUpdate(e){return e.has("store")&&this.bind(this.store),true}attributeChangedCallback(e,o,i){super.attributeChangedCallback(e,o,i),["group","sort","advanced","path"].includes(e)?setTimeout(()=>this._load()):e==="store"&&this.bind(i);}_initialContext(){Object.assign(this.context,{store:this.store,form:this,labelPos:this.labelPos,labelWidth:this.labelWidth,viewAlign:this.viewAlign,border:this.border,group:this.group,advanced:this.advanced,dark:this.dark,dirty:false,invalid:this._isValid(),validAtInit:this.validAtInit});}_isValid(){if(this.path){let e=this.store.schemas.errors||{};return Object.keys(e).some(o=>ks(this.path.split("."),o.split(".")))}else return Object.keys(this.store.schemas.errors).length>0}_load(e=true){if(this.store&&!this._loading)try{this._initialContext();let o=this.path?this.store.schemas.find(this.path):Object.values(this.store.schemas.store.state),i=s=>{if(!this.group||["default","general"].includes(this.group)&&s.group===void 0||["","*"].includes(this.group))return !0;let n=(s.group||"").split(","),c=this.group.split(",");return n.some(a=>c.includes(a))};this.schemas=Object.values(o).filter(s=>!(!i(s)||this.advanced===!1&&s.advanced)).sort((s,n)=>(s.order||0)-(n.order||0)),e&&this.requestUpdate();}finally{this._loading=false;}}bind(e){e&&(this.store=e,this._load(true));}clearErrors(){this.store.schemas.errors={},Array.from(this.shadowRoot.querySelectorAll(".fields > *")).forEach(o=>{o.tagName.startsWith("auto-field")&&(o.invalidTips=void 0);}),this.requestUpdate();}_renderFields(){return u` ${this.schemas.map(e=>u`${Oi(e,{attrs:{size:this.size}})}`)}`}render(){return this.classs.use(this.size,{dark:this.context.dark,[`${this.labelPos}-label`]:true,[`view-${this.viewAlign}`]:true,compact:this.compact,dirty:this.context.dirty,invalid:this.invalid}),u`
            <div class="actions header"></div>
            <div class="fields">${this._renderFields()}</div>
            <div class="actions footer"></div>
        `}reset(){this.store?.reset(),this._initialContext(),xr(this,"dirty",false),xr(this,"invalid",false);}submit(e){if(typeof e=="function"){let o=this.store?.schemas.getValues()||{},i=this.store?.schemas.errors;e(o,i);}}};v([is({context:jo})],ot.prototype,"context",2),v([p({type:Object})],ot.prototype,"store",2),v([p({type:Boolean,reflect:true})],ot.prototype,"validAtInit",2),v([p({type:String,reflect:true})],ot.prototype,"group",2),v([p({type:String,reflect:true})],ot.prototype,"icon",2),v([p({type:String,reflect:true})],ot.prototype,"path",2),v([p({type:Boolean,reflect:true})],ot.prototype,"compact",2),v([p({type:Boolean,reflect:true})],ot.prototype,"advanced",2),v([p({type:String,reflect:true})],ot.prototype,"validAt",2),v([p({type:String,reflect:true})],ot.prototype,"border",2),v([p({type:String})],ot.prototype,"size",2),v([p({type:String,reflect:true})],ot.prototype,"labelPos",2),v([p({type:String,reflect:true})],ot.prototype,"labelWidth",2),v([p({type:Boolean,reflect:true})],ot.prototype,"dark",2),v([p({type:Boolean,reflect:true})],ot.prototype,"readonly",2),v([p({type:Boolean,reflect:true})],ot.prototype,"viewonly",2),v([p({type:String,reflect:true})],ot.prototype,"viewAlign",2),v([p({type:String,reflect:true})],ot.prototype,"layout",2),v([p({type:String,reflect:true})],ot.prototype,"icons",2);var Fs=ot;customElements.get("auto-form")||customElements.define("auto-form",Fs);/*! Bundled license information:
