var AutoForm=(function(exports){'use strict';var Fl=Object.defineProperty;var Hl=Object.getOwnPropertyDescriptor;var Me=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var v=(t,r,e,o)=>{for(var i=o>1?void 0:o?Hl(r,e):r,s=t.length-1,n;s>=0;s--)(n=t[s])&&(i=(o?n(r,e,i):n(i))||i);return o&&i&&Fl(r,e,i),i};function Vs(t){let r=t.trim();if(r.startsWith("#")&&(r=r.slice(1)),r.length===3?r=r.replace(/(.)/g,"$1$1"):r.length===4&&(r=r.replace(/(.)/g,"$1$1")),r.length>6&&(r=r.slice(0,6)),!/^[0-9a-f]{6}$/i.test(r))throw new Error("Invalid hex color");let e=parseInt(r,16),o=e>>16&255,i=e>>8&255,s=e&255;return [o,i,s]}function Bl(t){let r=Vs(t);return (r[0]*2126+r[1]*7152+r[2]*722)/1e4<128}function Wl(t){let[r,e,o]=Array.isArray(t)?t:Vs(t),i=r/255,s=e/255,n=o/255,c=Math.max(i,s,n),a=Math.min(i,s,n),h=c-a,m=0,d=0,f=(c+a)/2;return h!==0&&(c===i?m=((s-n)/h+(s<n?6:0))/6:c===s?m=((n-i)/h+2)/6:m=((i-s)/h+4)/6),h!==0&&(d=h/(1-Math.abs(2*f-1))),[Math.round(m*360),Math.round(d*100),Math.round(f*100)]}function Ls(t){let[r,e,o]=t,i=r/360,s=e/100,n=o/100,c=(1-Math.abs(2*n-1))*s,a=c*(1-Math.abs(i*6%2-1)),h=n-c/2,m=0,d=0,f=0;0<=i&&i<1/6?(m=c,d=a,f=0):1/6<=i&&i<2/6?(m=a,d=c,f=0):2/6<=i&&i<3/6?(m=0,d=c,f=a):3/6<=i&&i<4/6?(m=0,d=a,f=c):4/6<=i&&i<5/6?(m=a,d=0,f=c):(m=c,d=0,f=a);let g=b=>Math.round((b+h)*255).toString(16).padStart(2,"0");return `#${g(m)}${g(d)}${g(f)}`}function jl(t){let{color:r,range:e,dark:o,count:i}=Object.assign({range:[5,98],count:5},t),s=Wl(r),n=o??Bl(r),c=Array.from({length:2*i+1});c[i]=r;let a=Math.abs(s[2]-e[0]),h=a/i,m=s[2];for(let d=i-1;d>=0;d--)m=m+(n?-1:1)*h,m<0&&(m=0),m>100&&(m=100),c[d]=Ls([s[0],s[1],m]);m=s[2],a=Math.abs(s[2]-e[1]),h=a/i;for(let d=i+1;d<i*2+1;d++)m=m+(n?1:-1)*h,m<0&&(m=0),m>100&&(m=100),c[d]=Ls([s[0],s[1],m]);return {colors:c,dark:n}}function De(t,r){let e=Object.assign({levels:[5,1,2,3,4,5],range:[10,98],count:5},typeof r=="string"?{color:r}:r),{colors:o,dark:i}=jl(e),s={};o.reduce((c,a,h)=>(s[`${t}${h}`]=a,c),{});let n=`--t-${t.split("-")[4]}`;return e.levels&&(s[`${n}-color`]=`var(${t}${e.levels[0]})`,s[`${n}-bgcolor`]=`var(${t}${e.levels[1]})`,e.levels.slice(2).forEach((c,a)=>{s[`${n}-bgcolor-${a+1}`]=`var(${t}${c})`;})),{vars:s,colors:o,dark:i}}function Oi(t=10){return Math.random().toString(36).substring(2,t+2)}function Ps(t,r){if(globalThis.document==null)return;let{id:e,mode:o,location:i="head"}=Object.assign({mode:"default"},r),s=document.head.querySelector(`#${e}`),n=e||Oi();return s?(o=="replace"?s.innerHTML=t:o=="append"&&(s.innerHTML+=t),n):(s=document.createElement("style"),s.innerHTML=t,s.id=n,r?.el?r.el.appendChild(s):i=="head"?document.head.appendChild(s):document.body.appendChild(s),s)}function Nl(t){let r=Object.assign({name:Oi(),variants:{}},t),e=Object.assign({prefix:"--t-color-theme-",range:[10,100],levels:[10,1,2,3,4,5]},typeof r.theme=="string"?{color:r.theme}:r.theme),{vars:o,dark:i}=De("--t-color-theme-",e);r.variants.primary&&De("--t-color-primary-",r.variants.primary),r.variants.danger&&De("--t-color-danger-",r.variants.danger),r.variants.success&&De("--t-color-success-",r.variants.success),r.variants.warning&&De("--t-color-warning-",r.variants.warning),r.variants.info&&De("--t-color-info-",r.variants.info);let s=`:host,:root[data-theme=${r.name}]{
        ${`color-schema: ${i?"dark":"light"}`};
        ${Object.entries(o).map(([n,c])=>`${n}:${c}`).join(`;
`)}}`;return Ps(s,{id:`theme-${r.name||Oi()}`,mode:"replace"}),s}var Ti=class{root;constructor(){this.root=document.documentElement,document.addEventListener("DOMContentLoaded",this._onDomContentLoaded.bind(this));}get size(){return this.root.dataset.size||"medium"}set size(r){this.root.dataset.size=r;}get spacing(){return this.root.dataset.spacing||"medium"}set spacing(r){this.root.dataset.spacing=String(r);}get radius(){return this.root.dataset.radius||"medium"}set radius(r){this.root.dataset.radius=r;}get theme(){return this.root.dataset.theme||"light"}set theme(r){this.root.dataset.theme=r;}_onDomContentLoaded(){this.root=document.documentElement;}createVariant(r,e){let{vars:o}=De(`--t-color-${r}-`,e),i=`${this.theme==="light"?":root,:host":`:host,
:root[data-theme=${this.theme}]`}{${Object.entries(o).map(([s,n])=>`${s}: ${n};`).join(`
`)}`;Ps(i,{id:`t-${this.theme}-${r}`,mode:"replace"});}create(r){Nl(r);}},Ul=new Ti;globalThis.ThemePro=Ul;var Io=globalThis,ko=Io.trustedTypes,Ms=ko?ko.createPolicy("lit-html",{createHTML:t=>t}):void 0,Ri="$lit$",pe=`lit$${Math.random().toFixed(9).slice(2)}$`,zi="?"+pe,ql=`<${zi}>`,Be=Io.document===void 0?{createTreeWalker:()=>({})}:document,Lr=()=>Be.createComment(""),Vr=t=>t===null||typeof t!="object"&&typeof t!="function",Li=Array.isArray,js=t=>Li(t)||typeof t?.[Symbol.iterator]=="function",Ii=`[ 	
\f\r]`,zr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ds=/-->/g,Fs=/>/g,Fe=RegExp(`>|${Ii}(?:([^\\s"'>=/]+)(${Ii}*=${Ii}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Hs=/'/g,Bs=/"/g,Ns=/^(?:script|style|textarea|title)$/i,Vi=t=>(r,...e)=>({_$litType$:t,strings:r,values:e}),u=Vi(1),nt=Symbol.for("lit-noChange"),Y=Symbol.for("lit-nothing"),Ws=new WeakMap,He=Be.createTreeWalker(Be,129);function Ks(t,r){if(!Li(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ms!==void 0?Ms.createHTML(r):r}var Gs=(t,r)=>{let e=t.length-1,o=[],i,s=r===2?"<svg>":r===3?"<math>":"",n=zr;for(let c=0;c<e;c++){let a=t[c],h,m,d=-1,f=0;for(;f<a.length&&(n.lastIndex=f,m=n.exec(a),m!==null);)f=n.lastIndex,n===zr?m[1]==="!--"?n=Ds:m[1]!==void 0?n=Fs:m[2]!==void 0?(Ns.test(m[2])&&(i=RegExp("</"+m[2],"g")),n=Fe):m[3]!==void 0&&(n=Fe):n===Fe?m[0]===">"?(n=i??zr,d=-1):m[1]===void 0?d=-2:(d=n.lastIndex-m[2].length,h=m[1],n=m[3]===void 0?Fe:m[3]==='"'?Bs:Hs):n===Bs||n===Hs?n=Fe:n===Ds||n===Fs?n=zr:(n=Fe,i=void 0);let g=n===Fe&&t[c+1].startsWith("/>")?" ":"";s+=n===zr?a+ql:d>=0?(o.push(h),a.slice(0,d)+Ri+a.slice(d)+pe+g):a+pe+(d===-2?c:g);}return [Ks(t,s+(t[e]||"<?>")+(r===2?"</svg>":r===3?"</math>":"")),o]},Pr=class t{constructor({strings:r,_$litType$:e},o){let i;this.parts=[];let s=0,n=0,c=r.length-1,a=this.parts,[h,m]=Gs(r,e);if(this.el=t.createElement(h,o),He.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes);}for(;(i=He.nextNode())!==null&&a.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Ri)){let f=m[n++],g=i.getAttribute(d).split(pe),b=/([.?@])?(.*)/.exec(f);a.push({type:1,index:s,name:b[2],strings:g,ctor:b[1]==="."?Eo:b[1]==="?"?Ao:b[1]==="@"?Oo:je}),i.removeAttribute(d);}else d.startsWith(pe)&&(a.push({type:6,index:s}),i.removeAttribute(d));if(Ns.test(i.tagName)){let d=i.textContent.split(pe),f=d.length-1;if(f>0){i.textContent=ko?ko.emptyScript:"";for(let g=0;g<f;g++)i.append(d[g],Lr()),He.nextNode(),a.push({type:2,index:++s});i.append(d[f],Lr());}}}else if(i.nodeType===8)if(i.data===zi)a.push({type:2,index:s});else {let d=-1;for(;(d=i.data.indexOf(pe,d+1))!==-1;)a.push({type:7,index:s}),d+=pe.length-1;}s++;}}static createElement(r,e){let o=Be.createElement("template");return o.innerHTML=r,o}};function We(t,r,e=t,o){if(r===nt)return r;let i=o!==void 0?e._$Co?.[o]:e._$Cl,s=Vr(r)?void 0:r._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(false),s===void 0?i=void 0:(i=new s(t),i._$AT(t,e,o)),o!==void 0?(e._$Co??=[])[o]=i:e._$Cl=i),i!==void 0&&(r=We(t,i._$AS(t,r.values),i,o)),r}var $o=class{constructor(r,e){this._$AV=[],this._$AN=void 0,this._$AD=r,this._$AM=e;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(r){let{el:{content:e},parts:o}=this._$AD,i=(r?.creationScope??Be).importNode(e,true);He.currentNode=i;let s=He.nextNode(),n=0,c=0,a=o[0];for(;a!==void 0;){if(n===a.index){let h;a.type===2?h=new lr(s,s.nextSibling,this,r):a.type===1?h=new a.ctor(s,a.name,a.strings,this,r):a.type===6&&(h=new To(s,this,r)),this._$AV.push(h),a=o[++c];}n!==a?.index&&(s=He.nextNode(),n++);}return He.currentNode=Be,i}p(r){let e=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(r,o,e),e+=o.strings.length-2):o._$AI(r[e])),e++;}},lr=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(r,e,o,i){this.type=2,this._$AH=Y,this._$AN=void 0,this._$AA=r,this._$AB=e,this._$AM=o,this.options=i,this._$Cv=i?.isConnected??true;}get parentNode(){let r=this._$AA.parentNode,e=this._$AM;return e!==void 0&&r?.nodeType===11&&(r=e.parentNode),r}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(r,e=this){r=We(this,r,e),Vr(r)?r===Y||r==null||r===""?(this._$AH!==Y&&this._$AR(),this._$AH=Y):r!==this._$AH&&r!==nt&&this._(r):r._$litType$!==void 0?this.$(r):r.nodeType!==void 0?this.T(r):js(r)?this.k(r):this._(r);}O(r){return this._$AA.parentNode.insertBefore(r,this._$AB)}T(r){this._$AH!==r&&(this._$AR(),this._$AH=this.O(r));}_(r){this._$AH!==Y&&Vr(this._$AH)?this._$AA.nextSibling.data=r:this.T(Be.createTextNode(r)),this._$AH=r;}$(r){let{values:e,_$litType$:o}=r,i=typeof o=="number"?this._$AC(r):(o.el===void 0&&(o.el=Pr.createElement(Ks(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===i)this._$AH.p(e);else {let s=new $o(i,this),n=s.u(this.options);s.p(e),this.T(n),this._$AH=s;}}_$AC(r){let e=Ws.get(r.strings);return e===void 0&&Ws.set(r.strings,e=new Pr(r)),e}k(r){Li(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,o,i=0;for(let s of r)i===e.length?e.push(o=new t(this.O(Lr()),this.O(Lr()),this,this.options)):o=e[i],o._$AI(s),i++;i<e.length&&(this._$AR(o&&o._$AB.nextSibling,i),e.length=i);}_$AR(r=this._$AA.nextSibling,e){for(this._$AP?.(false,true,e);r&&r!==this._$AB;){let o=r.nextSibling;r.remove(),r=o;}}setConnected(r){this._$AM===void 0&&(this._$Cv=r,this._$AP?.(r));}},je=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(r,e,o,i,s){this.type=1,this._$AH=Y,this._$AN=void 0,this.element=r,this.name=e,this._$AM=i,this.options=s,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=Y;}_$AI(r,e=this,o,i){let s=this.strings,n=false;if(s===void 0)r=We(this,r,e,0),n=!Vr(r)||r!==this._$AH&&r!==nt,n&&(this._$AH=r);else {let c=r,a,h;for(r=s[0],a=0;a<s.length-1;a++)h=We(this,c[o+a],e,a),h===nt&&(h=this._$AH[a]),n||=!Vr(h)||h!==this._$AH[a],h===Y?r=Y:r!==Y&&(r+=(h??"")+s[a+1]),this._$AH[a]=h;}n&&!i&&this.j(r);}j(r){r===Y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,r??"");}},Eo=class extends je{constructor(){super(...arguments),this.type=3;}j(r){this.element[this.name]=r===Y?void 0:r;}},Ao=class extends je{constructor(){super(...arguments),this.type=4;}j(r){this.element.toggleAttribute(this.name,!!r&&r!==Y);}},Oo=class extends je{constructor(r,e,o,i,s){super(r,e,o,i,s),this.type=5;}_$AI(r,e=this){if((r=We(this,r,e,0)??Y)===nt)return;let o=this._$AH,i=r===Y&&o!==Y||r.capture!==o.capture||r.once!==o.once||r.passive!==o.passive,s=r!==Y&&(o===Y||i);i&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,r),this._$AH=r;}handleEvent(r){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,r):this._$AH.handleEvent(r);}},To=class{constructor(r,e,o){this.element=r,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o;}get _$AU(){return this._$AM._$AU}_$AI(r){We(this,r);}},Ys={I:lr},Kl=Io.litHtmlPolyfillSupport;Kl?.(Pr,lr),(Io.litHtmlVersions??=[]).push("3.3.0");var cr=(t,r,e)=>{let o=e?.renderBefore??r,i=o._$litPart$;if(i===void 0){let s=e?.renderBefore??null;o._$litPart$=i=new lr(r.insertBefore(Lr(),s),s,void 0,e??{});}return i._$AI(t),i};var w=t=>t??Y;var Xs=class{get shadowRoot(){return this.__host.__shadowRoot}constructor(r){this.ariaAtomic="",this.ariaAutoComplete="",this.ariaBrailleLabel="",this.ariaBrailleRoleDescription="",this.ariaBusy="",this.ariaChecked="",this.ariaColCount="",this.ariaColIndex="",this.ariaColSpan="",this.ariaCurrent="",this.ariaDescription="",this.ariaDisabled="",this.ariaExpanded="",this.ariaHasPopup="",this.ariaHidden="",this.ariaInvalid="",this.ariaKeyShortcuts="",this.ariaLabel="",this.ariaLevel="",this.ariaLive="",this.ariaModal="",this.ariaMultiLine="",this.ariaMultiSelectable="",this.ariaOrientation="",this.ariaPlaceholder="",this.ariaPosInSet="",this.ariaPressed="",this.ariaReadOnly="",this.ariaRequired="",this.ariaRoleDescription="",this.ariaRowCount="",this.ariaRowIndex="",this.ariaRowSpan="",this.ariaSelected="",this.ariaSetSize="",this.ariaSort="",this.ariaValueMax="",this.ariaValueMin="",this.ariaValueNow="",this.ariaValueText="",this.role="",this.form=null,this.labels=[],this.states=new Set,this.validationMessage="",this.validity={},this.willValidate=true,this.__host=r;}checkValidity(){return console.warn("`ElementInternals.checkValidity()` was called on the server.This method always returns true."),true}reportValidity(){return  true}setFormValue(){}setValidity(){}};var ie=function(t,r,e,o,i){if(typeof r=="function"?t!==r||true:!r.has(t))throw new TypeError("Cannot write private member to an object whose class did not declare it");return r.set(t,e),e},bt=function(t,r,e,o){if(typeof r=="function"?t!==r||true:!r.has(t))throw new TypeError("Cannot read private member from an object whose class did not declare it");return e==="m"?o:e==="a"?o.call(t):o?o.value:r.get(t)},pr,Ro,zo,Mr,Pi,Dr,Lo,Ne,Fr,we,Vo,Qs,Zs=t=>typeof t=="boolean"?t:t?.capture??false;var Gl=class{constructor(){this.__eventListeners=new Map,this.__captureEventListeners=new Map;}addEventListener(r,e,o){if(e==null)return;let i=Zs(o)?this.__captureEventListeners:this.__eventListeners,s=i.get(r);if(s===void 0)s=new Map,i.set(r,s);else if(s.has(e))return;let n=typeof o=="object"&&o?o:{};n.signal?.addEventListener("abort",()=>this.removeEventListener(r,e,o)),s.set(e,n??{});}removeEventListener(r,e,o){if(e==null)return;let i=Zs(o)?this.__captureEventListeners:this.__eventListeners,s=i.get(r);s!==void 0&&(s.delete(e),s.size||i.delete(r));}dispatchEvent(r){let e=[this],o=this.__eventTargetParent;if(r.composed)for(;o;)e.push(o),o=o.__eventTargetParent;else for(;o&&o!==this.__host;)e.push(o),o=o.__eventTargetParent;let i=false,s=false,n=0,c=null,a=null,h=null,m=r.stopPropagation,d=r.stopImmediatePropagation;Object.defineProperties(r,{target:{get(){return c??a},...Z},srcElement:{get(){return r.target},...Z},currentTarget:{get(){return h},...Z},eventPhase:{get(){return n},...Z},composedPath:{value:()=>e,...Z},stopPropagation:{value:()=>{i=true,m.call(r);},...Z},stopImmediatePropagation:{value:()=>{s=true,d.call(r);},...Z}});let f=(E,S,O)=>{typeof E=="function"?E(r):typeof E?.handleEvent=="function"&&E.handleEvent(r),S.once&&O.delete(E);},g=()=>(h=null,n=0,!r.defaultPrevented),b=e.slice().reverse();c=!this.__host||!r.composed?this:null;let x=E=>{for(a=this;a.__host&&E.includes(a.__host);)a=a.__host;};for(let E of b){!c&&(!a||a===E.__host)&&x(b.slice(b.indexOf(E))),h=E,n=E===r.target?2:1;let S=E.__captureEventListeners.get(r.type);if(S){for(let[O,_]of S)if(f(O,_,S),s)return g()}if(i)return g()}let T=r.bubbles?e:[this];a=null;for(let E of T){!c&&(!a||E===a.__host)&&x(T.slice(0,T.indexOf(E)+1)),h=E,n=E===r.target?2:3;let S=E.__eventListeners.get(r.type);if(S){for(let[O,_]of S)if(f(O,_,S),s)return g()}if(i)return g()}return g()}},Mi=Gl;var Z={__proto__:null};Z.enumerable=true;Object.freeze(Z);var Di=(we=class{constructor(r,e={}){if(pr.set(this,false),Ro.set(this,false),zo.set(this,false),Mr.set(this,false),Pi.set(this,Date.now()),Dr.set(this,false),Lo.set(this,void 0),Ne.set(this,void 0),Fr.set(this,void 0),this.NONE=0,this.CAPTURING_PHASE=1,this.AT_TARGET=2,this.BUBBLING_PHASE=3,arguments.length===0)throw new Error("The type argument must be specified");if(typeof e!="object"||!e)throw new Error('The "options" argument must be an object');let{bubbles:o,cancelable:i,composed:s}=e;ie(this,pr,!!i),ie(this,Ro,!!o),ie(this,zo,!!s),ie(this,Lo,`${r}`),ie(this,Ne,null),ie(this,Fr,false);}initEvent(r,e,o){throw new Error("Method not implemented.")}stopImmediatePropagation(){this.stopPropagation();}preventDefault(){ie(this,Mr,true);}get target(){return bt(this,Ne,"f")}get currentTarget(){return bt(this,Ne,"f")}get srcElement(){return bt(this,Ne,"f")}get type(){return bt(this,Lo,"f")}get cancelable(){return bt(this,pr,"f")}get defaultPrevented(){return bt(this,pr,"f")&&bt(this,Mr,"f")}get timeStamp(){return bt(this,Pi,"f")}composedPath(){return bt(this,Fr,"f")?[bt(this,Ne,"f")]:[]}get returnValue(){return !bt(this,pr,"f")||!bt(this,Mr,"f")}get bubbles(){return bt(this,Ro,"f")}get composed(){return bt(this,zo,"f")}get eventPhase(){return bt(this,Fr,"f")?we.AT_TARGET:we.NONE}get cancelBubble(){return bt(this,Dr,"f")}set cancelBubble(r){r&&ie(this,Dr,true);}stopPropagation(){ie(this,Dr,true);}get isTrusted(){return  false}},pr=new WeakMap,Ro=new WeakMap,zo=new WeakMap,Mr=new WeakMap,Pi=new WeakMap,Dr=new WeakMap,Lo=new WeakMap,Ne=new WeakMap,Fr=new WeakMap,we.NONE=0,we.CAPTURING_PHASE=1,we.AT_TARGET=2,we.BUBBLING_PHASE=3,we);Object.defineProperties(Di.prototype,{initEvent:Z,stopImmediatePropagation:Z,preventDefault:Z,target:Z,currentTarget:Z,srcElement:Z,type:Z,cancelable:Z,defaultPrevented:Z,timeStamp:Z,composedPath:Z,returnValue:Z,bubbles:Z,composed:Z,eventPhase:Z,cancelBubble:Z,stopPropagation:Z,isTrusted:Z});var Js=(Qs=class extends Di{constructor(r,e={}){super(r,e),Vo.set(this,void 0),ie(this,Vo,e?.detail??null);}initCustomEvent(r,e,o,i){throw new Error("Method not implemented.")}get detail(){return bt(this,Vo,"f")}},Vo=new WeakMap,Qs);Object.defineProperties(Js.prototype,{detail:Z});var Fi=Di,Hi=Js;globalThis.Event??=Fi;globalThis.CustomEvent??=Hi;var tn=new WeakMap,Hr=t=>{let r=tn.get(t);return r===void 0&&tn.set(t,r=new Map),r},Yl=class extends Mi{constructor(){super(...arguments),this.__shadowRootMode=null,this.__shadowRoot=null,this.__internals=null;}get attributes(){return Array.from(Hr(this)).map(([r,e])=>({name:r,value:e}))}get shadowRoot(){return this.__shadowRootMode==="closed"?null:this.__shadowRoot}get localName(){return this.constructor.__localName}get tagName(){return this.localName?.toUpperCase()}setAttribute(r,e){Hr(this).set(r,String(e));}removeAttribute(r){Hr(this).delete(r);}toggleAttribute(r,e){if(this.hasAttribute(r)){if(e===void 0||!e)return this.removeAttribute(r),false}else return e===void 0||e?(this.setAttribute(r,""),true):false;return  true}hasAttribute(r){return Hr(this).has(r)}attachShadow(r){let e={host:this};return this.__shadowRootMode=r.mode,r&&r.mode==="open"&&(this.__shadowRoot=e),e}attachInternals(){if(this.__internals!==null)throw new Error("Failed to execute 'attachInternals' on 'HTMLElement': ElementInternals for the specified element was already attached.");let r=new Xs(this);return this.__internals=r,r}getAttribute(r){return Hr(this).get(r)??null}};var Xl=class extends Yl{},Bi=Xl;globalThis.litServerRoot??=Object.defineProperty(new Bi,"localName",{get(){return "lit-server-root"}});var Ql=class{constructor(){this.__definitions=new Map;}define(r,e){if(this.__definitions.has(r))if(process.env.NODE_ENV==="development")console.warn(`'CustomElementRegistry' already has "${r}" defined. This may have been caused by live reload or hot module replacement in which case it can be safely ignored.
Make sure to test your application with a production build as repeat registrations will throw in production.`);else throw new Error(`Failed to execute 'define' on 'CustomElementRegistry': the name "${r}" has already been used with this registry`);e.__localName=r,this.__definitions.set(r,{ctor:e,observedAttributes:e.observedAttributes??[]});}get(r){return this.__definitions.get(r)?.ctor}},Zl=Ql;var en=new Zl;var Br=globalThis,Po=Br.ShadowRoot&&(Br.ShadyCSS===void 0||Br.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Wi=Symbol(),rn=new WeakMap,Wr=class{constructor(r,e,o){if(this._$cssResult$=true,o!==Wi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=r,this.t=e;}get styleSheet(){let r=this.o,e=this.t;if(Po&&r===void 0){let o=e!==void 0&&e.length===1;o&&(r=rn.get(e)),r===void 0&&((this.o=r=new CSSStyleSheet).replaceSync(this.cssText),o&&rn.set(e,r));}return r}toString(){return this.cssText}},on=t=>new Wr(typeof t=="string"?t:t+"",void 0,Wi),y=(t,...r)=>{let e=t.length===1?t[0]:r.reduce((o,i,s)=>o+(n=>{if(n._$cssResult$===true)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new Wr(e,t,Wi)},sn=(t,r)=>{if(Po)t.adoptedStyleSheets=r.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of r){let o=document.createElement("style"),i=Br.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=e.cssText,t.appendChild(o);}},ji=Po||Br.CSSStyleSheet===void 0?t=>t:t=>t instanceof CSSStyleSheet?(r=>{let e="";for(let o of r.cssRules)e+=o.cssText;return on(e)})(t):t;var{is:Jl,defineProperty:tc,getOwnPropertyDescriptor:ec,getOwnPropertyNames:rc,getOwnPropertySymbols:oc,getPrototypeOf:ic}=Object,Nr=globalThis;Nr.customElements??=en;var nn=Nr.trustedTypes,sc=nn?nn.emptyScript:"",nc=Nr.reactiveElementPolyfillSupport,jr=(t,r)=>t,Se={toAttribute(t,r){switch(r){case Boolean:t=t?sc:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t);}return t},fromAttribute(t,r){let e=t;switch(r){case Boolean:e=t!==null;break;case Number:e=t===null?null:Number(t);break;case Object:case Array:try{e=JSON.parse(t);}catch{e=null;}}return e}},Mo=(t,r)=>!Jl(t,r),an={attribute:true,type:String,converter:Se,reflect:false,useDefault:false,hasChanged:Mo};Symbol.metadata??=Symbol("metadata"),Nr.litPropertyMetadata??=new WeakMap;var de=class extends(globalThis.HTMLElement??Bi){static addInitializer(r){this._$Ei(),(this.l??=[]).push(r);}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(r,e=an){if(e.state&&(e.attribute=false),this._$Ei(),this.prototype.hasOwnProperty(r)&&((e=Object.create(e)).wrapped=true),this.elementProperties.set(r,e),!e.noAccessor){let o=Symbol(),i=this.getPropertyDescriptor(r,o,e);i!==void 0&&tc(this.prototype,r,i);}}static getPropertyDescriptor(r,e,o){let{get:i,set:s}=ec(this.prototype,r)??{get(){return this[e]},set(n){this[e]=n;}};return {get:i,set(n){let c=i?.call(this);s?.call(this,n),this.requestUpdate(r,c,o);},configurable:true,enumerable:true}}static getPropertyOptions(r){return this.elementProperties.get(r)??an}static _$Ei(){if(this.hasOwnProperty(jr("elementProperties")))return;let r=ic(this);r.finalize(),r.l!==void 0&&(this.l=[...r.l]),this.elementProperties=new Map(r.elementProperties);}static finalize(){if(this.hasOwnProperty(jr("finalized")))return;if(this.finalized=true,this._$Ei(),this.hasOwnProperty(jr("properties"))){let e=this.properties,o=[...rc(e),...oc(e)];for(let i of o)this.createProperty(i,e[i]);}let r=this[Symbol.metadata];if(r!==null){let e=litPropertyMetadata.get(r);if(e!==void 0)for(let[o,i]of e)this.elementProperties.set(o,i);}this._$Eh=new Map;for(let[e,o]of this.elementProperties){let i=this._$Eu(e,o);i!==void 0&&this._$Eh.set(i,e);}this.elementStyles=this.finalizeStyles(this.styles);}static finalizeStyles(r){let e=[];if(Array.isArray(r)){let o=new Set(r.flat(1/0).reverse());for(let i of o)e.unshift(ji(i));}else r!==void 0&&e.push(ji(r));return e}static _$Eu(r,e){let o=e.attribute;return o===false?void 0:typeof o=="string"?o:typeof r=="string"?r.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=false,this.hasUpdated=false,this._$Em=null,this._$Ev();}_$Ev(){this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(r=>r(this));}addController(r){(this._$EO??=new Set).add(r),this.renderRoot!==void 0&&this.isConnected&&r.hostConnected?.();}removeController(r){this._$EO?.delete(r);}_$E_(){let r=new Map,e=this.constructor.elementProperties;for(let o of e.keys())this.hasOwnProperty(o)&&(r.set(o,this[o]),delete this[o]);r.size>0&&(this._$Ep=r);}createRenderRoot(){let r=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return sn(r,this.constructor.elementStyles),r}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(true),this._$EO?.forEach(r=>r.hostConnected?.());}enableUpdating(r){}disconnectedCallback(){this._$EO?.forEach(r=>r.hostDisconnected?.());}attributeChangedCallback(r,e,o){this._$AK(r,o);}_$ET(r,e){let o=this.constructor.elementProperties.get(r),i=this.constructor._$Eu(r,o);if(i!==void 0&&o.reflect===true){let s=(o.converter?.toAttribute!==void 0?o.converter:Se).toAttribute(e,o.type);this._$Em=r,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null;}}_$AK(r,e){let o=this.constructor,i=o._$Eh.get(r);if(i!==void 0&&this._$Em!==i){let s=o.getPropertyOptions(i),n=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:Se;this._$Em=i,this[i]=n.fromAttribute(e,s.type)??this._$Ej?.get(i)??null,this._$Em=null;}}requestUpdate(r,e,o){if(r!==void 0){let i=this.constructor,s=this[r];if(o??=i.getPropertyOptions(r),!((o.hasChanged??Mo)(s,e)||o.useDefault&&o.reflect&&s===this._$Ej?.get(r)&&!this.hasAttribute(i._$Eu(r,o))))return;this.C(r,e,o);}this.isUpdatePending===false&&(this._$ES=this._$EP());}C(r,e,{useDefault:o,reflect:i,wrapped:s},n){o&&!(this._$Ej??=new Map).has(r)&&(this._$Ej.set(r,n??e??this[r]),s!==true||n!==void 0)||(this._$AL.has(r)||(this.hasUpdated||o||(e=void 0),this._$AL.set(r,e)),i===true&&this._$Em!==r&&(this._$Eq??=new Set).add(r));}async _$EP(){this.isUpdatePending=true;try{await this._$ES;}catch(e){Promise.reject(e);}let r=this.scheduleUpdate();return r!=null&&await r,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0;}let o=this.constructor.elementProperties;if(o.size>0)for(let[i,s]of o){let{wrapped:n}=s,c=this[i];n!==true||this._$AL.has(i)||c===void 0||this.C(i,void 0,s,c);}}let r=false,e=this._$AL;try{r=this.shouldUpdate(e),r?(this.willUpdate(e),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(e)):this._$EM();}catch(o){throw r=false,this._$EM(),o}r&&this._$AE(e);}willUpdate(r){}_$AE(r){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=true,this.firstUpdated(r)),this.updated(r);}_$EM(){this._$AL=new Map,this.isUpdatePending=false;}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(r){return  true}update(r){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM();}updated(r){}firstUpdated(r){}};de.elementStyles=[],de.shadowRootOptions={mode:"open"},de[jr("elementProperties")]=new Map,de[jr("finalized")]=new Map,nc?.({ReactiveElement:de}),(Nr.reactiveElementVersions??=[]).push("2.1.0");var Ni=globalThis,ut=class extends de{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0;}createRenderRoot(){let r=super.createRenderRoot();return this.renderOptions.renderBefore??=r.firstChild,r}update(r){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(r),this._$Do=cr(e,this.renderRoot,this.renderOptions);}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(true);}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(false);}render(){return nt}};ut._$litElement$=true,ut.finalized=true,Ni.litElementHydrateSupport?.({LitElement:ut});var ac=Ni.litElementPolyfillSupport;ac?.({LitElement:ut});(Ni.litElementVersions??=[]).push("4.2.0");var ln=t=>(r,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(t,r);}):customElements.define(t,r);};var lc={attribute:true,type:String,converter:Se,reflect:false,hasChanged:Mo},cc=(t=lc,r,e)=>{let{kind:o,metadata:i}=e,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),o==="setter"&&((t=Object.create(t)).wrapped=true),s.set(e.name,t),o==="accessor"){let{name:n}=e;return {set(c){let a=r.get.call(this);r.set.call(this,c),this.requestUpdate(n,a,t);},init(c){return c!==void 0&&this.C(n,void 0,t,c),c}}}if(o==="setter"){let{name:n}=e;return function(c){let a=this[n];r.call(this,c),this.requestUpdate(n,a,t);}}throw Error("Unsupported decorator location: "+o)};function p(t){return (r,e)=>typeof e=="object"?cc(t,r,e):((o,i,s)=>{let n=i.hasOwnProperty(s);return i.constructor.createProperty(s,o),n?Object.getOwnPropertyDescriptor(i,s):void 0})(t,r,e)}function k(t){return p({...t,state:true,attribute:false})}function Ce(t){return (r,e)=>{let o=typeof r=="function"?r:r[e];Object.assign(o,t);}}var he=(t,r,e)=>(e.configurable=true,e.enumerable=true,Reflect.decorate&&typeof r!="object"&&Object.defineProperty(t,r,e),e);function $(t,r){return (e,o,i)=>{let s=n=>n.renderRoot?.querySelector(t)??null;return he(e,o,{get(){return s(this)}})}}var pc;function cn(t){return (r,e)=>he(r,e,{get(){return (this.renderRoot??(pc??=document.createDocumentFragment())).querySelectorAll(t)}})}function pn(t){return (r,e)=>{let{slot:o,selector:i}=t??{},s="slot"+(o?`[name=${o}]`:":not([name])");return he(r,e,{get(){let n=this.renderRoot?.querySelector(s),c=n?.assignedElements(t)??[];return i===void 0?c:c.filter(a=>a.matches(i))}})}}function ke(t){return t&&typeof t=="object"&&t.hasOwnProperty("__AS_ASYNC_COMPUTED_VALUE__")}function dn(t,r){return ke(t)?Object.assign({},t,r):Object.assign({value:t,loading:false,retry:0,progress:0,timeout:0,error:null,run:()=>{},cancel:()=>{}},r)}var dc=".";function hn(t,r,e){if(!r||r.length===0)return t;let o=Array.isArray(r)?r:r.split(dc),i,s=t;for(let n=0;n<o.length;n++){let c=o[n];if(c in s)i=s[c];else return e;s=i;}return i}function Do(t,r,e,o){if(!r||!t)return t;let i=r;if(i.length===0)return typeof t=="object"&&Object.assign(t,e),t;{let s=t,n=[],c=(a,h,m)=>{a[h]=m;};for(let a=0;a<i.length;a++){let h=i[a];if(n.push(h),s)if(Array.isArray(s)){let m=parseInt(h,10);if(Number.isNaN(m)||m<0)throw new Error(`setVal: invalid array index ${n.join(".")}`);a===i.length-1?c(s,m,e):s=s[m];}else s instanceof Map||s instanceof WeakMap?a===i.length-1?s.set(h,e):(s.has(h)||s.set(h,{}),s=s.get(h)):typeof s=="object"&&h in s?a===i.length-1?c(s,h,e):s=s[h]:(s[h]=a===i.length-1?e:{},s=s[h]);else s[h]=a===i.length-1?e:{},s=s[h];}}return t}function hc(t){if(t==null)return "";let r=typeof t;if(r==="boolean")return String(t);if(Array.isArray(t))return t.join(",");if(r==="object")try{return JSON.stringify(t)}catch{return "{}"}return String(t)}function un(t,r){if(!r)return t;let e=r.datatype||"any";if(e==="any")return t;if(e==="string")return hc(t);if(e==="number")return Number(t);if(Array.isArray(t))return [...t];if(typeof t=="object")return {...t};if(typeof t=="string"){if(e==="boolean")return t.toLowerCase()==="true";if(e==="array")return t.split(",").map(o=>o.trim());if(e==="object")try{return JSON.parse(t)}catch{return {}}}return e==="boolean"?!!t:t}function mn(t,r,e){return t?e(r):r}var Ui="";function fn(t){Ui=t;}function gn(t=""){if(!Ui){let r=[...document.getElementsByTagName("script")],e=r.find(o=>o.hasAttribute("data-shoelace"));if(e)fn(e.getAttribute("data-shoelace"));else {let o=r.find(s=>/shoelace(\.min)?\.js($|\?)/.test(s.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(s.src)),i="";o&&(i=o.getAttribute("src")),fn(i.split("/").slice(0,-1).join("/"));}}return Ui.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var uc={name:"default",resolver:t=>gn(`assets/icons/${t}.svg`)},bn=uc;var vn={caret:`
  ...
  `},mc={name:"system",resolver:t=>t in vn?`data:image/svg+xml,${encodeURIComponent(vn[t])}`:""},yn=mc;var Fo=[bn,yn],Ho=[];function qi(t){Ho.push(t);}function Ki(t){Ho=Ho.filter(r=>r!==t);}function dr(t){return Fo.find(r=>r.name===t)}function Gi(t,r){xn(t),Fo.push({name:t,resolver:r.resolver,mutator:r.mutator,spriteSheet:r.spriteSheet}),Ho.forEach(e=>{e.library===t&&e.setIcon();});}function xn(t){Fo=Fo.filter(r=>r.name!==t);}var Sn=Object.defineProperty,fc=Object.defineProperties,gc=Object.getOwnPropertyDescriptor,bc=Object.getOwnPropertyDescriptors,_n=Object.getOwnPropertySymbols,vc=Object.prototype.hasOwnProperty,yc=Object.prototype.propertyIsEnumerable,Yi=(t,r)=>(r=Symbol[t])?r:Symbol.for("Symbol."+t),Xi=t=>{throw TypeError(t)},wn=(t,r,e)=>r in t?Sn(t,r,{enumerable:true,configurable:true,writable:true,value:e}):t[r]=e,St=(t,r)=>{for(var e in r||(r={}))vc.call(r,e)&&wn(t,e,r[e]);if(_n)for(var e of _n(r))yc.call(r,e)&&wn(t,e,r[e]);return t},ue=(t,r)=>fc(t,bc(r)),l=(t,r,e,o)=>{for(var i=o>1?void 0:o?gc(r,e):r,s=t.length-1,n;s>=0;s--)(n=t[s])&&(i=(o?n(r,e,i):n(i))||i);return o&&i&&Sn(r,e,i),i},Cn=(t,r,e)=>r.has(t)||Xi("Cannot "+e),kn=(t,r,e)=>(Cn(t,r,"read from private field"),r.get(t)),$n=(t,r,e)=>r.has(t)?Xi("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,e),En=(t,r,e,o)=>(Cn(t,r,"write to private field"),r.set(t,e),e),xc=function(t,r){this[0]=t,this[1]=r;},An=t=>{var r=t[Yi("asyncIterator")],e=false,o,i={};return r==null?(r=t[Yi("iterator")](),o=s=>i[s]=n=>r[s](n)):(r=r.call(t),o=s=>i[s]=n=>{if(e){if(e=false,s==="throw")throw n;return n}return e=true,{done:false,value:new xc(new Promise(c=>{var a=r[s](n);a instanceof Object||Xi("Object expected"),c(a);}),1)}}),i[Yi("iterator")]=()=>i,o("next"),"throw"in r?o("throw"):i.throw=s=>{throw s},"return"in r&&o("return"),i};var Tn="https://unpkg.com/lucide-static@latest/icons/{name}.svg",Qi={help:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>',error:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>',email:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/></svg>',search:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/></svg>',lock:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="16" r="1"/><rect x="3" y="10" width="18" height="12" rx="2"/><path d="M7 10V7a5 5 0 0 1 10 0v3"/></svg>',user:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" ><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>',globe:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round""><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>',date:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>',time:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',phone:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"/></svg>',copy:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>',remove:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>',refresh:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',datetime:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M16 14v2.2l1.6 1"/><path d="M16 2v4"/><path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5"/><path d="M3 10h5"/><path d="M8 2v4"/><circle cx="16" cy="16" r="6"/></svg>',bell:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><path d="M10.268 21a2 2 0 0 0 3.464 0"/><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"/></svg>',menu:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><path d="M4 12h16"/><path d="M4 18h16"/><path d="M4 6h16"/></svg>'},On=t=>t in Qi?`data:image/svg+xml,${encodeURIComponent(Qi[t])}`:Tn.replace("{name}",t),_c=t=>{t&&t.setAttribute("stroke-width","1");};function hr(t="https://unpkg.com/lucide-static@latest/icons/{name}.svg",r){if(!t.includes("{name}"))throw new Error('icon url must include "{name}"');Tn=t,dr("default").resolver!==On&&Gi("default",{resolver:On,mutator:_c});}function wc(t){t=t.replace(/^#/,"");let r=parseInt(t.substring(0,2),16)/255,e=parseInt(t.substring(2,4),16)/255,o=parseInt(t.substring(4,6),16)/255,i=Math.max(r,e,o),s=Math.min(r,e,o),n=0,c=0,a=(i+s)/2;if(i!==s){let h=i-s;switch(c=a>.5?h/(2-i-s):h/(i+s),i){case r:n=(e-o)/h+(e<o?6:0);break;case e:n=(o-r)/h+2;break;case o:n=(r-e)/h+4;break}n/=6;}return {h:Math.round(n*360),s:Math.round(c*100),l:Math.round(a*100)}}function Sc(t,r,e){r/=100,e/=100;let o=(1-Math.abs(2*e-1))*r,i=o*(1-Math.abs(t/60%2-1)),s=e-o/2,n=0,c=0,a=0;0<=t&&t<60?(n=o,c=i,a=0):60<=t&&t<120?(n=i,c=o,a=0):120<=t&&t<180?(n=0,c=o,a=i):180<=t&&t<240?(n=0,c=i,a=o):240<=t&&t<300?(n=i,c=0,a=o):300<=t&&t<360&&(n=o,c=0,a=i),n=Math.round((n+s)*255),c=Math.round((c+s)*255),a=Math.round((a+s)*255);let h=m=>{let d=m.toString(16);return d.length===1?"0"+d:d};return `#${h(n)}${h(c)}${h(a)}`}function In(t){let r=wc(t),e={50:{hDiff:3.3,sFactor:.74,lFactor:.44},100:{hDiff:3.7,sFactor:.82,lFactor:.59},200:{hDiff:3,sFactor:.88,lFactor:.65},300:{hDiff:3.4,sFactor:.94,lFactor:.76},400:{hDiff:2.4,sFactor:.94,lFactor:.93},500:{hDiff:0,sFactor:1,lFactor:1},600:{hDiff:-1,sFactor:1.14,lFactor:1.2},700:{hDiff:-1,sFactor:1.16,lFactor:1.48},800:{hDiff:-0.9,sFactor:1.16,lFactor:1.73},900:{hDiff:-1.2,sFactor:1.16,lFactor:1.89},950:{hDiff:-13.7,sFactor:1.16,lFactor:2}},o={};for(let[i,s]of Object.entries(e)){let n=Math.max(0,Math.min(360,r.h+s.hDiff)),c=Math.max(0,Math.min(100,r.s*s.sFactor)),a=Math.max(0,Math.min(100,r.l*s.lFactor));o[`--sl-color-primary-${i}`]=Sc(n,c,a);}return o}function Cc(t){if(!t.match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/)){console.error("Invalid color format. Please provide a valid hex color (e.g., #3B82F6)");return}try{let r=In(t),e=document.getElementById("auto-styles");e||(e=document.createElement("style"),e.id="auto-styles",document.head.appendChild(e));let o=`:root {
`;Object.entries(r).forEach(([s,n])=>{o+=`  ${s}: ${n};
`;}),o+="}",e.textContent=o;let i=document.body;return r["--sl-color-primary-500"]&&i.style.setProperty("--sl-color-primary-500",r["--sl-color-primary-500"]),console.log("Primary color changed successfully"),r}catch(r){console.error("Failed to change theme color:",r);}}globalThis.changePrimaryColor=Cc;var $e=class extends Event{constructor(r,e,o,i){super("context-request",{bubbles:true,composed:true}),this.context=r,this.contextTarget=e,this.callback=o,this.subscribe=i??false;}};var ur=class{constructor(r,e,o,i){if(this.subscribe=false,this.provided=false,this.value=void 0,this.t=(s,n)=>{this.unsubscribe&&(this.unsubscribe!==n&&(this.provided=false,this.unsubscribe()),this.subscribe||this.unsubscribe()),this.value=s,this.host.requestUpdate(),this.provided&&!this.subscribe||(this.provided=true,this.callback&&this.callback(s,n)),this.unsubscribe=n;},this.host=r,e.context!==void 0){let s=e;this.context=s.context,this.callback=s.callback,this.subscribe=s.subscribe??false;}else this.context=e,this.callback=o,this.subscribe=i??false;this.host.addController(this);}hostConnected(){this.dispatchRequest();}hostDisconnected(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=void 0);}dispatchRequest(){this.host.dispatchEvent(new $e(this.context,this.host,this.t,this.subscribe));}};var Bo=class{get value(){return this.o}set value(r){this.setValue(r);}setValue(r,e=false){let o=e||!Object.is(r,this.o);this.o=r,o&&this.updateObservers();}constructor(r){this.subscriptions=new Map,this.updateObservers=()=>{for(let[e,{disposer:o}]of this.subscriptions)e(this.o,o);},r!==void 0&&(this.value=r);}addCallback(r,e,o){if(!o)return void r(this.value);this.subscriptions.has(r)||this.subscriptions.set(r,{disposer:()=>{this.subscriptions.delete(r);},consumerHost:e});let{disposer:i}=this.subscriptions.get(r);r(this.value,i);}clearCallbacks(){this.subscriptions.clear();}};var Zi=class extends Event{constructor(r,e){super("context-provider",{bubbles:true,composed:true}),this.context=r,this.contextTarget=e;}},mr=class extends Bo{constructor(r,e,o){super(e.context!==void 0?e.initialValue:o),this.onContextRequest=i=>{if(i.context!==this.context)return;let s=i.contextTarget??i.composedPath()[0];s!==this.host&&(i.stopPropagation(),this.addCallback(i.callback,s,i.subscribe));},this.onProviderRequest=i=>{if(i.context!==this.context||(i.contextTarget??i.composedPath()[0])===this.host)return;let s=new Set;for(let[n,{consumerHost:c}]of this.subscriptions)s.has(n)||(s.add(n),c.dispatchEvent(new $e(this.context,c,n,true)));i.stopPropagation();},this.host=r,e.context!==void 0?this.context=e.context:this.context=e,this.attachListeners(),this.host.addController?.(this);}attachListeners(){this.host.addEventListener("context-request",this.onContextRequest),this.host.addEventListener("context-provider",this.onProviderRequest);}hostConnected(){this.host.dispatchEvent(new Zi(this.context,this.host));}};function Ji({context:t}){return (r,e)=>{let o=new WeakMap;if(typeof e=="object")return {get(){return r.get.call(this)},set(i){return o.get(this).setValue(i),r.set.call(this,i)},init(i){return o.set(this,new mr(this,{context:t,initialValue:i})),i}};{r.constructor.addInitializer(n=>{o.set(n,new mr(n,{context:t}));});let i=Object.getOwnPropertyDescriptor(r,e),s;if(i===void 0){let n=new WeakMap;s={get(){return n.get(this)},set(c){o.get(this).setValue(c),n.set(this,c);},configurable:true,enumerable:true};}else {let n=i.set;s={...i,set(c){o.get(this).setValue(c),n?.call(this,c);}};}return void Object.defineProperty(r,e,s)}}}function ts({context:t,subscribe:r}){return (e,o)=>{typeof o=="object"?o.addInitializer(function(){new ur(this,{context:t,callback:i=>{e.set.call(this,i);},subscribe:r});}):e.constructor.addInitializer(i=>{new ur(i,{context:t,callback:s=>{i[o]=s;},subscribe:r});});}}var Wo="autoform";var jo=y`
...
`;var vt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Mt=t=>(...r)=>({_$litDirective$:t,values:r}),At=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,o){this._$Ct=r,this._$AM=e,this._$Ci=o;}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var{I:$c}=Ys;var Ln=(t,r)=>t?._$litType$!==void 0;var No=t=>t.strings===void 0,zn=()=>document.createComment(""),fr=(t,r,e)=>{let o=t._$AA.parentNode,i=r===void 0?t._$AB:r._$AA;if(e===void 0){let s=o.insertBefore(zn(),i),n=o.insertBefore(zn(),i);e=new $c(s,n,t,t.options);}else {let s=e._$AB.nextSibling,n=e._$AM,c=n!==t;if(c){let a;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(a=t._$AU)!==n._$AU&&e._$AP(a);}if(s!==i||c){let a=e._$AA;for(;a!==s;){let h=a.nextSibling;o.insertBefore(a,i),a=h;}}}return e},Ee=(t,r,e=t)=>(t._$AI(r,e),t),Ec={},Uo=(t,r=Ec)=>t._$AH=r,Vn=t=>t._$AH,qo=t=>{t._$AP?.(false,true);let r=t._$AA,e=t._$AB.nextSibling;for(;r!==e;){let o=r.nextSibling;r.remove(),r=o;}};var Pn=(t,r,e)=>{let o=new Map;for(let i=r;i<=e;i++)o.set(t[i],i);return o},et=Mt(class extends At{constructor(t){if(super(t),t.type!==vt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,r,e){let o;e===void 0?e=r:r!==void 0&&(o=r);let i=[],s=[],n=0;for(let c of t)i[n]=o?o(c,n):n,s[n]=e(c,n),n++;return {values:s,keys:i}}render(t,r,e){return this.dt(t,r,e).values}update(t,[r,e,o]){let i=Vn(t),{values:s,keys:n}=this.dt(r,e,o);if(!Array.isArray(i))return this.ut=n,s;let c=this.ut??=[],a=[],h,m,d=0,f=i.length-1,g=0,b=s.length-1;for(;d<=f&&g<=b;)if(i[d]===null)d++;else if(i[f]===null)f--;else if(c[d]===n[g])a[g]=Ee(i[d],s[g]),d++,g++;else if(c[f]===n[b])a[b]=Ee(i[f],s[b]),f--,b--;else if(c[d]===n[b])a[b]=Ee(i[d],s[b]),fr(t,a[b+1],i[d]),d++,b--;else if(c[f]===n[g])a[g]=Ee(i[f],s[g]),fr(t,i[d],i[f]),f--,g++;else if(h===void 0&&(h=Pn(n,g,b),m=Pn(c,d,f)),h.has(c[d]))if(h.has(c[f])){let x=m.get(n[g]),T=x!==void 0?i[x]:null;if(T===null){let E=fr(t,i[d]);Ee(E,s[g]),a[g]=E;}else a[g]=Ee(T,s[g]),fr(t,i[d],T),i[x]=null;g++;}else qo(i[f]),f--;else qo(i[d]),d++;for(;g<=b;){let x=fr(t,a[b+1]);Ee(x,s[g]),a[g++]=x;}for(;d<=f;){let x=i[d++];x!==null&&qo(x);}return this.ut=n,Uo(t,a),nt}});var gr=class{constructor(r){this.host=r,r.addController(this);}updateContext(){Object.assign(this.host.context,{labelPos:this.host.labelPos,labelWidth:this.host.labelWidth,readonly:this.host.readonly,viewonly:this.host.viewonly,viewAlign:this.host.viewAlign,compact:this.host.compact,border:this.host.border,group:this.host.group,layout:this.host.layout,advanced:this.host.advanced,validAt:this.host.validAt,size:this.host.size});}hostUpdate(){this.host.tagName==="AUTO-FORM"&&this.updateContext();}};var Mn="important",Ac=" !"+Mn,J=Mt(class extends At{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((r,e)=>{let o=t[e];return o==null?r:r+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${o};`},"")}update(t,[r]){let{style:e}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(r)),this.render(r);for(let o of this.ft)r[o]==null&&(this.ft.delete(o),o.includes("-")?e.removeProperty(o):e[o]=null);for(let o in r){let i=r[o];if(i!=null){this.ft.add(o);let s=typeof i=="string"&&i.endsWith(Ac);o.includes("-")||s?e.setProperty(o,s?i.slice(0,-11):i,s?Mn:""):e[o]=i;}}return nt}});function B(t,r,e){return t?r(t):e?.(t)}var Ae=class{constructor(r,...e){this.initialClasses=[];this.host=r,r.addController(this),this.initialClasses=e;}_forEachClasss(r,e){r&&r.forEach(o=>{typeof o=="string"?(e(o,true),this.host.classList.add(o)):Object.entries(o).forEach(([i,s])=>{e(i,s);});});}add(...r){this.host&&r&&this._forEachClasss(r,e=>{this.host.classList.add(e);});}remove(...r){this.host&&r&&this._forEachClasss(r,e=>{this.host.classList.remove(e);});}toggle(...r){this.host&&this._forEachClasss(r,e=>{this.host.classList.toggle(e);});}use(...r){this.host&&this._forEachClasss(r,(e,o)=>{o?this.host.classList.add(e):this.host.classList.remove(e);});}has(r){return this.host.classList.contains(r)}hostConnected(){this.add(...this.initialClasses);}hostDisconnected(){this.remove(...this.initialClasses);}hostUpdate(){}};var Ur=class extends At{constructor(r){if(super(r),this.it=Y,r.type!==vt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(r){if(r===Y||r==null)return this._t=void 0,this.it=r;if(r===nt)return r;if(typeof r!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(r===this.it)return this._t;this.it=r;let e=[r];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Ur.directiveName="unsafeHTML",Ur.resultType=1;var Ot=Mt(Ur);function Dn(t,r){r&&Object.entries(r).forEach(([e,o])=>{(e==="root"?[t]:Array.from(t.querySelectorAll(e))).forEach(s=>{typeof o=="string"?s.style.cssText=o:typeof o=="object"&&Object.assign(s.style,o);});});}function br(t,r,e){e?t.classList.add(r):t.classList.remove(r);}function Fn(){return {widget:"input",name:"",path:[],visible:true,enable:true,required:false,order:0,advanced:false,actions:[]}}var R=class extends ut{constructor(){super(...arguments);this.theme=new gr(this);this.classs=new Ae(this);this.options=Fn();this.value="";this.name="";this.path="";this.labelPos="top";this.dirty=false;this.noreactive=false;this.beforeActions=[];this.afterActions=[];this._subscribers=[];this.onFieldChange=()=>this._updateFieldValue();this.onFieldInput=()=>this._updateFieldValue();}static{this.styles=Rn;}get shadow(){return this.shadowRoot}getFieldOptions(){return Object.entries(this.schema||{}).reduce((e,[o,i])=>(ke(i)?e[o]=i.value:e[o]=i,e),Object.assign({},Fn(),this.getInitialOptions()))}getPrefix(){}getSuffix(){}renderActions(e=true){return u`${this.renderBeforeActions(e)} ${this.renderAfterActions(e)}`}_onClickAction(e,o){return i=>{typeof o=="function"&&o(i),e.onClick&&typeof e.onClick=="function"&&e.onClick?.call(this,this.getInputValue(),{action:e,options:this.options,event:i,update:s=>{Do(this.context.store.state,this.options.path,s);}});}}renderBeforeActions(e){if(Array.isArray(this.beforeActions)&&this.beforeActions.length>0)return u`<div
            ...
            >
                ...
                <sl-menu>
                    ${et(e.items||[],o=>o==="-"?u`<sl-divider></sl-divider>`:(typeof o=="string"&&(o={label:o}),u`<sl-menu-item
        ...
        `],exports.AutoFieldInput=v([I("auto-field-input")],exports.AutoFieldInput);var Hn=y`
  :host {
...
`;var Go,L=class extends ut{constructor(){super(),$n(this,Go,false),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([t,r])=>{this.constructor.define(t,r);});}emit(t,r){let e=new CustomEvent(t,St({bubbles:true,cancelable:false,composed:true,detail:{}},r));return this.dispatchEvent(e),e}static define(t,r=this,e={}){let o=customElements.get(t);if(!o){try{customElements.define(t,r,e);}catch{customElements.define(t,class extends r{},e);}return}let i=" (unknown version)",s=i;"version"in r&&r.version&&(i=" v"+r.version),"version"in o&&o.version&&(s=" v"+o.version),!(i&&s&&i===s)&&console.warn(`Attempted to register <${t}>${i}, but <${t}>${s} has already been registered.`);}attributeChangedCallback(t,r,e){kn(this,Go)||(this.constructor.elementProperties.forEach((o,i)=>{o.reflect&&this[i]!=null&&this.initialReflectedProperties.set(i,this[i]);}),En(this,Go,true)),super.attributeChangedCallback(t,r,e);}willUpdate(t){super.willUpdate(t),this.initialReflectedProperties.forEach((r,e)=>{t.has(e)&&this[e]==null&&(this[e]=r);});}};Go=new WeakMap;L.version="2.20.1";L.dependencies={};l([p()],L.prototype,"dir",2);l([p()],L.prototype,"lang",2);var Yr=Symbol(),Yo=Symbol(),rs,os=new Map,q=class extends L{constructor(){super(...arguments),this.initialRender=false,this.svg=null,this.label="",this.library="default";}async resolveIcon(t,r){var e;let o;if(r?.spriteSheet)return this.svg=u`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,this.svg;try{if(o=await fetch(t,{mode:"cors"}),!o.ok)return o.status===410?Yr:Yo}catch{return Yo}try{let i=document.createElement("div");i.innerHTML=await o.text();let s=i.firstElementChild;if(((e=s?.tagName)==null?void 0:e.toLowerCase())!=="svg")return Yr;rs||(rs=new DOMParser);let c=rs.parseFromString(s.outerHTML,"text/html").body.querySelector("svg");return c?(c.part.add("svg"),document.adoptNode(c)):Yr}catch{return Yr}}connectedCallback(){super.connectedCallback(),qi(this);}firstUpdated(){this.initialRender=true,this.setIcon();}disconnectedCallback(){super.disconnectedCallback(),Ki(this);}getIconSource(){let t=dr(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:true}:{url:this.src,fromLibrary:false}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"));}async setIcon(){var t;let{url:r,fromLibrary:e}=this.getIconSource(),o=e?dr(this.library):void 0;if(!r){this.svg=null;return}let i=os.get(r);if(i||(i=this.resolveIcon(r,o),os.set(r,i)),!this.initialRender)return;let s=await i;if(s===Yo&&os.delete(r),r===this.getIconSource().url){if(Ln(s)){if(this.svg=s,o){await this.updateComplete;let n=this.shadowRoot.querySelector("[part='svg']");typeof o.mutator=="function"&&n&&o.mutator(n);}return}switch(s){case Yo:case Yr:this.svg=null,this.emit("sl-error");break;default:this.svg=s.cloneNode(true),(t=o?.mutator)==null||t.call(o,this.svg),this.emit("sl-load");}}}render(){return this.svg}};q.styles=[V,Nn];l([k()],q.prototype,"svg",2);l([p({reflect:true})],q.prototype,"name",2);l([p()],q.prototype,"src",2);l([p()],q.prototype,"label",2);l([p({reflect:true})],q.prototype,"library",2);l([A("label")],q.prototype,"handleLabelChange",1);l([A(["name","src","library"])],q.prototype,"setIcon",1);var z=Mt(class extends At{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return " "+Object.keys(t).filter(r=>t[r]).join(" ")+" "}update(t,[r]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(let o in r)r[o]&&!this.nt?.has(o)&&this.st.add(o);return this.render(r)}let e=t.element.classList;for(let o of this.st)o in r||(e.remove(o),this.st.delete(o));for(let o in r){let i=!!r[o];i===this.st.has(o)||this.nt?.has(o)||(i?(e.add(o),this.st.add(o)):(e.remove(o),this.st.delete(o)));}return nt}});var kt=Mt(class extends At{constructor(t){if(super(t),t.type!==vt.PROPERTY&&t.type!==vt.ATTRIBUTE&&t.type!==vt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!No(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[r]){if(r===nt||r===Y)return r;let e=t.element,o=t.name;if(t.type===vt.PROPERTY){if(r===e[o])return nt}else if(t.type===vt.BOOLEAN_ATTRIBUTE){if(!!r===e.hasAttribute(o))return nt}else if(t.type===vt.ATTRIBUTE&&e.getAttribute(o)===r+"")return nt;return Uo(t),r}});var ot=class extends L{constructor(){super(...arguments),this.formControlController=new mt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,r)=>t.checked=r}),this.hasSlotController=new at(this,"help-text"),this.hasFocus=false,this.title="",this.name="",this.size="medium",this.disabled=false,this.checked=false,this.indeterminate=false,this.defaultChecked=false,this.form="",this.required=false,this.helpText="";}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity();}handleClick(){this.checked=!this.checked,this.indeterminate=false,this.emit("sl-change");}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleInput(){this.emit("sl-input");}handleInvalid(t){this.formControlController.setValidity(false),this.formControlController.emitInvalidEvent(t);}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleDisabledChange(){this.formControlController.setValidity(this.disabled);}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity();}click(){this.input.click();}focus(t){this.input.focus(t);}blur(){this.input.blur();}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity();}render(){let t=this.hasSlotController.test("help-text"),r=this.helpText?true:!!t;return u`
      <div
    ...
    `}};ot.styles=[V,Tt,Hn];ot.dependencies={"sl-icon":q};l([$('input[type="checkbox"]')],ot.prototype,"input",2);l([k()],ot.prototype,"hasFocus",2);l([p()],ot.prototype,"title",2);l([p()],ot.prototype,"name",2);l([p()],ot.prototype,"value",2);l([p({reflect:true})],ot.prototype,"size",2);l([p({type:Boolean,reflect:true})],ot.prototype,"disabled",2);l([p({type:Boolean,reflect:true})],ot.prototype,"checked",2);l([p({type:Boolean,reflect:true})],ot.prototype,"indeterminate",2);l([Ht("checked")],ot.prototype,"defaultChecked",2);l([p({reflect:true})],ot.prototype,"form",2);l([p({type:Boolean,reflect:true})],ot.prototype,"required",2);l([p({attribute:"help-text"})],ot.prototype,"helpText",2);l([A("disabled",{waitUntilFirstUpdate:true})],ot.prototype,"handleDisabledChange",1);l([A(["checked","indeterminate"],{waitUntilFirstUpdate:true})],ot.prototype,"handleStateChange",1);ot.define("sl-checkbox");exports.AutoFieldCheckbox=class Xr extends R{renderInput(){return u`
            <sl-checkbox
                slot="value"
                name="${this.name}"
                data-path=${this.path}
        ...
        `],exports.AutoFieldCheckbox=v([I("auto-field-checkbox")],exports.AutoFieldCheckbox);var Un=y`
  :host {
    display: block;
  }
...
`;var Zt=class extends L{constructor(){super(),this.checked=false,this.hasFocus=false,this.size="medium",this.disabled=false,this.handleBlur=()=>{this.hasFocus=false,this.emit("sl-blur");},this.handleClick=()=>{this.disabled||(this.checked=true);},this.handleFocus=()=>{this.hasFocus=true,this.emit("sl-focus");},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus);}connectedCallback(){super.connectedCallback(),this.setInitialAttributes();}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false");}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1");}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false");}render(){return u`
    ...
    `}};Zt.styles=[V,Un];Zt.dependencies={"sl-icon":q};l([k()],Zt.prototype,"checked",2);l([k()],Zt.prototype,"hasFocus",2);l([p()],Zt.prototype,"value",2);l([p({reflect:true})],Zt.prototype,"size",2);l([p({type:Boolean,reflect:true})],Zt.prototype,"disabled",2);l([A("checked")],Zt.prototype,"handleCheckedChange",1);l([A("disabled",{waitUntilFirstUpdate:true})],Zt.prototype,"handleDisabledChange",1);Zt.define("sl-radio");var qn=y`
  :host {
    display: block;
  }
...
`;var Oe=class extends L{constructor(){super(...arguments),this.disableRole=false,this.label="";}handleFocus(t){let r=Qr(t.target);r?.toggleAttribute("data-sl-button-group__button--focus",true);}handleBlur(t){let r=Qr(t.target);r?.toggleAttribute("data-sl-button-group__button--focus",false);}handleMouseOver(t){let r=Qr(t.target);r?.toggleAttribute("data-sl-button-group__button--hover",true);}handleMouseOut(t){let r=Qr(t.target);r?.toggleAttribute("data-sl-button-group__button--hover",false);}handleSlotChange(){let t=[...this.defaultSlot.assignedElements({flatten:true})];t.forEach(r=>{let e=t.indexOf(r),o=Qr(r);o&&(o.toggleAttribute("data-sl-button-group__button",true),o.toggleAttribute("data-sl-button-group__button--first",e===0),o.toggleAttribute("data-sl-button-group__button--inner",e>0&&e<t.length-1),o.toggleAttribute("data-sl-button-group__button--last",e===t.length-1),o.toggleAttribute("data-sl-button-group__button--radio",o.tagName.toLowerCase()==="sl-radio-button"));});}render(){return u`
      <div
        part="base"
        class="button-group"
    ...
    `}};ft.styles=[V,Tt,qn];ft.dependencies={"sl-button-group":Oe};l([$("slot:not([name])")],ft.prototype,"defaultSlot",2);l([$(".radio-group__validation-input")],ft.prototype,"validationInput",2);l([k()],ft.prototype,"hasButtonGroup",2);l([k()],ft.prototype,"errorMessage",2);l([k()],ft.prototype,"defaultValue",2);l([p()],ft.prototype,"label",2);l([p({attribute:"help-text"})],ft.prototype,"helpText",2);l([p()],ft.prototype,"name",2);l([p({reflect:true})],ft.prototype,"value",2);l([p({reflect:true})],ft.prototype,"size",2);l([p({reflect:true})],ft.prototype,"form",2);l([p({type:Boolean,reflect:true})],ft.prototype,"required",2);l([A("size",{waitUntilFirstUpdate:true})],ft.prototype,"handleSizeChange",1);l([A("value")],ft.prototype,"handleValueChange",1);ft.define("sl-radio-group");exports.AutoFieldRadio=class Zr extends R{getInitialOptions(){return {card:false,select:[],valueKey:"value"}}renderOptionItemWithCard(r,e){if(this.options.card){let o=e[this.options.valueKey]||e.label,i=this.value===o;return u`<div
                class="card"
        ...
        `],exports.AutoFieldRadio=v([I("auto-field-radio")],exports.AutoFieldRadio);var Gn=y`
  :host {
    display: block;
  }
...
`;var K=class extends L{constructor(){super(...arguments),this.formControlController=new mt(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new at(this,"help-text","label"),this.hasFocus=false,this.title="",this.name="",this.value="",this.size="medium",this.filled=false,this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=false,this.readonly=false,this.form="",this.required=false,this.spellcheck=true,this.defaultValue="";}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input);});}firstUpdated(){this.formControlController.updateValidity();}disconnectedCallback(){var t;super.disconnectedCallback(),this.input&&((t=this.resizeObserver)==null||t.unobserve(this.input));}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("sl-change");}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleInput(){this.value=this.input.value,this.emit("sl-input");}handleInvalid(t){this.formControlController.setValidity(false),this.formControlController.emitInvalidEvent(t);}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height="";}handleDisabledChange(){this.formControlController.setValidity(this.disabled);}handleRowsChange(){this.setTextareaHeight();}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight();}focus(t){this.input.focus(t);}blur(){this.input.blur();}select(){this.input.select();}scrollPosition(t){if(t){typeof t.top=="number"&&(this.input.scrollTop=t.top),typeof t.left=="number"&&(this.input.scrollLeft=t.left);return}return {top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,r,e="none"){this.input.setSelectionRange(t,r,e);}setRangeText(t,r,e,o="preserve"){let i=r??this.input.selectionStart,s=e??this.input.selectionEnd;this.input.setRangeText(t,i,s,o),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight());}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity();}render(){let t=this.hasSlotController.test("label"),r=this.hasSlotController.test("help-text"),e=this.label?true:!!t,o=this.helpText?true:!!r;return u`
    ...
    `}};K.styles=[V,Tt,Gn];l([$(".textarea__control")],K.prototype,"input",2);l([$(".textarea__size-adjuster")],K.prototype,"sizeAdjuster",2);l([k()],K.prototype,"hasFocus",2);l([p()],K.prototype,"title",2);l([p()],K.prototype,"name",2);l([p()],K.prototype,"value",2);l([p({reflect:true})],K.prototype,"size",2);l([p({type:Boolean,reflect:true})],K.prototype,"filled",2);l([p()],K.prototype,"label",2);l([p({attribute:"help-text"})],K.prototype,"helpText",2);l([p()],K.prototype,"placeholder",2);l([p({type:Number})],K.prototype,"rows",2);l([p()],K.prototype,"resize",2);l([p({type:Boolean,reflect:true})],K.prototype,"disabled",2);l([p({type:Boolean,reflect:true})],K.prototype,"readonly",2);l([p({reflect:true})],K.prototype,"form",2);l([p({type:Boolean,reflect:true})],K.prototype,"required",2);l([p({type:Number})],K.prototype,"minlength",2);l([p({type:Number})],K.prototype,"maxlength",2);l([p()],K.prototype,"autocapitalize",2);l([p()],K.prototype,"autocorrect",2);l([p()],K.prototype,"autocomplete",2);l([p({type:Boolean})],K.prototype,"autofocus",2);l([p()],K.prototype,"enterkeyhint",2);l([p({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],K.prototype,"spellcheck",2);l([p()],K.prototype,"inputmode",2);l([Ht()],K.prototype,"defaultValue",2);l([A("disabled",{waitUntilFirstUpdate:true})],K.prototype,"handleDisabledChange",1);l([A("rows",{waitUntilFirstUpdate:true})],K.prototype,"handleRowsChange",1);l([A("value",{waitUntilFirstUpdate:true})],K.prototype,"handleValueChange",1);K.define("sl-textarea");exports.AutoFieldTextArea=class Jr extends R{renderInput(){return u`
            <sl-textarea
                name=${this.name}
                data-path=${this.path}
                value=${this.value}
        ...
        `],exports.AutoFieldTextArea=v([I("auto-field-textarea")],exports.AutoFieldTextArea);var Yn=y`
  :host {
    display: inline-block;
  }
...
`;var yt=class extends L{constructor(){super(...arguments),this.formControlController=new mt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,r)=>t.checked=r}),this.hasSlotController=new at(this,"help-text"),this.hasFocus=false,this.title="",this.name="",this.size="medium",this.disabled=false,this.checked=false,this.defaultChecked=false,this.form="",this.required=false,this.helpText="";}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity();}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleInput(){this.emit("sl-input");}handleInvalid(t){this.formControlController.setValidity(false),this.formControlController.emitInvalidEvent(t);}handleClick(){this.checked=!this.checked,this.emit("sl-change");}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=false,this.emit("sl-change"),this.emit("sl-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=true,this.emit("sl-change"),this.emit("sl-input"));}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity();}handleDisabledChange(){this.formControlController.setValidity(true);}click(){this.input.click();}focus(t){this.input.focus(t);}blur(){this.input.blur();}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity();}render(){let t=this.hasSlotController.test("help-text"),r=this.helpText?true:!!t;return u`
    ...
    `}};yt.styles=[V,Tt,Yn];l([$('input[type="checkbox"]')],yt.prototype,"input",2);l([k()],yt.prototype,"hasFocus",2);l([p()],yt.prototype,"title",2);l([p()],yt.prototype,"name",2);l([p()],yt.prototype,"value",2);l([p({reflect:true})],yt.prototype,"size",2);l([p({type:Boolean,reflect:true})],yt.prototype,"disabled",2);l([p({type:Boolean,reflect:true})],yt.prototype,"checked",2);l([Ht("checked")],yt.prototype,"defaultChecked",2);l([p({reflect:true})],yt.prototype,"form",2);l([p({type:Boolean,reflect:true})],yt.prototype,"required",2);l([p({attribute:"help-text"})],yt.prototype,"helpText",2);l([A("checked",{waitUntilFirstUpdate:true})],yt.prototype,"handleCheckedChange",1);l([A("disabled",{waitUntilFirstUpdate:true})],yt.prototype,"handleDisabledChange",1);yt.define("sl-switch");exports.AutoFieldSwitch=class to extends R{renderInput(){return u`
            <sl-switch
                slot="value"
                name="${this.name}"
                data-path=${this.path}
        ...
        `],exports.AutoFieldSwitch=v([I("auto-field-switch")],exports.AutoFieldSwitch);var Xo=y`
  :host {
    display: inline-block;
    position: relative;
    width: auto;
...
`;var Zn=Symbol.for(""),Oc=t=>{if(t?.r===Zn)return t?._$litStatic$};var yr=(t,...r)=>({_$litStatic$:r.reduce((e,o,i)=>e+(s=>{if(s._$litStatic$!==void 0)return s._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${s}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+t[i+1],t[0]),r:Zn}),Qn=new Map,is=t=>(r,...e)=>{let o=e.length,i,s,n=[],c=[],a,h=0,m=false;for(;h<o;){for(a=r[h];h<o&&(s=e[h],(i=Oc(s))!==void 0);)a+=i+r[++h],m=true;h!==o&&c.push(s),n.push(a),h++;}if(h===o&&n.push(r[o]),m){let d=n.join("$$lit$$");(r=Qn.get(d))===void 0&&(n.raw=n,Qn.set(d,r=n)),e=c;}return t(r,...e)},Te=is(u);var Bt=class extends L{constructor(){super(...arguments),this.hasSlotController=new at(this,"[default]","prefix","suffix"),this.hasFocus=false,this.checked=false,this.disabled=false,this.size="medium",this.pill=false;}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation");}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleClick(t){if(this.disabled){t.preventDefault(),t.stopPropagation();return}this.checked=true;}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false");}focus(t){this.input.focus(t);}blur(){this.input.blur();}render(){return Te`
    ...
    `}};Bt.styles=[V,Xn];l([$(".button")],Bt.prototype,"input",2);l([$(".hidden-input")],Bt.prototype,"hiddenInput",2);l([k()],Bt.prototype,"hasFocus",2);l([p({type:Boolean,reflect:true})],Bt.prototype,"checked",2);l([p()],Bt.prototype,"value",2);l([p({type:Boolean,reflect:true})],Bt.prototype,"disabled",2);l([p({reflect:true})],Bt.prototype,"size",2);l([p({type:Boolean,reflect:true})],Bt.prototype,"pill",2);l([A("disabled",{waitUntilFirstUpdate:true})],Bt.prototype,"handleDisabledChange",1);Bt.define("sl-radio-button");exports.AutoFieldRadioButton=class eo extends R{getInitialOptions(){return {valueKey:"value"}}renderRadioItem(r){let e=r[this.options.valueKey];return u`<sl-radio-button value="${e}" ?pill=${this.options.pill} ?disabled=${!this.options.enable}>${r.label}</sl-radio-button>`}renderInput(){let r=this.getOptionValue("select",[]).map((e,o)=>{let i={};return typeof e=="object"?Object.assign(i,e):Object.assign(i,{label:e,value:o+1}),i});return u`
    ...
    `;}create(r,e){let o=new ss(r,e);return this._scrollbars.push(o),o}hostConnected(){}hostUpdate(){}hostDisconnected(){for(let r of this._scrollbars)r.destroy();this._scrollbars=[];}};var Tc=[".png",".jpg",".jpeg",".gif",".webp",".svg",".bmp",".ico",".apng",".avif"],Ic=[".mp4",".webm",".ogg",".ogv",".mov",".avi",".wmv",".flv",".mkv",".m4v",".3gp",".mpeg",".mpg",".ts",".m2ts",".hevc",".rm",".rmvb",".vob",".asf"];function Rc(t){if(!t||typeof t!="string")return  false;let o=t.split("?")[0].split("/").pop().split(".").pop();return Tc.includes(`.${o}`)}function zc(t){if(!t||typeof t!="string")return  false;let o=t.split("?")[0].split("/").pop().split(".").pop();return Ic.includes(`.${o}`)}exports.AutoFieldUpload=class xr extends R{constructor(){super(...arguments);this.files=[];this.fileInputRef=null;this._imagePreview=new si(this);}retryUpload(e){this.startUpload(e.file,e.id);}getInitialOptions(){return {fileTypes:[],url:"",multiple:true,fileFieldName:"files",preview:true,tips:"\u62D6\u52A8\u6587\u4EF6\u5230\u6B64\u5904\u6216\u70B9\u51FB\u9009\u62E9\u6587\u4EF6\u4E0A\u4F20",onResolve:this._defaultFileResolver.bind(this),onFileLabel:this._getDefaultFileLabel.bind(this),selector:"auto",onlyFileUrl:true}}_getDefaultFileLabel(e){return typeof e=="string"?e:e.title||e.url.split("/").slice(-1)[0]}_createUploadInput(){this.fileInputRef=document.createElement("input"),this.fileInputRef.type="file",this.fileInputRef.multiple=!!this.options?.multiple,this.options.fileTypes.length>0&&(this.fileInputRef.accept=this.options.fileTypes.filter(e=>e!=="*").join(",")),this.fileInputRef.style.display="none",this.fileInputRef.addEventListener("change",this.handleFileInputChange.bind(this)),this.renderRoot.appendChild(this.fileInputRef);}firstUpdated(){this._createUploadInput();}handleFileInputChange(e){let o=e.target;if(!o.files||o.files.length===0)return;Array.from(o.files).forEach(s=>this.uploadFile(s)),o.value="";}handleDragOver(e){e.preventDefault(),this.renderRoot.querySelector(".upload")?.classList.add("dragover");}handleDragLeave(e){e.preventDefault(),this.renderRoot.querySelector(".upload")?.classList.remove("dragover");}handleDrop(e){if(e.preventDefault(),this.renderRoot.querySelector(".upload")?.classList.remove("dragover"),!e.dataTransfer?.files)return;let i=Array.from(e.dataTransfer.files);if(!this.options?.multiple&&i.length>1){alert("\u53EA\u80FD\u4E0A\u4F20\u4E00\u4E2A\u6587\u4EF6");return}if(this.options?.fileTypes&&this.options.fileTypes.length>0){let s=i.filter(n=>this.options?.fileTypes?!this.options.fileTypes.some(c=>c==="*"?true:c.startsWith(".")?n.name.toLowerCase().endsWith(c.toLowerCase()):n.type.startsWith(c)):false);if(s.length>0){alert(`\u4E0D\u652F\u6301\u7684\u6587\u4EF6\u7C7B\u578B: ${s.map(n=>n.name).join(", ")}`);return}}i.forEach(s=>this.uploadFile(s));}handleUploadClick(){this.fileInputRef?.click();}generateId(){return Math.random().toString(36).substring(2,9)}async uploadFile(e){if(!this.options?.url)throw new Error("Upload URL is not configured");this.options?.multiple||(this.files=[]);let o={id:this.generateId(),file:e,progress:0,status:"uploading",value:{url:e.name}};return this.files.push(o),this.startUpload(e,o.id)}_updateFileRecord(e,o){let i=this.files.findIndex(s=>s.id===e);i!==-1&&(this.files=[...this.files.slice(0,i),{...this.files[i],...o},...this.files.slice(i+1)]);}_getResponseError(e){let o="\u4E0A\u4F20\u5931\u8D25";try{let i=JSON.parse(e.responseText);o=i.message||i.error||o;}catch{switch(e.status){case 400:o="\u8BF7\u6C42\u65E0\u6548\uFF0C\u8BF7\u68C0\u67E5\u4E0A\u4F20\u53C2\u6570";break;case 401:o="\u672A\u6388\u6743\uFF0C\u8BF7\u5148\u767B\u5F55";break;case 403:o="\u65E0\u6743\u9650\u4E0A\u4F20\u6587\u4EF6";break;case 413:o="\u6587\u4EF6\u592A\u5927";break;case 415:o="\u4E0D\u652F\u6301\u7684\u6587\u4EF6\u7C7B\u578B";break;case 500:o="\u670D\u52A1\u5668\u5185\u90E8\u9519\u8BEF\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5";break;case 503:o="\u670D\u52A1\u6682\u65F6\u4E0D\u53EF\u7528\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5";break;default:o=`\u4E0A\u4F20\u5931\u8D25 (${e.status})`;}}return new Error(o)}_defaultFileResolver(e){if(typeof e=="string")return e;if(typeof e=="object"){if(!e.url)throw new Error("\u4E0A\u4F20\u54CD\u5E94\u7F3A\u5C11\u5FC5\u8981\u7684url\u5B57\u6BB5");return e}}_parseUploadResponse(e){let o={};try{Object.assign(o,JSON.parse(e));}catch{o=e;}return typeof this.options.onResolve=="function"&&(o=this.options.onResolve(o)),o}async startUpload(e,o){let i=this.files.findIndex(n=>n.id===o);if(i===-1)return;let s=this.files[i];return new Promise((n,c)=>{let a=new XMLHttpRequest,h=new FormData;h.append(this.options.fileFieldName,e),a.upload.onprogress=m=>{if(m.lengthComputable){let d=Math.round(m.loaded/m.total*100);this._updateFileRecord(o,{progress:d});}},a.onload=()=>{if(this.files.findIndex(d=>d.id===o)!==-1)if(a.status>=200&&a.status<300){this._updateFileRecord(o,{status:"done"});try{let d=this._parseUploadResponse(a.responseText);this._updateFileRecord(o,{value:d}),s.status="done",this.onFieldChange(),n();}catch{let d=new Error("\u89E3\u6790\u4E0A\u4F20\u54CD\u5E94\u5931\u8D25");this.handleUploadError(o,d),c(d);}}else {let d=this._getResponseError(a);this.handleUploadError(o,d),c(d);}},a.onerror=()=>{if(this.files.findIndex(f=>f.id===o)===-1)return;let d=new Error("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5");this.handleUploadError(o,d),c(d);},a.ontimeout=()=>{if(this.files.findIndex(f=>f.id===o)===-1)return;let d=new Error("\u4E0A\u4F20\u8D85\u65F6\uFF0C\u8BF7\u91CD\u8BD5");this.handleUploadError(o,d),c(d);},a.open("POST",this.options.url),this._updateFileRecord(o,{progress:0,status:"uploading"}),a.send(h);})}handleUploadError(e,o){this._updateFileRecord(e,{error:o.message,status:"error"});}deleteFile(e){let o=this.files.findIndex(c=>c.id===e);if(o===-1)return;let i=this.files[o],s=i.status==="uploading"||i.status==="error",n=()=>{this.files=[...this.files.slice(0,o),...this.files.slice(o+1)];};s?n():typeof this.options.onRemove=="function"?Promise.resolve(this.options.onRemove.call(this,i.value)).then(()=>{n(),this.onFieldChange();}).catch(c=>{alert(c.message);}):(n(),this.onFieldChange());}getInputValue(){if(this.options.multiple){let e=this.files.map(o=>o.value);return this.options.onlyFileUrl?e.map(o=>typeof o=="object"?o.url:o):e}else {let e=this.files.length>0?this.files[0].value:void 0;if(e)return this.options.onlyFileUrl&&typeof e=="object"?e.url:e}}getStateValue(){let e=super.getStateValue();return Array.isArray(e)||(e=[e]),this.files=e.map((o,i)=>{let s={id:String(i),file:void 0,progress:0,status:"done",error:void 0,value:void 0};return typeof o=="string"?s.value=o:typeof o=="object"&&(s.value=Object.assign({},s.value,o)),s}),e}renderProgressbar(e,o){if(e.status!=="uploading")return;let i=o==="hori"?`width:${e.progress}%;`:`height:${e.progress}%;top:${100-e.progress}%`;return u`<span
        ...
        `],exports.AutoFieldIpAddress=v([I("auto-field-ipaddress")],exports.AutoFieldIpAddress);var Jn=y`
  :host {
    display: inline-block;
  }
...
`;var lt=class extends L{constructor(){super(...arguments),this.hasFocus=false,this.label="",this.disabled=false;}handleBlur(){this.hasFocus=false,this.emit("sl-blur");}handleFocus(){this.hasFocus=true,this.emit("sl-focus");}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation());}click(){this.button.click();}focus(t){this.button.focus(t);}blur(){this.button.blur();}render(){let t=!!this.href,r=t?yr`a`:yr`button`;return Te`
      <${r}
        part="base"
    ...
    `}};lt.styles=[V,ta];lt.dependencies={"sl-icon":q};l([$(".icon-button")],lt.prototype,"button",2);l([k()],lt.prototype,"hasFocus",2);l([p()],lt.prototype,"name",2);l([p()],lt.prototype,"library",2);l([p()],lt.prototype,"src",2);l([p()],lt.prototype,"href",2);l([p()],lt.prototype,"target",2);l([p()],lt.prototype,"download",2);l([p()],lt.prototype,"label",2);l([p({type:Boolean,reflect:true})],lt.prototype,"disabled",2);var ns=new Set,_r=new Map,Ue,as="ltr",ls="en",ea=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(ea){let t=new MutationObserver(ra);as=document.documentElement.dir||"ltr",ls=document.documentElement.lang||navigator.language,t.observe(document.documentElement,{attributes:true,attributeFilter:["dir","lang"]});}function oo(...t){t.map(r=>{let e=r.$code.toLowerCase();_r.has(e)?_r.set(e,Object.assign(Object.assign({},_r.get(e)),r)):_r.set(e,r),Ue||(Ue=r);}),ra();}function ra(){ea&&(as=document.documentElement.dir||"ltr",ls=document.documentElement.lang||navigator.language),[...ns.keys()].map(t=>{typeof t.requestUpdate=="function"&&t.requestUpdate();});}var ai=class{constructor(r){this.host=r,this.host.addController(this);}hostConnected(){ns.add(this.host);}hostDisconnected(){ns.delete(this.host);}dir(){return `${this.host.dir||as}`.toLowerCase()}lang(){return `${this.host.lang||ls}`.toLowerCase()}getTranslationData(r){var e,o;let i=new Intl.Locale(r.replace(/_/g,"-")),s=i?.language.toLowerCase(),n=(o=(e=i?.region)===null||e===void 0?void 0:e.toLowerCase())!==null&&o!==void 0?o:"",c=_r.get(`${s}-${n}`),a=_r.get(s);return {locale:i,language:s,region:n,primary:c,secondary:a}}exists(r,e){var o;let{primary:i,secondary:s}=this.getTranslationData((o=e.lang)!==null&&o!==void 0?o:this.lang());return e=Object.assign({includeFallback:false},e),!!(i&&i[r]||s&&s[r]||e.includeFallback&&Ue&&Ue[r])}term(r,...e){let{primary:o,secondary:i}=this.getTranslationData(this.lang()),s;if(o&&o[r])s=o[r];else if(i&&i[r])s=i[r];else if(Ue&&Ue[r])s=Ue[r];else return console.error(`No translation found for: ${String(r)}`),String(r);return typeof s=="function"?s(...e):s}date(r,e){return r=new Date(r),new Intl.DateTimeFormat(this.lang(),e).format(r)}number(r,e){return r=Number(r),isNaN(r)?"":new Intl.NumberFormat(this.lang(),e).format(r)}relativeTime(r,e,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(r,e)}};var oa={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,r)=>`Go to slide ${t} of ${r}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format"};oo(oa);var ia=oa;var W=class extends ai{};oo(ia);var se=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.variant="neutral",this.size="medium",this.pill=false,this.removable=false;}handleRemoveClick(){this.emit("sl-remove");}render(){return u`
      <span
        part="base"
    ...
    `}};se.styles=[V,Jn];se.dependencies={"sl-icon-button":lt};l([p({reflect:true})],se.prototype,"variant",2);l([p({reflect:true})],se.prototype,"size",2);l([p({type:Boolean,reflect:true})],se.prototype,"pill",2);l([p({type:Boolean})],se.prototype,"removable",2);var sa=y`
  :host {
    display: block;
  }
...
`;var ne=Math.min,$t=Math.max,no=Math.round,ao=Math.floor,Jt=t=>({x:t,y:t}),Vc={left:"right",right:"left",bottom:"top",top:"bottom"},Pc={start:"end",end:"start"};function ci(t,r,e){return $t(t,ne(r,e))}function qe(t,r){return typeof t=="function"?t(r):t}function me(t){return t.split("-")[0]}function Ke(t){return t.split("-")[1]}function cs(t){return t==="x"?"y":"x"}function pi(t){return t==="y"?"height":"width"}function fe(t){return ["top","bottom"].includes(me(t))?"y":"x"}function di(t){return cs(fe(t))}function aa(t,r,e){e===void 0&&(e=false);let o=Ke(t),i=di(t),s=pi(i),n=i==="x"?o===(e?"end":"start")?"right":"left":o==="start"?"bottom":"top";return r.reference[s]>r.floating[s]&&(n=so(n)),[n,so(n)]}function la(t){let r=so(t);return [li(t),r,li(r)]}function li(t){return t.replace(/start|end/g,r=>Pc[r])}function Mc(t,r,e){let o=["left","right"],i=["right","left"],s=["top","bottom"],n=["bottom","top"];switch(t){case "top":case "bottom":return e?r?i:o:r?o:i;case "left":case "right":return r?s:n;default:return []}}function ca(t,r,e,o){let i=Ke(t),s=Mc(me(t),e==="start",o);return i&&(s=s.map(n=>n+"-"+i),r&&(s=s.concat(s.map(li)))),s}function so(t){return t.replace(/left|right|bottom|top/g,r=>Vc[r])}function Dc(t){return {top:0,right:0,bottom:0,left:0,...t}}function ps(t){return typeof t!="number"?Dc(t):{top:t,right:t,bottom:t,left:t}}function Ge(t){let{x:r,y:e,width:o,height:i}=t;return {width:o,height:i,top:e,left:r,right:r+o,bottom:e+i,x:r,y:e}}function pa(t,r,e){let{reference:o,floating:i}=t,s=fe(r),n=di(r),c=pi(n),a=me(r),h=s==="y",m=o.x+o.width/2-i.width/2,d=o.y+o.height/2-i.height/2,f=o[c]/2-i[c]/2,g;switch(a){case "top":g={x:m,y:o.y-i.height};break;case "bottom":g={x:m,y:o.y+o.height};break;case "right":g={x:o.x+o.width,y:d};break;case "left":g={x:o.x-i.width,y:d};break;default:g={x:o.x,y:o.y};}switch(Ke(r)){case "start":g[n]-=f*(e&&h?-1:1);break;case "end":g[n]+=f*(e&&h?-1:1);break}return g}var da=async(t,r,e)=>{let{placement:o="bottom",strategy:i="absolute",middleware:s=[],platform:n}=e,c=s.filter(Boolean),a=await(n.isRTL==null?void 0:n.isRTL(r)),h=await n.getElementRects({reference:t,floating:r,strategy:i}),{x:m,y:d}=pa(h,o,a),f=o,g={},b=0;for(let x=0;x<c.length;x++){let{name:T,fn:E}=c[x],{x:S,y:O,data:_,reset:C}=await E({x:m,y:d,initialPlacement:o,placement:f,strategy:i,middlewareData:g,rects:h,platform:n,elements:{reference:t,floating:r}});m=S??m,d=O??d,g={...g,[T]:{...g[T],..._}},C&&b<=50&&(b++,typeof C=="object"&&(C.placement&&(f=C.placement),C.rects&&(h=C.rects===true?await n.getElementRects({reference:t,floating:r,strategy:i}):C.rects),{x:m,y:d}=pa(h,f,a)),x=-1);}return {x:m,y:d,placement:f,strategy:i,middlewareData:g}};async function hi(t,r){var e;r===void 0&&(r={});let{x:o,y:i,platform:s,rects:n,elements:c,strategy:a}=t,{boundary:h="clippingAncestors",rootBoundary:m="viewport",elementContext:d="floating",altBoundary:f=false,padding:g=0}=qe(r,t),b=ps(g),T=c[f?d==="floating"?"reference":"floating":d],E=Ge(await s.getClippingRect({element:(e=await(s.isElement==null?void 0:s.isElement(T)))==null||e?T:T.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(c.floating)),boundary:h,rootBoundary:m,strategy:a})),S=d==="floating"?{x:o,y:i,width:n.floating.width,height:n.floating.height}:n.reference,O=await(s.getOffsetParent==null?void 0:s.getOffsetParent(c.floating)),_=await(s.isElement==null?void 0:s.isElement(O))?await(s.getScale==null?void 0:s.getScale(O))||{x:1,y:1}:{x:1,y:1},C=Ge(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:S,offsetParent:O,strategy:a}):S);return {top:(E.top-C.top+b.top)/_.y,bottom:(C.bottom-E.bottom+b.bottom)/_.y,left:(E.left-C.left+b.left)/_.x,right:(C.right-E.right+b.right)/_.x}}var ha=t=>({name:"arrow",options:t,async fn(r){let{x:e,y:o,placement:i,rects:s,platform:n,elements:c,middlewareData:a}=r,{element:h,padding:m=0}=qe(t,r)||{};if(h==null)return {};let d=ps(m),f={x:e,y:o},g=di(i),b=pi(g),x=await n.getDimensions(h),T=g==="y",E=T?"top":"left",S=T?"bottom":"right",O=T?"clientHeight":"clientWidth",_=s.reference[b]+s.reference[g]-f[g]-s.floating[b],C=f[g]-s.reference[g],M=await(n.getOffsetParent==null?void 0:n.getOffsetParent(h)),H=M?M[O]:0;(!H||!await(n.isElement==null?void 0:n.isElement(M)))&&(H=c.floating[O]||s.floating[b]);let U=_/2-C/2,D=H/2-x[b]/2-1,P=ne(d[E],D),pt=ne(d[S],D),st=P,_t=H-x[b]-pt,Ct=H/2-x[b]/2+U,wt=ci(st,Ct,_t),ye=!a.arrow&&Ke(i)!=null&&Ct!==wt&&s.reference[b]/2-(Ct<st?P:pt)-x[b]/2<0,ce=ye?Ct<st?Ct-st:Ct-_t:0;return {[g]:f[g]+ce,data:{[g]:wt,centerOffset:Ct-wt-ce,...ye&&{alignmentOffset:ce}},reset:ye}}});var ua=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(r){var e,o;let{placement:i,middlewareData:s,rects:n,initialPlacement:c,platform:a,elements:h}=r,{mainAxis:m=true,crossAxis:d=true,fallbackPlacements:f,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:x=true,...T}=qe(t,r);if((e=s.arrow)!=null&&e.alignmentOffset)return {};let E=me(i),S=fe(c),O=me(c)===c,_=await(a.isRTL==null?void 0:a.isRTL(h.floating)),C=f||(O||!x?[so(c)]:la(c)),M=b!=="none";!f&&M&&C.push(...ca(c,x,b,_));let H=[c,...C],U=await hi(r,T),D=[],P=((o=s.flip)==null?void 0:o.overflows)||[];if(m&&D.push(U[E]),d){let wt=aa(i,n,_);D.push(U[wt[0]],U[wt[1]]);}if(P=[...P,{placement:i,overflows:D}],!D.every(wt=>wt<=0)){var pt,st;let wt=(((pt=s.flip)==null?void 0:pt.index)||0)+1,ye=H[wt];if(ye){var _t;let xe=d==="alignment"?S!==fe(ye):false,oe=((_t=P[0])==null?void 0:_t.overflows[0])>0;if(!xe||oe)return {data:{index:wt,overflows:P},reset:{placement:ye}}}let ce=(st=P.filter(xe=>xe.overflows[0]<=0).sort((xe,oe)=>xe.overflows[1]-oe.overflows[1])[0])==null?void 0:st.placement;if(!ce)switch(g){case "bestFit":{var Ct;let xe=(Ct=P.filter(oe=>{if(M){let _e=fe(oe.placement);return _e===S||_e==="y"}return  true}).map(oe=>[oe.placement,oe.overflows.filter(_e=>_e>0).reduce((_e,Dl)=>_e+Dl,0)]).sort((oe,_e)=>oe[1]-_e[1])[0])==null?void 0:Ct[0];xe&&(ce=xe);break}case "initialPlacement":ce=c;break}if(i!==ce)return {reset:{placement:ce}}}return {}}}};async function Fc(t,r){let{placement:e,platform:o,elements:i}=t,s=await(o.isRTL==null?void 0:o.isRTL(i.floating)),n=me(e),c=Ke(e),a=fe(e)==="y",h=["left","top"].includes(n)?-1:1,m=s&&a?-1:1,d=qe(r,t),{mainAxis:f,crossAxis:g,alignmentAxis:b}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return c&&typeof b=="number"&&(g=c==="end"?b*-1:b),a?{x:g*m,y:f*h}:{x:f*h,y:g*m}}var ma=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(r){var e,o;let{x:i,y:s,placement:n,middlewareData:c}=r,a=await Fc(r,t);return n===((e=c.offset)==null?void 0:e.placement)&&(o=c.arrow)!=null&&o.alignmentOffset?{}:{x:i+a.x,y:s+a.y,data:{...a,placement:n}}}}},fa=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(r){let{x:e,y:o,placement:i}=r,{mainAxis:s=true,crossAxis:n=false,limiter:c={fn:T=>{let{x:E,y:S}=T;return {x:E,y:S}}},...a}=qe(t,r),h={x:e,y:o},m=await hi(r,a),d=fe(me(i)),f=cs(d),g=h[f],b=h[d];if(s){let T=f==="y"?"top":"left",E=f==="y"?"bottom":"right",S=g+m[T],O=g-m[E];g=ci(S,g,O);}if(n){let T=d==="y"?"top":"left",E=d==="y"?"bottom":"right",S=b+m[T],O=b-m[E];b=ci(S,b,O);}let x=c.fn({...r,[f]:g,[d]:b});return {...x,data:{x:x.x-e,y:x.y-o,enabled:{[f]:s,[d]:n}}}}}};var ga=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(r){var e,o;let{placement:i,rects:s,platform:n,elements:c}=r,{apply:a=()=>{},...h}=qe(t,r),m=await hi(r,h),d=me(i),f=Ke(i),g=fe(i)==="y",{width:b,height:x}=s.floating,T,E;d==="top"||d==="bottom"?(T=d,E=f===(await(n.isRTL==null?void 0:n.isRTL(c.floating))?"start":"end")?"left":"right"):(E=d,T=f==="end"?"top":"bottom");let S=x-m.top-m.bottom,O=b-m.left-m.right,_=ne(x-m[T],S),C=ne(b-m[E],O),M=!r.middlewareData.shift,H=_,U=C;if((e=r.middlewareData.shift)!=null&&e.enabled.x&&(U=O),(o=r.middlewareData.shift)!=null&&o.enabled.y&&(H=S),M&&!f){let P=$t(m.left,0),pt=$t(m.right,0),st=$t(m.top,0),_t=$t(m.bottom,0);g?U=b-2*(P!==0||pt!==0?P+pt:$t(m.left,m.right)):H=x-2*(st!==0||_t!==0?st+_t:$t(m.top,m.bottom));}await a({...r,availableWidth:U,availableHeight:H});let D=await n.getDimensions(c.floating);return b!==D.width||x!==D.height?{reset:{rects:true}}:{}}}};function ui(){return typeof window<"u"}function Ye(t){return va(t)?(t.nodeName||"").toLowerCase():"#document"}function It(t){var r;return (t==null||(r=t.ownerDocument)==null?void 0:r.defaultView)||window}function te(t){var r;return (r=(va(t)?t.ownerDocument:t.document)||window.document)==null?void 0:r.documentElement}function va(t){return ui()?t instanceof Node||t instanceof It(t).Node:false}function Wt(t){return ui()?t instanceof Element||t instanceof It(t).Element:false}function ee(t){return ui()?t instanceof HTMLElement||t instanceof It(t).HTMLElement:false}function ba(t){return !ui()||typeof ShadowRoot>"u"?false:t instanceof ShadowRoot||t instanceof It(t).ShadowRoot}function Sr(t){let{overflow:r,overflowX:e,overflowY:o,display:i}=jt(t);return /auto|scroll|overlay|hidden|clip/.test(r+o+e)&&!["inline","contents"].includes(i)}function ya(t){return ["table","td","th"].includes(Ye(t))}function lo(t){return [":popover-open",":modal"].some(r=>{try{return t.matches(r)}catch{return  false}})}function Cr(t){let r=mi(),e=Wt(t)?jt(t):t;return ["transform","translate","scale","rotate","perspective"].some(o=>e[o]?e[o]!=="none":false)||(e.containerType?e.containerType!=="normal":false)||!r&&(e.backdropFilter?e.backdropFilter!=="none":false)||!r&&(e.filter?e.filter!=="none":false)||["transform","translate","scale","rotate","perspective","filter"].some(o=>(e.willChange||"").includes(o))||["paint","layout","strict","content"].some(o=>(e.contain||"").includes(o))}function xa(t){let r=ge(t);for(;ee(r)&&!Xe(r);){if(Cr(r))return r;if(lo(r))return null;r=ge(r);}return null}function mi(){return typeof CSS>"u"||!CSS.supports?false:CSS.supports("-webkit-backdrop-filter","none")}function Xe(t){return ["html","body","#document"].includes(Ye(t))}function jt(t){return It(t).getComputedStyle(t)}function co(t){return Wt(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function ge(t){if(Ye(t)==="html")return t;let r=t.assignedSlot||t.parentNode||ba(t)&&t.host||te(t);return ba(r)?r.host:r}function _a(t){let r=ge(t);return Xe(r)?t.ownerDocument?t.ownerDocument.body:t.body:ee(r)&&Sr(r)?r:_a(r)}function wr(t,r,e){var o;r===void 0&&(r=[]),e===void 0&&(e=true);let i=_a(t),s=i===((o=t.ownerDocument)==null?void 0:o.body),n=It(i);if(s){let c=fi(n);return r.concat(n,n.visualViewport||[],Sr(i)?i:[],c&&e?wr(c):[])}return r.concat(i,wr(i,[],e))}function fi(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function Ca(t){let r=jt(t),e=parseFloat(r.width)||0,o=parseFloat(r.height)||0,i=ee(t),s=i?t.offsetWidth:e,n=i?t.offsetHeight:o,c=no(e)!==s||no(o)!==n;return c&&(e=s,o=n),{width:e,height:o,$:c}}function hs(t){return Wt(t)?t:t.contextElement}function kr(t){let r=hs(t);if(!ee(r))return Jt(1);let e=r.getBoundingClientRect(),{width:o,height:i,$:s}=Ca(r),n=(s?no(e.width):e.width)/o,c=(s?no(e.height):e.height)/i;return (!n||!Number.isFinite(n))&&(n=1),(!c||!Number.isFinite(c))&&(c=1),{x:n,y:c}}var Hc=Jt(0);function ka(t){let r=It(t);return !mi()||!r.visualViewport?Hc:{x:r.visualViewport.offsetLeft,y:r.visualViewport.offsetTop}}function Bc(t,r,e){return r===void 0&&(r=false),!e||r&&e!==It(t)?false:r}function Qe(t,r,e,o){r===void 0&&(r=false),e===void 0&&(e=false);let i=t.getBoundingClientRect(),s=hs(t),n=Jt(1);r&&(o?Wt(o)&&(n=kr(o)):n=kr(t));let c=Bc(s,e,o)?ka(s):Jt(0),a=(i.left+c.x)/n.x,h=(i.top+c.y)/n.y,m=i.width/n.x,d=i.height/n.y;if(s){let f=It(s),g=o&&Wt(o)?It(o):o,b=f,x=fi(b);for(;x&&o&&g!==b;){let T=kr(x),E=x.getBoundingClientRect(),S=jt(x),O=E.left+(x.clientLeft+parseFloat(S.paddingLeft))*T.x,_=E.top+(x.clientTop+parseFloat(S.paddingTop))*T.y;a*=T.x,h*=T.y,m*=T.x,d*=T.y,a+=O,h+=_,b=It(x),x=fi(b);}}return Ge({width:m,height:d,x:a,y:h})}function us(t,r){let e=co(t).scrollLeft;return r?r.left+e:Qe(te(t)).left+e}function $a(t,r,e){e===void 0&&(e=false);let o=t.getBoundingClientRect(),i=o.left+r.scrollLeft-(e?0:us(t,o)),s=o.top+r.scrollTop;return {x:i,y:s}}function Wc(t){let{elements:r,rect:e,offsetParent:o,strategy:i}=t,s=i==="fixed",n=te(o),c=r?lo(r.floating):false;if(o===n||c&&s)return e;let a={scrollLeft:0,scrollTop:0},h=Jt(1),m=Jt(0),d=ee(o);if((d||!d&&!s)&&((Ye(o)!=="body"||Sr(n))&&(a=co(o)),ee(o))){let g=Qe(o);h=kr(o),m.x=g.x+o.clientLeft,m.y=g.y+o.clientTop;}let f=n&&!d&&!s?$a(n,a,true):Jt(0);return {width:e.width*h.x,height:e.height*h.y,x:e.x*h.x-a.scrollLeft*h.x+m.x+f.x,y:e.y*h.y-a.scrollTop*h.y+m.y+f.y}}function jc(t){return Array.from(t.getClientRects())}function Nc(t){let r=te(t),e=co(t),o=t.ownerDocument.body,i=$t(r.scrollWidth,r.clientWidth,o.scrollWidth,o.clientWidth),s=$t(r.scrollHeight,r.clientHeight,o.scrollHeight,o.clientHeight),n=-e.scrollLeft+us(t),c=-e.scrollTop;return jt(o).direction==="rtl"&&(n+=$t(r.clientWidth,o.clientWidth)-i),{width:i,height:s,x:n,y:c}}function Uc(t,r){let e=It(t),o=te(t),i=e.visualViewport,s=o.clientWidth,n=o.clientHeight,c=0,a=0;if(i){s=i.width,n=i.height;let h=mi();(!h||h&&r==="fixed")&&(c=i.offsetLeft,a=i.offsetTop);}return {width:s,height:n,x:c,y:a}}function qc(t,r){let e=Qe(t,true,r==="fixed"),o=e.top+t.clientTop,i=e.left+t.clientLeft,s=ee(t)?kr(t):Jt(1),n=t.clientWidth*s.x,c=t.clientHeight*s.y,a=i*s.x,h=o*s.y;return {width:n,height:c,x:a,y:h}}function wa(t,r,e){let o;if(r==="viewport")o=Uc(t,e);else if(r==="document")o=Nc(te(t));else if(Wt(r))o=qc(r,e);else {let i=ka(t);o={x:r.x-i.x,y:r.y-i.y,width:r.width,height:r.height};}return Ge(o)}function Ea(t,r){let e=ge(t);return e===r||!Wt(e)||Xe(e)?false:jt(e).position==="fixed"||Ea(e,r)}function Kc(t,r){let e=r.get(t);if(e)return e;let o=wr(t,[],false).filter(c=>Wt(c)&&Ye(c)!=="body"),i=null,s=jt(t).position==="fixed",n=s?ge(t):t;for(;Wt(n)&&!Xe(n);){let c=jt(n),a=Cr(n);!a&&c.position==="fixed"&&(i=null),(s?!a&&!i:!a&&c.position==="static"&&!!i&&["absolute","fixed"].includes(i.position)||Sr(n)&&!a&&Ea(t,n))?o=o.filter(m=>m!==n):i=c,n=ge(n);}return r.set(t,o),o}function Gc(t){let{element:r,boundary:e,rootBoundary:o,strategy:i}=t,n=[...e==="clippingAncestors"?lo(r)?[]:Kc(r,this._c):[].concat(e),o],c=n[0],a=n.reduce((h,m)=>{let d=wa(r,m,i);return h.top=$t(d.top,h.top),h.right=ne(d.right,h.right),h.bottom=ne(d.bottom,h.bottom),h.left=$t(d.left,h.left),h},wa(r,c,i));return {width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}}function Yc(t){let{width:r,height:e}=Ca(t);return {width:r,height:e}}function Xc(t,r,e){let o=ee(r),i=te(r),s=e==="fixed",n=Qe(t,true,s,r),c={scrollLeft:0,scrollTop:0},a=Jt(0);function h(){a.x=us(i);}if(o||!o&&!s)if((Ye(r)!=="body"||Sr(i))&&(c=co(r)),o){let g=Qe(r,true,s,r);a.x=g.x+r.clientLeft,a.y=g.y+r.clientTop;}else i&&h();s&&!o&&i&&h();let m=i&&!o&&!s?$a(i,c):Jt(0),d=n.left+c.scrollLeft-a.x-m.x,f=n.top+c.scrollTop-a.y-m.y;return {x:d,y:f,width:n.width,height:n.height}}function ds(t){return jt(t).position==="static"}function Sa(t,r){if(!ee(t)||jt(t).position==="fixed")return null;if(r)return r(t);let e=t.offsetParent;return te(t)===e&&(e=e.ownerDocument.body),e}function Aa(t,r){let e=It(t);if(lo(t))return e;if(!ee(t)){let i=ge(t);for(;i&&!Xe(i);){if(Wt(i)&&!ds(i))return i;i=ge(i);}return e}let o=Sa(t,r);for(;o&&ya(o)&&ds(o);)o=Sa(o,r);return o&&Xe(o)&&ds(o)&&!Cr(o)?e:o||xa(t)||e}var Qc=async function(t){let r=this.getOffsetParent||Aa,e=this.getDimensions,o=await e(t.floating);return {reference:Xc(t.reference,await r(t.floating),t.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function Zc(t){return jt(t).direction==="rtl"}var po={convertOffsetParentRelativeRectToViewportRelativeRect:Wc,getDocumentElement:te,getClippingRect:Gc,getOffsetParent:Aa,getElementRects:Qc,getClientRects:jc,getDimensions:Yc,getScale:kr,isElement:Wt,isRTL:Zc};function Oa(t,r){return t.x===r.x&&t.y===r.y&&t.width===r.width&&t.height===r.height}function Jc(t,r){let e=null,o,i=te(t);function s(){var c;clearTimeout(o),(c=e)==null||c.disconnect(),e=null;}function n(c,a){c===void 0&&(c=false),a===void 0&&(a=1),s();let h=t.getBoundingClientRect(),{left:m,top:d,width:f,height:g}=h;if(c||r(),!f||!g)return;let b=ao(d),x=ao(i.clientWidth-(m+f)),T=ao(i.clientHeight-(d+g)),E=ao(m),O={rootMargin:-b+"px "+-x+"px "+-T+"px "+-E+"px",threshold:$t(0,ne(1,a))||1},_=true;function C(M){let H=M[0].intersectionRatio;if(H!==a){if(!_)return n();H?n(false,H):o=setTimeout(()=>{n(false,1e-7);},1e3);}H===1&&!Oa(h,t.getBoundingClientRect())&&n(),_=false;}try{e=new IntersectionObserver(C,{...O,root:i.ownerDocument});}catch{e=new IntersectionObserver(C,O);}e.observe(t);}return n(true),s}function Ta(t,r,e,o){o===void 0&&(o={});let{ancestorScroll:i=true,ancestorResize:s=true,elementResize:n=typeof ResizeObserver=="function",layoutShift:c=typeof IntersectionObserver=="function",animationFrame:a=false}=o,h=hs(t),m=i||s?[...h?wr(h):[],...wr(r)]:[];m.forEach(E=>{i&&E.addEventListener("scroll",e,{passive:true}),s&&E.addEventListener("resize",e);});let d=h&&c?Jc(h,e):null,f=-1,g=null;n&&(g=new ResizeObserver(E=>{let[S]=E;S&&S.target===h&&g&&(g.unobserve(r),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var O;(O=g)==null||O.observe(r);})),e();}),h&&!a&&g.observe(h),g.observe(r));let b,x=a?Qe(t):null;a&&T();function T(){let E=Qe(t);x&&!Oa(x,E)&&e(),x=E,b=requestAnimationFrame(T);}return e(),()=>{var E;m.forEach(S=>{i&&S.removeEventListener("scroll",e),s&&S.removeEventListener("resize",e);}),d?.(),(E=g)==null||E.disconnect(),g=null,a&&cancelAnimationFrame(b);}}var Ia=ma;var Ra=fa,za=ua,ms=ga;var La=ha;var Va=(t,r,e)=>{let o=new Map,i={platform:po,...e},s={...i.platform,_c:o};return da(t,r,{...i,platform:s})};function Pa(t){return tp(t)}function fs(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function tp(t){for(let r=t;r;r=fs(r))if(r instanceof Element&&getComputedStyle(r).display==="none")return null;for(let r=fs(t);r;r=fs(r)){if(!(r instanceof Element))continue;let e=getComputedStyle(r);if(e.display!=="contents"&&(e.position!=="static"||Cr(e)||r.tagName==="BODY"))return r}return null}function ep(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t.contextElement instanceof Element:true)}var X=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.active=false,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=false,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=false,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=false,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=false,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let t=this.anchorEl.getBoundingClientRect(),r=this.popup.getBoundingClientRect(),e=this.placement.includes("top")||this.placement.includes("bottom"),o=0,i=0,s=0,n=0,c=0,a=0,h=0,m=0;e?t.top<r.top?(o=t.left,i=t.bottom,s=t.right,n=t.bottom,c=r.left,a=r.top,h=r.right,m=r.top):(o=r.left,i=r.bottom,s=r.right,n=r.bottom,c=t.left,a=t.top,h=t.right,m=t.top):t.left<r.left?(o=t.right,i=t.top,s=r.left,n=r.top,c=t.right,a=t.bottom,h=r.left,m=r.bottom):(o=r.right,i=r.top,s=t.left,n=t.top,c=r.right,a=r.bottom,h=t.left,m=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${a}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${m}px`);}};}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start();}disconnectedCallback(){super.disconnectedCallback(),this.stop();}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition());}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor);}else this.anchor instanceof Element||ep(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:true})[0]),this.anchorEl&&this.active&&this.start();}start(){!this.anchorEl||!this.active||(this.cleanup=Ta(this.anchorEl,this.popup,()=>{this.reposition();}));}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t();})}reposition(){if(!this.active||!this.anchorEl)return;let t=[Ia({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(ms({apply:({rects:e})=>{let o=this.sync==="width"||this.sync==="both",i=this.sync==="height"||this.sync==="both";this.popup.style.width=o?`${e.reference.width}px`:"",this.popup.style.height=i?`${e.reference.height}px`:"";}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(za({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Ra({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(ms({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:o})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${o}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width");}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(La({element:this.arrowEl,padding:this.arrowPadding}));let r=this.strategy==="absolute"?e=>po.getOffsetParent(e,Pa):po.getOffsetParent;Va(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:ue(St({},po),{getOffsetParent:r})}).then(({x:e,y:o,middlewareData:i,placement:s})=>{let n=this.localize.dir()==="rtl",c={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${e}px`,top:`${o}px`}),this.arrow){let a=i.arrow.x,h=i.arrow.y,m="",d="",f="",g="";if(this.arrowPlacement==="start"){let b=typeof a=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";m=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",d=n?b:"",g=n?"":b;}else if(this.arrowPlacement==="end"){let b=typeof a=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";d=n?"":b,g=n?b:"",f=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";}else this.arrowPlacement==="center"?(g=typeof a=="number"?"calc(50% - var(--arrow-size-diagonal))":"",m=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(g=typeof a=="number"?`${a}px`:"",m=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:m,right:d,bottom:f,left:g,[c]:"calc(var(--arrow-size-diagonal) * -1)"});}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition");}render(){return u`
    ...
    `}};X.styles=[V,na];l([$(".popup")],X.prototype,"popup",2);l([$(".popup__arrow")],X.prototype,"arrowEl",2);l([p()],X.prototype,"anchor",2);l([p({type:Boolean,reflect:true})],X.prototype,"active",2);l([p({reflect:true})],X.prototype,"placement",2);l([p({reflect:true})],X.prototype,"strategy",2);l([p({type:Number})],X.prototype,"distance",2);l([p({type:Number})],X.prototype,"skidding",2);l([p({type:Boolean})],X.prototype,"arrow",2);l([p({attribute:"arrow-placement"})],X.prototype,"arrowPlacement",2);l([p({attribute:"arrow-padding",type:Number})],X.prototype,"arrowPadding",2);l([p({type:Boolean})],X.prototype,"flip",2);l([p({attribute:"flip-fallback-placements",converter:{fromAttribute:t=>t.split(" ").map(r=>r.trim()).filter(r=>r!==""),toAttribute:t=>t.join(" ")}})],X.prototype,"flipFallbackPlacements",2);l([p({attribute:"flip-fallback-strategy"})],X.prototype,"flipFallbackStrategy",2);l([p({type:Object})],X.prototype,"flipBoundary",2);l([p({attribute:"flip-padding",type:Number})],X.prototype,"flipPadding",2);l([p({type:Boolean})],X.prototype,"shift",2);l([p({type:Object})],X.prototype,"shiftBoundary",2);l([p({attribute:"shift-padding",type:Number})],X.prototype,"shiftPadding",2);l([p({attribute:"auto-size"})],X.prototype,"autoSize",2);l([p()],X.prototype,"sync",2);l([p({type:Object})],X.prototype,"autoSizeBoundary",2);l([p({attribute:"auto-size-padding",type:Number})],X.prototype,"autoSizePadding",2);l([p({attribute:"hover-bridge",type:Boolean})],X.prototype,"hoverBridge",2);var Da=new Map,rp=new WeakMap;function op(t){return t??{keyframes:[],options:{duration:0}}}function Ma(t,r){return r.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function Nt(t,r){Da.set(t,op(r));}function Ut(t,r,e){let o=rp.get(t);if(o?.[r])return Ma(o[r],e.dir);let i=Da.get(r);return i?Ma(i,e.dir):{keyframes:[],options:{duration:0}}}function be(t,r){return new Promise(e=>{function o(i){i.target===t&&(t.removeEventListener(r,o),e());}t.addEventListener(r,o);})}function qt(t,r,e){return new Promise(o=>{if(e?.duration===1/0)throw new Error("Promise-based animations must be finite.");let i=t.animate(r,ue(St({},e),{duration:ip()?0:e.duration}));i.addEventListener("cancel",o,{once:true}),i.addEventListener("finish",o,{once:true});})}function ip(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Kt(t){return Promise.all(t.getAnimations().map(r=>new Promise(e=>{r.cancel(),requestAnimationFrame(e);})))}function $r(t,r){return t.map(e=>ue(St({},e),{height:e.height==="auto"?`${r}px`:e.height}))}var j=class extends L{constructor(){super(...arguments),this.formControlController=new mt(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new at(this,"help-text","label"),this.localize=new W(this),this.typeToSelectString="",this.hasFocus=false,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=false,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=false,this.maxOptionsVisible=3,this.disabled=false,this.clearable=false,this.open=false,this.hoist=false,this.filled=false,this.pill=false,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=false,this.getTag=t=>u`
      <sl-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`;var Dt=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.isInitialized=false,this.current=false,this.selected=false,this.hasHover=false,this.value="",this.disabled=false;}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false");}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined("sl-select").then(()=>{let t=this.closest("sl-select");t&&t.handleDefaultSlotChange();}):this.isInitialized=true;}handleMouseEnter(){this.hasHover=true;}handleMouseLeave(){this.hasHover=false;}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false");}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false");}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"));}getTextLabel(){let t=this.childNodes,r="";return [...t].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute("slot")||(r+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(r+=e.textContent);}),r.trim()}render(){return u`
    ...
    `}};Dt.styles=[V,Fa];Dt.dependencies={"sl-icon":q};l([$(".option__label")],Dt.prototype,"defaultSlot",2);l([k()],Dt.prototype,"current",2);l([k()],Dt.prototype,"selected",2);l([k()],Dt.prototype,"hasHover",2);l([p({reflect:true})],Dt.prototype,"value",2);l([p({type:Boolean,reflect:true})],Dt.prototype,"disabled",2);l([A("disabled")],Dt.prototype,"handleDisabledChange",1);l([A("selected")],Dt.prototype,"handleSelectedChange",1);l([A("value")],Dt.prototype,"handleValueChange",1);Dt.define("sl-option");var Ha=y`
    :host {
...
`;exports.AutoFieldSelect=class ho extends R{constructor(){super(...arguments);this.valueKey="value";this.labelKey="label";}getInitialOptions(){return {valueKey:"value",labelKey:"label",select:[],multiple:false,clearable:true,maxOptionsVisible:0,placement:"top"}}_renderItem(e){let o=this.options.renderItem;return typeof o=="string"?u`${Ot(o.replace(/\{(.+?)\}/g,(i,s)=>e[s]))}`:typeof o=="function"?u`${Ot(o(e))}`:e.label||e.value}renderInput(){let e=this.options.select.map(o=>{let i={};return typeof o=="object"?Object.assign(i,o):typeof o=="string"&&o.startsWith("-")?Object.assign(i,{type:"divider"}):Object.assign(i,{label:o}),i});return u`
            ...
            >
                ...
                ${e.map(o=>o.type==="divider"?u`<sl-divider></sl-divider>`:u`<sl-option value="${o[this.valueKey]||o.label}" ?disabled=${!this.options.enable}>
                        <auto-flex class="item" gap="1em" align="center" grow="sl-icon + *,:first-child:not(sl-icon)" style="text-align:left;">
                            ${B(o.icon,()=>u`<sl-icon name="${o.icon}"></sl-icon>`)}
                            ${this._renderItem(o)}
                        </auto-flex>
                    </sl-option>`)}
                ${this.renderAfterActions()}
            </sl-select>
        `}getValue(){return this.options.multiple?this.value.join(" "):this.value}getInputValue(){return this.options.multiple?Array.isArray(this.input.value)?this.input.value:this.input.value.split(" "):this.input.value}};exports.AutoFieldSelect.styles=[R.styles,Ha,y`
            .actions.before {
                position: sticky;
                top: 0;
                width: 100%;
        ...
        `],exports.AutoFieldSelect=v([I("auto-field-select")],exports.AutoFieldSelect);var Ba=y`
  :host {
    --thumb-size: 20px;
    --tooltip-offset: 10px;
...
`;var tt=class extends L{constructor(){super(...arguments),this.formControlController=new mt(this),this.hasSlotController=new at(this,"help-text","label"),this.localize=new W(this),this.hasFocus=false,this.hasTooltip=false,this.title="",this.name="",this.value=0,this.label="",this.helpText="",this.disabled=false,this.min=0,this.max=100,this.step=1,this.tooltip="top",this.tooltipFormatter=t=>t.toString(),this.form="",this.defaultValue=0;}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.syncRange()),this.value<this.min&&(this.value=this.min),this.value>this.max&&(this.value=this.max),this.updateComplete.then(()=>{this.syncRange(),this.resizeObserver.observe(this.input);});}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.resizeObserver)==null||t.unobserve(this.input);}handleChange(){this.emit("sl-change");}handleInput(){this.value=parseFloat(this.input.value),this.emit("sl-input"),this.syncRange();}handleBlur(){this.hasFocus=false,this.hasTooltip=false,this.emit("sl-blur");}handleFocus(){this.hasFocus=true,this.hasTooltip=true,this.emit("sl-focus");}handleThumbDragStart(){this.hasTooltip=true;}handleThumbDragEnd(){this.hasTooltip=false;}syncProgress(t){this.input.style.setProperty("--percent",`${t*100}%`);}syncTooltip(t){if(this.output!==null){let r=this.input.offsetWidth,e=this.output.offsetWidth,o=getComputedStyle(this.input).getPropertyValue("--thumb-size"),i=this.localize.dir()==="rtl",s=r*t;if(i){let n=`${r-s}px + ${t} * ${o}`;this.output.style.translate=`calc((${n} - ${e/2}px - ${o} / 2))`;}else {let n=`${s}px - ${t} * ${o}`;this.output.style.translate=`calc(${n} - ${e/2}px + ${o} / 2)`;}}}handleValueChange(){this.formControlController.updateValidity(),this.input.value=this.value.toString(),this.value=parseFloat(this.input.value),this.syncRange();}handleDisabledChange(){this.formControlController.setValidity(this.disabled);}syncRange(){let t=Math.max(0,(this.value-this.min)/(this.max-this.min));this.syncProgress(t),this.tooltip!=="none"&&this.hasTooltip&&this.updateComplete.then(()=>this.syncTooltip(t));}handleInvalid(t){this.formControlController.setValidity(false),this.formControlController.emitInvalidEvent(t);}focus(t){this.input.focus(t);}blur(){this.input.blur();}stepUp(){this.input.stepUp(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value));}stepDown(){this.input.stepDown(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value));}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity();}render(){let t=this.hasSlotController.test("label"),r=this.hasSlotController.test("help-text"),e=this.label?true:!!t,o=this.helpText?true:!!r;return u`
    ...
    `}};tt.styles=[V,Tt,Ba];l([$(".range__control")],tt.prototype,"input",2);l([$(".range__tooltip")],tt.prototype,"output",2);l([k()],tt.prototype,"hasFocus",2);l([k()],tt.prototype,"hasTooltip",2);l([p()],tt.prototype,"title",2);l([p()],tt.prototype,"name",2);l([p({type:Number})],tt.prototype,"value",2);l([p()],tt.prototype,"label",2);l([p({attribute:"help-text"})],tt.prototype,"helpText",2);l([p({type:Boolean,reflect:true})],tt.prototype,"disabled",2);l([p({type:Number})],tt.prototype,"min",2);l([p({type:Number})],tt.prototype,"max",2);l([p({type:Number})],tt.prototype,"step",2);l([p()],tt.prototype,"tooltip",2);l([p({attribute:false})],tt.prototype,"tooltipFormatter",2);l([p({reflect:true})],tt.prototype,"form",2);l([Ht()],tt.prototype,"defaultValue",2);l([Ce({passive:true})],tt.prototype,"handleThumbDragStart",1);l([A("value",{waitUntilFirstUpdate:true})],tt.prototype,"handleValueChange",1);l([A("disabled",{waitUntilFirstUpdate:true})],tt.prototype,"handleDisabledChange",1);l([A("hasTooltip",{waitUntilFirstUpdate:true})],tt.prototype,"syncRange",1);tt.define("sl-range");exports.AutoFieldRabge=class uo extends R{getInitialOptions(){return {max:100,min:0,step:1,tooltip:"top"}}renderInput(){return u`
            <div>
        ...
        `],exports.AutoFieldRabge=v([I("auto-field-range")],exports.AutoFieldRabge);var Wa=y`
  :host {
...
`;function ct(t,r,e){let o=i=>Object.is(i,-0)?0:i;return t<r?o(r):t>e?o(e):o(t)}var xt=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.hoverValue=0,this.isHovering=false,this.label="",this.value=0,this.max=5,this.precision=1,this.readonly=false,this.disabled=false,this.getSymbol=()=>'<sl-icon name="star-fill" library="system"></sl-icon>';}getValueFromMousePosition(t){return this.getValueFromXCoordinate(t.clientX)}getValueFromTouchPosition(t){return this.getValueFromXCoordinate(t.touches[0].clientX)}getValueFromXCoordinate(t){let r=this.localize.dir()==="rtl",{left:e,right:o,width:i}=this.rating.getBoundingClientRect(),s=r?this.roundToPrecision((o-t)/i*this.max,this.precision):this.roundToPrecision((t-e)/i*this.max,this.precision);return ct(s,0,this.max)}handleClick(t){this.disabled||(this.setValue(this.getValueFromMousePosition(t)),this.emit("sl-change"));}setValue(t){this.disabled||this.readonly||(this.value=t===this.value?0:t,this.isHovering=false);}handleKeyDown(t){let r=this.localize.dir()==="ltr",e=this.localize.dir()==="rtl",o=this.value;if(!(this.disabled||this.readonly)){if(t.key==="ArrowDown"||r&&t.key==="ArrowLeft"||e&&t.key==="ArrowRight"){let i=t.shiftKey?1:this.precision;this.value=Math.max(0,this.value-i),t.preventDefault();}if(t.key==="ArrowUp"||r&&t.key==="ArrowRight"||e&&t.key==="ArrowLeft"){let i=t.shiftKey?1:this.precision;this.value=Math.min(this.max,this.value+i),t.preventDefault();}t.key==="Home"&&(this.value=0,t.preventDefault()),t.key==="End"&&(this.value=this.max,t.preventDefault()),this.value!==o&&this.emit("sl-change");}}handleMouseEnter(t){this.isHovering=true,this.hoverValue=this.getValueFromMousePosition(t);}handleMouseMove(t){this.hoverValue=this.getValueFromMousePosition(t);}handleMouseLeave(){this.isHovering=false;}handleTouchStart(t){this.isHovering=true,this.hoverValue=this.getValueFromTouchPosition(t),t.preventDefault();}handleTouchMove(t){this.hoverValue=this.getValueFromTouchPosition(t);}handleTouchEnd(t){this.isHovering=false,this.setValue(this.hoverValue),this.emit("sl-change"),t.preventDefault();}roundToPrecision(t,r=.5){let e=1/r;return Math.ceil(t*e)/e}handleHoverValueChange(){this.emit("sl-hover",{detail:{phase:"move",value:this.hoverValue}});}handleIsHoveringChange(){this.emit("sl-hover",{detail:{phase:this.isHovering?"start":"end",value:this.hoverValue}});}focus(t){this.rating.focus(t);}blur(){this.rating.blur();}render(){let t=this.localize.dir()==="rtl",r=Array.from(Array(this.max).keys()),e=0;return this.disabled||this.readonly?e=this.value:e=this.isHovering?this.hoverValue:this.value,u`
    ...
    `}};xt.styles=[V,Wa];xt.dependencies={"sl-icon":q};l([$(".rating")],xt.prototype,"rating",2);l([k()],xt.prototype,"hoverValue",2);l([k()],xt.prototype,"isHovering",2);l([p()],xt.prototype,"label",2);l([p({type:Number})],xt.prototype,"value",2);l([p({type:Number})],xt.prototype,"max",2);l([p({type:Number})],xt.prototype,"precision",2);l([p({type:Boolean,reflect:true})],xt.prototype,"readonly",2);l([p({type:Boolean,reflect:true})],xt.prototype,"disabled",2);l([p()],xt.prototype,"getSymbol",2);l([Ce({passive:true})],xt.prototype,"handleTouchMove",1);l([A("hoverValue")],xt.prototype,"handleHoverValueChange",1);l([A("isHovering")],xt.prototype,"handleIsHoveringChange",1);xt.define("sl-rating");exports.AutoFieldRating=class gi extends R{getInitialOptions(){return {max:5,precision:1}}renderInput(){return u`
            <sl-rating
                slot="value"
                name="${this.name}"
                data-path=${this.path}
        ...
        `}renderView(){return u`<sl-rating slot="value" name="${this.name}" data-path=${this.path} value=${this.value} max=${this.options.max} readonly> </sl-rating> `}};exports.AutoFieldRating=v([I("auto-field-rating")],exports.AutoFieldRating);var ja=y`
...
`;var gs=class extends L{render(){return u` <slot></slot> `}};gs.styles=[V,ja];var Na=y`
  :host {
    display: block;
  }
...
`;function*Ka(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*An(Ka(t.shadowRoot.activeElement))));}function Ga(){return [...Ka()].pop()}var qa=new WeakMap;function Ya(t){let r=qa.get(t);return r||(r=window.getComputedStyle(t,null),qa.set(t,r)),r}function sp(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:false,checkVisibilityCSS:true});let r=Ya(t);return r.visibility!=="hidden"&&r.display!=="none"}function np(t){let r=Ya(t),{overflowY:e,overflowX:o}=r;return e==="scroll"||o==="scroll"?true:e!=="auto"||o!=="auto"?false:t.scrollHeight>t.clientHeight&&e==="auto"||t.scrollWidth>t.clientWidth&&o==="auto"}function ap(t){let r=t.tagName.toLowerCase(),e=Number(t.getAttribute("tabindex"));if(t.hasAttribute("tabindex")&&(isNaN(e)||e<=-1)||t.hasAttribute("disabled")||t.closest("[inert]"))return  false;if(r==="input"&&t.getAttribute("type")==="radio"){let s=t.getRootNode(),n=`input[type='radio'][name="${t.getAttribute("name")}"]`,c=s.querySelector(`${n}:checked`);return c?c===t:s.querySelector(n)===t}return sp(t)?(r==="audio"||r==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(r)?true:np(t):false}function Xa(t){var r,e;let o=cp(t),i=(r=o[0])!=null?r:null,s=(e=o[o.length-1])!=null?e:null;return {start:i,end:s}}function lp(t,r){var e;return ((e=t.getRootNode({composed:true}))==null?void 0:e.host)!==r}function cp(t){let r=new WeakMap,e=[];function o(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||r.has(i))return;r.set(i,true),!e.includes(i)&&ap(i)&&e.push(i),i instanceof HTMLSlotElement&&lp(i,t)&&i.assignedElements({flatten:true}).forEach(s=>{o(s);}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&o(i.shadowRoot);}for(let s of i.children)o(s);}return o(t),e.sort((i,s)=>{let n=Number(i.getAttribute("tabindex"))||0;return (Number(s.getAttribute("tabindex"))||0)-n})}var dt=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.open=false,this.placement="bottom-start",this.disabled=false,this.stayOpenOnSelect=false,this.distance=0,this.skidding=0,this.hoist=false,this.sync=void 0,this.handleKeyDown=t=>{this.open&&t.key==="Escape"&&(t.stopPropagation(),this.hide(),this.focusOnTrigger());},this.handleDocumentKeyDown=t=>{var r;if(t.key==="Escape"&&this.open&&!this.closeWatcher){t.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(t.key==="Tab"){if(this.open&&((r=document.activeElement)==null?void 0:r.tagName.toLowerCase())==="sl-menu-item"){t.preventDefault(),this.hide(),this.focusOnTrigger();return}let e=(o,i)=>{if(!o)return null;let s=o.closest(i);if(s)return s;let n=o.getRootNode();return n instanceof ShadowRoot?e(n.host,i):null};setTimeout(()=>{var o;let i=((o=this.containingElement)==null?void 0:o.getRootNode())instanceof ShadowRoot?Ga():document.activeElement;(!this.containingElement||e(i,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide();});}},this.handleDocumentMouseDown=t=>{let r=t.composedPath();this.containingElement&&!r.includes(this.containingElement)&&this.hide();},this.handlePanelSelect=t=>{let r=t.target;!this.stayOpenOnSelect&&r.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger());};}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this);}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=true);}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide();}focusOnTrigger(){let t=this.trigger.assignedElements({flatten:true})[0];typeof t?.focus=="function"&&t.focus();}getMenu(){return this.panel.assignedElements({flatten:true}).find(t=>t.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger());}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}let r=this.getMenu();if(r){let e=r.getAllItems(),o=e[0],i=e[e.length-1];["ArrowDown","ArrowUp","Home","End"].includes(t.key)&&(t.preventDefault(),this.open||(this.show(),await this.updateComplete),e.length>0&&this.updateComplete.then(()=>{(t.key==="ArrowDown"||t.key==="Home")&&(r.setCurrentItem(o),o.focus()),(t.key==="ArrowUp"||t.key==="End")&&(r.setCurrentItem(i),i.focus());}));}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault();}handleTriggerSlotChange(){this.updateAccessibleTrigger();}updateAccessibleTrigger(){let r=this.trigger.assignedElements({flatten:true}).find(o=>Xa(o).start),e;if(r){switch(r.tagName.toLowerCase()){case "sl-button":case "sl-icon-button":e=r.button;break;default:e=r;}e.setAttribute("aria-haspopup","true"),e.setAttribute("aria-expanded",this.open?"true":"false");}}async show(){if(!this.open)return this.open=true,be(this,"sl-after-show")}async hide(){if(this.open)return this.open=false,be(this,"sl-after-hide")}reposition(){this.popup.reposition();}addOpenListeners(){var t;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger();}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown);}removeOpenListeners(){var t;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(t=this.closeWatcher)==null||t.destroy();}async handleOpenChange(){if(this.disabled){this.open=false;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await Kt(this),this.panel.hidden=false,this.popup.active=true;let{keyframes:t,options:r}=Ut(this,"dropdown.show",{dir:this.localize.dir()});await qt(this.popup.popup,t,r),this.emit("sl-after-show");}else {this.emit("sl-hide"),this.removeOpenListeners(),await Kt(this);let{keyframes:t,options:r}=Ut(this,"dropdown.hide",{dir:this.localize.dir()});await qt(this.popup.popup,t,r),this.panel.hidden=true,this.popup.active=false,this.emit("sl-after-hide");}}render(){return u`
      <sl-popup
        part="base"
    ...
    `}};dt.styles=[V,Ua];dt.dependencies={"sl-popup":X};l([$(".dropdown")],dt.prototype,"popup",2);l([$(".dropdown__trigger")],dt.prototype,"trigger",2);l([$(".dropdown__panel")],dt.prototype,"panel",2);l([p({type:Boolean,reflect:true})],dt.prototype,"open",2);l([p({reflect:true})],dt.prototype,"placement",2);l([p({type:Boolean,reflect:true})],dt.prototype,"disabled",2);l([p({attribute:"stay-open-on-select",type:Boolean,reflect:true})],dt.prototype,"stayOpenOnSelect",2);l([p({attribute:false})],dt.prototype,"containingElement",2);l([p({type:Number})],dt.prototype,"distance",2);l([p({type:Number})],dt.prototype,"skidding",2);l([p({type:Boolean})],dt.prototype,"hoist",2);l([p({reflect:true})],dt.prototype,"sync",2);l([A("open",{waitUntilFirstUpdate:true})],dt.prototype,"handleOpenChange",1);Nt("dropdown.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});Nt("dropdown.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});var Qa=y`
  :host {
    --grid-width: 280px;
    --grid-height: 200px;
...
`;var ve=class extends L{constructor(){super(...arguments),this.localize=new W(this);}render(){return u`
    ...
    `}};G.styles=[V,Xo];G.dependencies={"sl-icon":q,"sl-spinner":ve};l([$(".button")],G.prototype,"button",2);l([k()],G.prototype,"hasFocus",2);l([k()],G.prototype,"invalid",2);l([p()],G.prototype,"title",2);l([p({reflect:true})],G.prototype,"variant",2);l([p({reflect:true})],G.prototype,"size",2);l([p({type:Boolean,reflect:true})],G.prototype,"caret",2);l([p({type:Boolean,reflect:true})],G.prototype,"disabled",2);l([p({type:Boolean,reflect:true})],G.prototype,"loading",2);l([p({type:Boolean,reflect:true})],G.prototype,"outline",2);l([p({type:Boolean,reflect:true})],G.prototype,"pill",2);l([p({type:Boolean,reflect:true})],G.prototype,"circle",2);l([p()],G.prototype,"type",2);l([p()],G.prototype,"name",2);l([p()],G.prototype,"value",2);l([p()],G.prototype,"href",2);l([p()],G.prototype,"target",2);l([p()],G.prototype,"rel",2);l([p()],G.prototype,"download",2);l([p()],G.prototype,"form",2);l([p({attribute:"formaction"})],G.prototype,"formAction",2);l([p({attribute:"formenctype"})],G.prototype,"formEnctype",2);l([p({attribute:"formmethod"})],G.prototype,"formMethod",2);l([p({attribute:"formnovalidate",type:Boolean})],G.prototype,"formNoValidate",2);l([p({attribute:"formtarget"})],G.prototype,"formTarget",2);l([A("disabled",{waitUntilFirstUpdate:true})],G.prototype,"handleDisabledChange",1);function ht(t,r){pp(t)&&(t="100%");let e=dp(t);return t=r===360?t:Math.min(r,Math.max(0,parseFloat(t))),e&&(t=parseInt(String(t*r),10)/100),Math.abs(t-r)<1e-6?1:(r===360?t=(t<0?t%r+r:t%r)/parseFloat(String(r)):t=t%r/parseFloat(String(r)),t)}function mo(t){return Math.min(1,Math.max(0,t))}function pp(t){return typeof t=="string"&&t.indexOf(".")!==-1&&parseFloat(t)===1}function dp(t){return typeof t=="string"&&t.indexOf("%")!==-1}function bi(t){return t=parseFloat(t),(isNaN(t)||t<0||t>1)&&(t=1),t}function fo(t){return Number(t)<=1?`${Number(t)*100}%`:t}function Re(t){return t.length===1?"0"+t:String(t)}function Ja(t,r,e){return {r:ht(t,255)*255,g:ht(r,255)*255,b:ht(e,255)*255}}function vs(t,r,e){t=ht(t,255),r=ht(r,255),e=ht(e,255);let o=Math.max(t,r,e),i=Math.min(t,r,e),s=0,n=0,c=(o+i)/2;if(o===i)n=0,s=0;else {let a=o-i;switch(n=c>.5?a/(2-o-i):a/(o+i),o){case t:s=(r-e)/a+(r<e?6:0);break;case r:s=(e-t)/a+2;break;case e:s=(t-r)/a+4;break;}s/=6;}return {h:s,s:n,l:c}}function bs(t,r,e){return e<0&&(e+=1),e>1&&(e-=1),e<1/6?t+(r-t)*(6*e):e<1/2?r:e<2/3?t+(r-t)*(2/3-e)*6:t}function tl(t,r,e){let o,i,s;if(t=ht(t,360),r=ht(r,100),e=ht(e,100),r===0)i=e,s=e,o=e;else {let n=e<.5?e*(1+r):e+r-e*r,c=2*e-n;o=bs(c,n,t+1/3),i=bs(c,n,t),s=bs(c,n,t-1/3);}return {r:o*255,g:i*255,b:s*255}}function ys(t,r,e){t=ht(t,255),r=ht(r,255),e=ht(e,255);let o=Math.max(t,r,e),i=Math.min(t,r,e),s=0,n=o,c=o-i,a=o===0?0:c/o;if(o===i)s=0;else {switch(o){case t:s=(r-e)/c+(r<e?6:0);break;case r:s=(e-t)/c+2;break;case e:s=(t-r)/c+4;break;}s/=6;}return {h:s,s:a,v:n}}function el(t,r,e){t=ht(t,360)*6,r=ht(r,100),e=ht(e,100);let o=Math.floor(t),i=t-o,s=e*(1-r),n=e*(1-i*r),c=e*(1-(1-i)*r),a=o%6,h=[e,n,s,s,c,e][a],m=[c,e,e,n,s,s][a],d=[s,s,c,e,e,n][a];return {r:h*255,g:m*255,b:d*255}}function xs(t,r,e,o){let i=[Re(Math.round(t).toString(16)),Re(Math.round(r).toString(16)),Re(Math.round(e).toString(16))];return o&&i[0].startsWith(i[0].charAt(1))&&i[1].startsWith(i[1].charAt(1))&&i[2].startsWith(i[2].charAt(1))?i[0].charAt(0)+i[1].charAt(0)+i[2].charAt(0):i.join("")}function rl(t,r,e,o,i){let s=[Re(Math.round(t).toString(16)),Re(Math.round(r).toString(16)),Re(Math.round(e).toString(16)),Re(hp(o))];return i&&s[0].startsWith(s[0].charAt(1))&&s[1].startsWith(s[1].charAt(1))&&s[2].startsWith(s[2].charAt(1))&&s[3].startsWith(s[3].charAt(1))?s[0].charAt(0)+s[1].charAt(0)+s[2].charAt(0)+s[3].charAt(0):s.join("")}function ol(t,r,e,o){let i=t/100,s=r/100,n=e/100,c=o/100,a=255*(1-i)*(1-c),h=255*(1-s)*(1-c),m=255*(1-n)*(1-c);return {r:a,g:h,b:m}}function _s(t,r,e){let o=1-t/255,i=1-r/255,s=1-e/255,n=Math.min(o,i,s);return n===1?(o=0,i=0,s=0):(o=(o-n)/(1-n)*100,i=(i-n)/(1-n)*100,s=(s-n)/(1-n)*100),n*=100,{c:Math.round(o),m:Math.round(i),y:Math.round(s),k:Math.round(n)}}function hp(t){return Math.round(parseFloat(t)*255).toString(16)}function ws(t){return Rt(t)/255}function Rt(t){return parseInt(t,16)}function il(t){return {r:t>>16,g:(t&65280)>>8,b:t&255}}var go={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgreen:"#006400",darkgrey:"#a9a9a9",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#ff00ff",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",goldenrod:"#daa520",gold:"#ffd700",gray:"#808080",green:"#008000",greenyellow:"#adff2f",grey:"#808080",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavenderblush:"#fff0f5",lavender:"#e6e6fa",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgreen:"#90ee90",lightgrey:"#d3d3d3",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#778899",lightslategrey:"#778899",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#00ff00",limegreen:"#32cd32",linen:"#faf0e6",magenta:"#ff00ff",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370db",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#db7093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",rebeccapurple:"#663399",red:"#ff0000",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"};function sl(t){let r={r:0,g:0,b:0},e=1,o=null,i=null,s=null,n=false,c=false;return typeof t=="string"&&(t=fp(t)),typeof t=="object"&&(Ft(t.r)&&Ft(t.g)&&Ft(t.b)?(r=Ja(t.r,t.g,t.b),n=true,c=String(t.r).substr(-1)==="%"?"prgb":"rgb"):Ft(t.h)&&Ft(t.s)&&Ft(t.v)?(o=fo(t.s),i=fo(t.v),r=el(t.h,o,i),n=true,c="hsv"):Ft(t.h)&&Ft(t.s)&&Ft(t.l)?(o=fo(t.s),s=fo(t.l),r=tl(t.h,o,s),n=true,c="hsl"):Ft(t.c)&&Ft(t.m)&&Ft(t.y)&&Ft(t.k)&&(r=ol(t.c,t.m,t.y,t.k),n=true,c="cmyk"),Object.prototype.hasOwnProperty.call(t,"a")&&(e=t.a)),e=bi(e),{ok:n,format:t.format||c,r:Math.min(255,Math.max(r.r,0)),g:Math.min(255,Math.max(r.g,0)),b:Math.min(255,Math.max(r.b,0)),a:e}}var up="[-\\+]?\\d+%?",mp="[-\\+]?\\d*\\.\\d+%?",ze="(?:"+mp+")|(?:"+up+")",Ss="[\\s|\\(]+("+ze+")[,|\\s]+("+ze+")[,|\\s]+("+ze+")\\s*\\)?",vi="[\\s|\\(]+("+ze+")[,|\\s]+("+ze+")[,|\\s]+("+ze+")[,|\\s]+("+ze+")\\s*\\)?",Gt={CSS_UNIT:new RegExp(ze),rgb:new RegExp("rgb"+Ss),rgba:new RegExp("rgba"+vi),hsl:new RegExp("hsl"+Ss),hsla:new RegExp("hsla"+vi),hsv:new RegExp("hsv"+Ss),hsva:new RegExp("hsva"+vi),cmyk:new RegExp("cmyk"+vi),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};function fp(t){if(t=t.trim().toLowerCase(),t.length===0)return  false;let r=false;if(go[t])t=go[t],r=true;else if(t==="transparent")return {r:0,g:0,b:0,a:0,format:"name"};let e=Gt.rgb.exec(t);return e?{r:e[1],g:e[2],b:e[3]}:(e=Gt.rgba.exec(t),e?{r:e[1],g:e[2],b:e[3],a:e[4]}:(e=Gt.hsl.exec(t),e?{h:e[1],s:e[2],l:e[3]}:(e=Gt.hsla.exec(t),e?{h:e[1],s:e[2],l:e[3],a:e[4]}:(e=Gt.hsv.exec(t),e?{h:e[1],s:e[2],v:e[3]}:(e=Gt.hsva.exec(t),e?{h:e[1],s:e[2],v:e[3],a:e[4]}:(e=Gt.cmyk.exec(t),e?{c:e[1],m:e[2],y:e[3],k:e[4]}:(e=Gt.hex8.exec(t),e?{r:Rt(e[1]),g:Rt(e[2]),b:Rt(e[3]),a:ws(e[4]),format:r?"name":"hex8"}:(e=Gt.hex6.exec(t),e?{r:Rt(e[1]),g:Rt(e[2]),b:Rt(e[3]),format:r?"name":"hex"}:(e=Gt.hex4.exec(t),e?{r:Rt(e[1]+e[1]),g:Rt(e[2]+e[2]),b:Rt(e[3]+e[3]),a:ws(e[4]+e[4]),format:r?"name":"hex8"}:(e=Gt.hex3.exec(t),e?{r:Rt(e[1]+e[1]),g:Rt(e[2]+e[2]),b:Rt(e[3]+e[3]),format:r?"name":"hex"}:false))))))))))}function Ft(t){return typeof t=="number"?!Number.isNaN(t):Gt.CSS_UNIT.test(t)}var bo=class t{constructor(r="",e={}){if(r instanceof t)return r;typeof r=="number"&&(r=il(r)),this.originalInput=r;let o=sl(r);this.originalInput=r,this.r=o.r,this.g=o.g,this.b=o.b,this.a=o.a,this.roundA=Math.round(100*this.a)/100,this.format=e.format??o.format,this.gradientType=e.gradientType,this.r<1&&(this.r=Math.round(this.r)),this.g<1&&(this.g=Math.round(this.g)),this.b<1&&(this.b=Math.round(this.b)),this.isValid=o.ok;}isDark(){return this.getBrightness()<128}isLight(){return !this.isDark()}getBrightness(){let r=this.toRgb();return (r.r*299+r.g*587+r.b*114)/1e3}getLuminance(){let r=this.toRgb(),e,o,i,s=r.r/255,n=r.g/255,c=r.b/255;return s<=.03928?e=s/12.92:e=Math.pow((s+.055)/1.055,2.4),n<=.03928?o=n/12.92:o=Math.pow((n+.055)/1.055,2.4),c<=.03928?i=c/12.92:i=Math.pow((c+.055)/1.055,2.4),.2126*e+.7152*o+.0722*i}getAlpha(){return this.a}setAlpha(r){return this.a=bi(r),this.roundA=Math.round(100*this.a)/100,this}isMonochrome(){let{s:r}=this.toHsl();return r===0}toHsv(){let r=ys(this.r,this.g,this.b);return {h:r.h*360,s:r.s,v:r.v,a:this.a}}toHsvString(){let r=ys(this.r,this.g,this.b),e=Math.round(r.h*360),o=Math.round(r.s*100),i=Math.round(r.v*100);return this.a===1?`hsv(${e}, ${o}%, ${i}%)`:`hsva(${e}, ${o}%, ${i}%, ${this.roundA})`}toHsl(){let r=vs(this.r,this.g,this.b);return {h:r.h*360,s:r.s,l:r.l,a:this.a}}toHslString(){let r=vs(this.r,this.g,this.b),e=Math.round(r.h*360),o=Math.round(r.s*100),i=Math.round(r.l*100);return this.a===1?`hsl(${e}, ${o}%, ${i}%)`:`hsla(${e}, ${o}%, ${i}%, ${this.roundA})`}toHex(r=false){return xs(this.r,this.g,this.b,r)}toHexString(r=false){return "#"+this.toHex(r)}toHex8(r=false){return rl(this.r,this.g,this.b,this.a,r)}toHex8String(r=false){return "#"+this.toHex8(r)}toHexShortString(r=false){return this.a===1?this.toHexString(r):this.toHex8String(r)}toRgb(){return {r:Math.round(this.r),g:Math.round(this.g),b:Math.round(this.b),a:this.a}}toRgbString(){let r=Math.round(this.r),e=Math.round(this.g),o=Math.round(this.b);return this.a===1?`rgb(${r}, ${e}, ${o})`:`rgba(${r}, ${e}, ${o}, ${this.roundA})`}toPercentageRgb(){let r=e=>`${Math.round(ht(e,255)*100)}%`;return {r:r(this.r),g:r(this.g),b:r(this.b),a:this.a}}toPercentageRgbString(){let r=e=>Math.round(ht(e,255)*100);return this.a===1?`rgb(${r(this.r)}%, ${r(this.g)}%, ${r(this.b)}%)`:`rgba(${r(this.r)}%, ${r(this.g)}%, ${r(this.b)}%, ${this.roundA})`}toCmyk(){return {..._s(this.r,this.g,this.b)}}toCmykString(){let{c:r,m:e,y:o,k:i}=_s(this.r,this.g,this.b);return `cmyk(${r}, ${e}, ${o}, ${i})`}toName(){if(this.a===0)return "transparent";if(this.a<1)return  false;let r="#"+xs(this.r,this.g,this.b,false);for(let[e,o]of Object.entries(go))if(r===o)return e;return  false}toString(r){let e=!!r;r=r??this.format;let o=false,i=this.a<1&&this.a>=0;return !e&&i&&(r.startsWith("hex")||r==="name")?r==="name"&&this.a===0?this.toName():this.toRgbString():(r==="rgb"&&(o=this.toRgbString()),r==="prgb"&&(o=this.toPercentageRgbString()),(r==="hex"||r==="hex6")&&(o=this.toHexString()),r==="hex3"&&(o=this.toHexString(true)),r==="hex4"&&(o=this.toHex8String(true)),r==="hex8"&&(o=this.toHex8String()),r==="name"&&(o=this.toName()),r==="hsl"&&(o=this.toHslString()),r==="hsv"&&(o=this.toHsvString()),r==="cmyk"&&(o=this.toCmykString()),o||this.toHexString())}toNumber(){return (Math.round(this.r)<<16)+(Math.round(this.g)<<8)+Math.round(this.b)}clone(){return new t(this.toString())}lighten(r=10){let e=this.toHsl();return e.l+=r/100,e.l=mo(e.l),new t(e)}brighten(r=10){let e=this.toRgb();return e.r=Math.max(0,Math.min(255,e.r-Math.round(255*-(r/100)))),e.g=Math.max(0,Math.min(255,e.g-Math.round(255*-(r/100)))),e.b=Math.max(0,Math.min(255,e.b-Math.round(255*-(r/100)))),new t(e)}darken(r=10){let e=this.toHsl();return e.l-=r/100,e.l=mo(e.l),new t(e)}tint(r=10){return this.mix("white",r)}shade(r=10){return this.mix("black",r)}desaturate(r=10){let e=this.toHsl();return e.s-=r/100,e.s=mo(e.s),new t(e)}saturate(r=10){let e=this.toHsl();return e.s+=r/100,e.s=mo(e.s),new t(e)}greyscale(){return this.desaturate(100)}spin(r){let e=this.toHsl(),o=(e.h+r)%360;return e.h=o<0?360+o:o,new t(e)}mix(r,e=50){let o=this.toRgb(),i=new t(r).toRgb(),s=e/100,n={r:(i.r-o.r)*s+o.r,g:(i.g-o.g)*s+o.g,b:(i.b-o.b)*s+o.b,a:(i.a-o.a)*s+o.a};return new t(n)}analogous(r=6,e=30){let o=this.toHsl(),i=360/e,s=[this];for(o.h=(o.h-(i*r>>1)+720)%360;--r;)o.h=(o.h+i)%360,s.push(new t(o));return s}complement(){let r=this.toHsl();return r.h=(r.h+180)%360,new t(r)}monochromatic(r=6){let e=this.toHsv(),{h:o}=e,{s:i}=e,{v:s}=e,n=[],c=1/r;for(;r--;)n.push(new t({h:o,s:i,v:s})),s=(s+c)%1;return n}splitcomplement(){let r=this.toHsl(),{h:e}=r;return [this,new t({h:(e+72)%360,s:r.s,l:r.l}),new t({h:(e+216)%360,s:r.s,l:r.l})]}onBackground(r){let e=this.toRgb(),o=new t(r).toRgb(),i=e.a+o.a*(1-e.a);return new t({r:(e.r*e.a+o.r*o.a*(1-e.a))/i,g:(e.g*e.a+o.g*o.a*(1-e.a))/i,b:(e.b*e.a+o.b*o.a*(1-e.a))/i,a:i})}triad(){return this.polyad(3)}tetrad(){return this.polyad(4)}polyad(r){let e=this.toHsl(),{h:o}=e,i=[this],s=360/r;for(let n=1;n<r;n++)i.push(new t({h:(o+n*s)%360,s:e.s,l:e.l}));return i}equals(r){let e=new t(r);return this.format==="cmyk"||e.format==="cmyk"?this.toCmykString()===e.toCmykString():this.toRgbString()===e.toRgbString()}};var nl="EyeDropper"in window,N=class extends L{constructor(){super(),this.formControlController=new mt(this),this.isSafeValue=false,this.localize=new W(this),this.hasFocus=false,this.isDraggingGridHandle=false,this.isEmpty=false,this.inputValue="",this.hue=0,this.saturation=100,this.brightness=100,this.alpha=100,this.value="",this.defaultValue="",this.label="",this.format="hex",this.inline=false,this.size="medium",this.noFormatToggle=false,this.name="",this.disabled=false,this.hoist=false,this.opacity=false,this.uppercase=false,this.swatches="",this.form="",this.required=false,this.handleFocusIn=()=>{this.hasFocus=true,this.emit("sl-focus");},this.handleFocusOut=()=>{this.hasFocus=false,this.emit("sl-blur");},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut);}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.input.updateComplete.then(()=>{this.formControlController.updateValidity();});}handleCopy(){this.input.select(),document.execCommand("copy"),this.previewButton.focus(),this.previewButton.classList.add("color-picker__preview-color--copied"),this.previewButton.addEventListener("animationend",()=>{this.previewButton.classList.remove("color-picker__preview-color--copied");});}handleFormatToggle(){let t=["hex","rgb","hsl","hsv"],r=(t.indexOf(this.format)+1)%t.length;this.format=t[r],this.setColor(this.value),this.emit("sl-change"),this.emit("sl-input");}handleAlphaDrag(t){let r=this.shadowRoot.querySelector(".color-picker__slider.color-picker__alpha"),e=r.querySelector(".color-picker__slider-handle"),{width:o}=r.getBoundingClientRect(),i=this.value,s=this.value;e.focus(),t.preventDefault(),Er(r,{onMove:n=>{this.alpha=ct(n/o*100,0,100),this.syncValues(),this.value!==s&&(s=this.value,this.emit("sl-input"));},onStop:()=>{this.value!==i&&(i=this.value,this.emit("sl-change"));},initialEvent:t});}handleHueDrag(t){let r=this.shadowRoot.querySelector(".color-picker__slider.color-picker__hue"),e=r.querySelector(".color-picker__slider-handle"),{width:o}=r.getBoundingClientRect(),i=this.value,s=this.value;e.focus(),t.preventDefault(),Er(r,{onMove:n=>{this.hue=ct(n/o*360,0,360),this.syncValues(),this.value!==s&&(s=this.value,this.emit("sl-input"));},onStop:()=>{this.value!==i&&(i=this.value,this.emit("sl-change"));},initialEvent:t});}handleGridDrag(t){let r=this.shadowRoot.querySelector(".color-picker__grid"),e=r.querySelector(".color-picker__grid-handle"),{width:o,height:i}=r.getBoundingClientRect(),s=this.value,n=this.value;e.focus(),t.preventDefault(),this.isDraggingGridHandle=true,Er(r,{onMove:(c,a)=>{this.saturation=ct(c/o*100,0,100),this.brightness=ct(100-a/i*100,0,100),this.syncValues(),this.value!==n&&(n=this.value,this.emit("sl-input"));},onStop:()=>{this.isDraggingGridHandle=false,this.value!==s&&(s=this.value,this.emit("sl-change"));},initialEvent:t});}handleAlphaKeyDown(t){let r=t.shiftKey?10:1,e=this.value;t.key==="ArrowLeft"&&(t.preventDefault(),this.alpha=ct(this.alpha-r,0,100),this.syncValues()),t.key==="ArrowRight"&&(t.preventDefault(),this.alpha=ct(this.alpha+r,0,100),this.syncValues()),t.key==="Home"&&(t.preventDefault(),this.alpha=0,this.syncValues()),t.key==="End"&&(t.preventDefault(),this.alpha=100,this.syncValues()),this.value!==e&&(this.emit("sl-change"),this.emit("sl-input"));}handleHueKeyDown(t){let r=t.shiftKey?10:1,e=this.value;t.key==="ArrowLeft"&&(t.preventDefault(),this.hue=ct(this.hue-r,0,360),this.syncValues()),t.key==="ArrowRight"&&(t.preventDefault(),this.hue=ct(this.hue+r,0,360),this.syncValues()),t.key==="Home"&&(t.preventDefault(),this.hue=0,this.syncValues()),t.key==="End"&&(t.preventDefault(),this.hue=360,this.syncValues()),this.value!==e&&(this.emit("sl-change"),this.emit("sl-input"));}handleGridKeyDown(t){let r=t.shiftKey?10:1,e=this.value;t.key==="ArrowLeft"&&(t.preventDefault(),this.saturation=ct(this.saturation-r,0,100),this.syncValues()),t.key==="ArrowRight"&&(t.preventDefault(),this.saturation=ct(this.saturation+r,0,100),this.syncValues()),t.key==="ArrowUp"&&(t.preventDefault(),this.brightness=ct(this.brightness+r,0,100),this.syncValues()),t.key==="ArrowDown"&&(t.preventDefault(),this.brightness=ct(this.brightness-r,0,100),this.syncValues()),this.value!==e&&(this.emit("sl-change"),this.emit("sl-input"));}handleInputChange(t){let r=t.target,e=this.value;t.stopPropagation(),this.input.value?(this.setColor(r.value),r.value=this.value):this.value="",this.value!==e&&(this.emit("sl-change"),this.emit("sl-input"));}handleInputInput(t){this.formControlController.updateValidity(),t.stopPropagation();}handleInputKeyDown(t){if(t.key==="Enter"){let r=this.value;this.input.value?(this.setColor(this.input.value),this.input.value=this.value,this.value!==r&&(this.emit("sl-change"),this.emit("sl-input")),setTimeout(()=>this.input.select())):this.hue=0;}}handleInputInvalid(t){this.formControlController.setValidity(false),this.formControlController.emitInvalidEvent(t);}handleTouchMove(t){t.preventDefault();}parseColor(t){let r=new bo(t);if(!r.isValid)return null;let e=r.toHsl(),o={h:e.h,s:e.s*100,l:e.l*100,a:e.a},i=r.toRgb(),s=r.toHexString(),n=r.toHex8String(),c=r.toHsv(),a={h:c.h,s:c.s*100,v:c.v*100,a:c.a};return {hsl:{h:o.h,s:o.s,l:o.l,string:this.setLetterCase(`hsl(${Math.round(o.h)}, ${Math.round(o.s)}%, ${Math.round(o.l)}%)`)},hsla:{h:o.h,s:o.s,l:o.l,a:o.a,string:this.setLetterCase(`hsla(${Math.round(o.h)}, ${Math.round(o.s)}%, ${Math.round(o.l)}%, ${o.a.toFixed(2).toString()})`)},hsv:{h:a.h,s:a.s,v:a.v,string:this.setLetterCase(`hsv(${Math.round(a.h)}, ${Math.round(a.s)}%, ${Math.round(a.v)}%)`)},hsva:{h:a.h,s:a.s,v:a.v,a:a.a,string:this.setLetterCase(`hsva(${Math.round(a.h)}, ${Math.round(a.s)}%, ${Math.round(a.v)}%, ${a.a.toFixed(2).toString()})`)},rgb:{r:i.r,g:i.g,b:i.b,string:this.setLetterCase(`rgb(${Math.round(i.r)}, ${Math.round(i.g)}, ${Math.round(i.b)})`)},rgba:{r:i.r,g:i.g,b:i.b,a:i.a,string:this.setLetterCase(`rgba(${Math.round(i.r)}, ${Math.round(i.g)}, ${Math.round(i.b)}, ${i.a.toFixed(2).toString()})`)},hex:this.setLetterCase(s),hexa:this.setLetterCase(n)}}setColor(t){let r=this.parseColor(t);return r===null?false:(this.hue=r.hsva.h,this.saturation=r.hsva.s,this.brightness=r.hsva.v,this.alpha=this.opacity?r.hsva.a*100:100,this.syncValues(),true)}setLetterCase(t){return typeof t!="string"?"":this.uppercase?t.toUpperCase():t.toLowerCase()}async syncValues(){let t=this.parseColor(`hsva(${this.hue}, ${this.saturation}%, ${this.brightness}%, ${this.alpha/100})`);t!==null&&(this.format==="hsl"?this.inputValue=this.opacity?t.hsla.string:t.hsl.string:this.format==="rgb"?this.inputValue=this.opacity?t.rgba.string:t.rgb.string:this.format==="hsv"?this.inputValue=this.opacity?t.hsva.string:t.hsv.string:this.inputValue=this.opacity?t.hexa:t.hex,this.isSafeValue=true,this.value=this.inputValue,await this.updateComplete,this.isSafeValue=false);}handleAfterHide(){this.previewButton.classList.remove("color-picker__preview-color--copied");}handleEyeDropper(){if(!nl)return;new EyeDropper().open().then(r=>{let e=this.value;this.setColor(r.sRGBHex),this.value!==e&&(this.emit("sl-change"),this.emit("sl-input"));}).catch(()=>{});}selectSwatch(t){let r=this.value;this.disabled||(this.setColor(t),this.value!==r&&(this.emit("sl-change"),this.emit("sl-input")));}getHexString(t,r,e,o=100){let i=new bo(`hsva(${t}, ${r}%, ${e}%, ${o/100})`);return i.isValid?i.toHex8String():""}stopNestedEventPropagation(t){t.stopImmediatePropagation();}handleFormatChange(){this.syncValues();}handleOpacityChange(){this.alpha=100;}handleValueChange(t,r){if(this.isEmpty=!r,r||(this.hue=0,this.saturation=0,this.brightness=100,this.alpha=100),!this.isSafeValue){let e=this.parseColor(r);e!==null?(this.inputValue=this.value,this.hue=e.hsva.h,this.saturation=e.hsva.s,this.brightness=e.hsva.v,this.alpha=e.hsva.a*100,this.syncValues()):this.inputValue=t??"";}}focus(t){this.inline?this.base.focus(t):this.trigger.focus(t);}blur(){var t;let r=this.inline?this.base:this.trigger;this.hasFocus&&(r.focus({preventScroll:true}),r.blur()),(t=this.dropdown)!=null&&t.open&&this.dropdown.hide();}getFormattedValue(t="hex"){let r=this.parseColor(`hsva(${this.hue}, ${this.saturation}%, ${this.brightness}%, ${this.alpha/100})`);if(r===null)return "";switch(t){case "hex":return r.hex;case "hexa":return r.hexa;case "rgb":return r.rgb.string;case "rgba":return r.rgba.string;case "hsl":return r.hsl.string;case "hsla":return r.hsla.string;case "hsv":return r.hsv.string;case "hsva":return r.hsva.string;default:return ""}}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return !this.inline&&!this.validity.valid?(this.dropdown.show(),this.addEventListener("sl-after-show",()=>this.input.reportValidity(),{once:true}),this.disabled||this.formControlController.emitInvalidEvent(),false):this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity();}render(){let t=this.saturation,r=100-this.brightness,e=Array.isArray(this.swatches)?this.swatches:this.swatches.split(";").filter(i=>i.trim()!==""),o=u`
      <div
        part="base"
    ...
    `}};N.styles=[V,Qa];N.dependencies={"sl-button-group":Oe,"sl-button":G,"sl-dropdown":dt,"sl-icon":q,"sl-input":F,"sl-visually-hidden":gs};l([$('[part~="base"]')],N.prototype,"base",2);l([$('[part~="input"]')],N.prototype,"input",2);l([$(".color-dropdown")],N.prototype,"dropdown",2);l([$('[part~="preview"]')],N.prototype,"previewButton",2);l([$('[part~="trigger"]')],N.prototype,"trigger",2);l([k()],N.prototype,"hasFocus",2);l([k()],N.prototype,"isDraggingGridHandle",2);l([k()],N.prototype,"isEmpty",2);l([k()],N.prototype,"inputValue",2);l([k()],N.prototype,"hue",2);l([k()],N.prototype,"saturation",2);l([k()],N.prototype,"brightness",2);l([k()],N.prototype,"alpha",2);l([p()],N.prototype,"value",2);l([Ht()],N.prototype,"defaultValue",2);l([p()],N.prototype,"label",2);l([p()],N.prototype,"format",2);l([p({type:Boolean,reflect:true})],N.prototype,"inline",2);l([p({reflect:true})],N.prototype,"size",2);l([p({attribute:"no-format-toggle",type:Boolean})],N.prototype,"noFormatToggle",2);l([p()],N.prototype,"name",2);l([p({type:Boolean,reflect:true})],N.prototype,"disabled",2);l([p({type:Boolean})],N.prototype,"hoist",2);l([p({type:Boolean})],N.prototype,"opacity",2);l([p({type:Boolean})],N.prototype,"uppercase",2);l([p()],N.prototype,"swatches",2);l([p({reflect:true})],N.prototype,"form",2);l([p({type:Boolean,reflect:true})],N.prototype,"required",2);l([Ce({passive:false})],N.prototype,"handleTouchMove",1);l([A("format",{waitUntilFirstUpdate:true})],N.prototype,"handleFormatChange",1);l([A("opacity",{waitUntilFirstUpdate:true})],N.prototype,"handleOpacityChange",1);l([A("value")],N.prototype,"handleValueChange",1);N.define("sl-color-picker");var gp=["#ffffff","#f1f1f1","#bfbfbf","#262626","#f5222d","#fa541c","#fa8c16","#faad14","#fadb14","#a0d911","#52c41a","#13c2c2","#1890ff","#2f54eb","#722ed1","#eb2f96"];exports.AutoFieldColorPicker=class vo extends R{getInitialOptions(){return {format:"hex",opacity:false,inline:false,presets:gp}}renderInput(){return u`
            <sl-color-picker
                name=${this.name}
                data-path=${this.path}
                class="auto-input"
        ...
        `],exports.AutoFieldParts=v([I("auto-field-parts")],exports.AutoFieldParts);var al=y`
  :host {
    display: block;
    position: relative;
    background: var(--sl-panel-background-color);
...
`;var yi=class extends L{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu");}handleClick(t){let r=["menuitem","menuitemcheckbox"],e=t.composedPath(),o=e.find(c=>{var a;return r.includes(((a=c?.getAttribute)==null?void 0:a.call(c,"role"))||"")});if(!o||e.find(c=>{var a;return ((a=c?.getAttribute)==null?void 0:a.call(c,"role"))==="menu"})!==this)return;let n=o;n.type==="checkbox"&&(n.checked=!n.checked),this.emit("sl-select",{detail:{item:n}});}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){let r=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),r?.click();}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){let r=this.getAllItems(),e=this.getCurrentItem(),o=e?r.indexOf(e):0;r.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?o++:t.key==="ArrowUp"?o--:t.key==="Home"?o=0:t.key==="End"&&(o=r.length-1),o<0&&(o=r.length-1),o>r.length-1&&(o=0),this.setCurrentItem(r[o]),r[o].focus());}}handleMouseDown(t){let r=t.target;this.isMenuItem(r)&&this.setCurrentItem(r);}handleSlotChange(){let t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0]);}isMenuItem(t){var r;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((r=t.getAttribute("role"))!=null?r:"")}getAllItems(){return [...this.defaultSlot.assignedElements({flatten:true})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(e=>{e.setAttribute("tabindex",e===t?"0":"-1");});}render(){return u`
      ...
      ></slot>
    `}};yi.styles=[V,al];l([$("slot")],yi.prototype,"defaultSlot",2);yi.define("sl-menu");var ll=y`
  :host {
    --submenu-offset: -2px;
...
`;var _o=(t,r)=>{let e=t._$AN;if(e===void 0)return  false;for(let o of e)o._$AO?.(r,false),_o(o,r);return  true},xi=t=>{let r,e;do{if((r=t._$AM)===void 0)break;e=r._$AN,e.delete(t),t=r;}while(e?.size===0)},cl=t=>{for(let r;r=t._$AM;t=r){let e=r._$AN;if(e===void 0)r._$AN=e=new Set;else if(e.has(t))break;e.add(t),yp(r);}};function bp(t){this._$AN!==void 0?(xi(this),this._$AM=t,cl(this)):this._$AM=t;}function vp(t,r=false,e=0){let o=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(r)if(Array.isArray(o))for(let s=e;s<o.length;s++)_o(o[s],false),xi(o[s]);else o!=null&&(_o(o,false),xi(o));else _o(this,t);}var yp=t=>{t.type==vt.CHILD&&(t._$AP??=vp,t._$AQ??=bp);},_i=class extends At{constructor(){super(...arguments),this._$AN=void 0;}_$AT(r,e,o){super._$AT(r,e,o),cl(this),this.isConnected=r._$AU;}_$AO(r,e=true){r!==this.isConnected&&(this.isConnected=r,r?this.reconnected?.():this.disconnected?.()),e&&(_o(this,r),xi(this));}setValue(r){if(No(this._$Ct))this._$Ct._$AI(r,this);else {let e=[...this._$Ct._$AH];e[this._$Ci]=r,this._$Ct._$AI(e,this,0);}}disconnected(){}reconnected(){}};var pl=()=>new ks,ks=class{},Cs=new WeakMap,dl=Mt(class extends _i{render(t){return Y}update(t,[r]){let e=r!==this.G;return e&&this.G!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=r,this.ht=t.options?.host,this.rt(this.ct=t.element)),Y}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){let r=this.ht??globalThis,e=Cs.get(r);e===void 0&&(e=new WeakMap,Cs.set(r,e)),e.get(this.G)!==void 0&&this.G.call(this.ht,void 0),e.set(this.G,t),t!==void 0&&this.G.call(this.ht,t);}else this.G.value=t;}get lt(){return typeof this.G=="function"?Cs.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0);}reconnected(){this.rt(this.ct);}});var hl=class{constructor(t,r){this.popupRef=pl(),this.enableSubmenuTimer=-1,this.isConnected=false,this.isPopupConnected=false,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=e=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${e.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${e.clientY}px`);},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu();},this.handleKeyDown=e=>{switch(e.key){case "Escape":case "Tab":this.disableSubmenu();break;case "ArrowLeft":e.target!==this.host&&(e.preventDefault(),e.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case "ArrowRight":case "Enter":case " ":this.handleSubmenuEntry(e);break;}},this.handleClick=e=>{var o;e.target===this.host?(e.preventDefault(),e.stopPropagation()):e.target instanceof Element&&(e.target.tagName==="sl-menu-item"||(o=e.target.role)!=null&&o.startsWith("menuitem"))&&this.disableSubmenu();},this.handleFocusOut=e=>{e.relatedTarget&&e.relatedTarget instanceof Element&&this.host.contains(e.relatedTarget)||this.disableSubmenu();},this.handlePopupMouseover=e=>{e.stopPropagation();},this.handlePopupReposition=()=>{let e=this.host.renderRoot.querySelector("slot[name='submenu']"),o=e?.assignedElements({flatten:true}).filter(h=>h.localName==="sl-menu")[0],i=getComputedStyle(this.host).direction==="rtl";if(!o)return;let{left:s,top:n,width:c,height:a}=o.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${i?s+c:s}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${n}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${i?s+c:s}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${n+a}px`);},(this.host=t).addController(this),this.hasSlotController=r;}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners();}hostDisconnected(){this.removeListeners();}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners();}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=true),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=true);}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=false),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=false);}handleSubmenuEntry(t){let r=this.host.renderRoot.querySelector("slot[name='submenu']");if(!r){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let e=null;for(let o of r.assignedElements())if(e=o.querySelectorAll("sl-menu-item, [role^='menuitem']"),e.length!==0)break;if(!(!e||e.length===0)){e[0].setAttribute("tabindex","0");for(let o=1;o!==e.length;++o)e[o].setAttribute("tabindex","-1");this.popupRef.value&&(t.preventDefault(),t.stopPropagation(),this.popupRef.value.active?e[0]instanceof HTMLElement&&e[0].focus():(this.enableSubmenu(false),this.host.updateComplete.then(()=>{e[0]instanceof HTMLElement&&e[0].focus();}),this.host.requestUpdate()));}}setSubmenuState(t){this.popupRef.value&&this.popupRef.value.active!==t&&(this.popupRef.value.active=t,this.host.requestUpdate());}enableSubmenu(t=true){t?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(true);},this.submenuOpenDelay)):this.setSubmenuState(true);}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(false);}updateSkidding(){var t;if(!((t=this.host.parentElement)!=null&&t.computedStyleMap))return;let r=this.host.parentElement.computedStyleMap(),o=["padding-top","border-top-width","margin-top"].reduce((i,s)=>{var n;let c=(n=r.get(s))!=null?n:new CSSUnitValue(0,"px"),h=(c instanceof CSSUnitValue?c:new CSSUnitValue(0,"px")).to("px");return i-h.value},0);this.skidding=o;}isExpanded(){return this.popupRef.value?this.popupRef.value.active:false}renderSubmenu(){let t=getComputedStyle(this.host).direction==="rtl";return this.isConnected?u`
    ...
    `}};zt.styles=[V,ll];zt.dependencies={"sl-icon":q,"sl-popup":X,"sl-spinner":ve};l([$("slot:not([name])")],zt.prototype,"defaultSlot",2);l([$(".menu-item")],zt.prototype,"menuItem",2);l([p()],zt.prototype,"type",2);l([p({type:Boolean,reflect:true})],zt.prototype,"checked",2);l([p()],zt.prototype,"value",2);l([p({type:Boolean,reflect:true})],zt.prototype,"loading",2);l([p({type:Boolean,reflect:true})],zt.prototype,"disabled",2);l([A("checked")],zt.prototype,"handleCheckedChange",1);l([A("disabled")],zt.prototype,"handleDisabledChange",1);l([A("type")],zt.prototype,"handleTypeChange",1);zt.define("sl-menu-item");var ul=y`
  :host {
    --divider-width: 4px;
...
`;var $s=()=>null,Lt=class extends L{constructor(){super(...arguments),this.isCollapsed=false,this.localize=new W(this),this.positionBeforeCollapsing=0,this.position=50,this.vertical=false,this.disabled=false,this.snapValue="",this.snapFunction=$s,this.snapThreshold=12;}toSnapFunction(t){let r=t.split(" ");return ({pos:e,size:o,snapThreshold:i,isRtl:s,vertical:n})=>{let c=e,a=Number.POSITIVE_INFINITY;return r.forEach(h=>{let m;if(h.startsWith("repeat(")){let f=t.substring(7,t.length-1),g=f.endsWith("%"),b=Number.parseFloat(f),x=g?o*(b/100):b;m=Math.round((s&&!n?o-e:e)/x)*x;}else h.endsWith("%")?m=o*(Number.parseFloat(h)/100):m=Number.parseFloat(h);s&&!n&&(m=o-m);let d=Math.abs(e-m);d<=i&&d<a&&(c=m,a=d);}),c}}set snap(t){this.snapValue=t??"",t?this.snapFunction=typeof t=="string"?this.toSnapFunction(t):t:this.snapFunction=$s;}get snap(){return this.snapValue}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>this.handleResize(t)),this.updateComplete.then(()=>this.resizeObserver.observe(this)),this.detectSize(),this.cachedPositionInPixels=this.percentageToPixels(this.position);}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.resizeObserver)==null||t.unobserve(this);}detectSize(){let{width:t,height:r}=this.getBoundingClientRect();this.size=this.vertical?r:t;}percentageToPixels(t){return this.size*(t/100)}pixelsToPercentage(t){return t/this.size*100}handleDrag(t){let r=this.localize.dir()==="rtl";this.disabled||(t.cancelable&&t.preventDefault(),Er(this,{onMove:(e,o)=>{var i;let s=this.vertical?o:e;this.primary==="end"&&(s=this.size-s),s=(i=this.snapFunction({pos:s,size:this.size,snapThreshold:this.snapThreshold,isRtl:r,vertical:this.vertical}))!=null?i:s,this.position=ct(this.pixelsToPercentage(s),0,100);},initialEvent:t}));}handleKeyDown(t){if(!this.disabled&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End","Enter"].includes(t.key)){let r=this.position,e=(t.shiftKey?10:1)*(this.primary==="end"?-1:1);if(t.preventDefault(),(t.key==="ArrowLeft"&&!this.vertical||t.key==="ArrowUp"&&this.vertical)&&(r-=e),(t.key==="ArrowRight"&&!this.vertical||t.key==="ArrowDown"&&this.vertical)&&(r+=e),t.key==="Home"&&(r=this.primary==="end"?100:0),t.key==="End"&&(r=this.primary==="end"?0:100),t.key==="Enter")if(this.isCollapsed)r=this.positionBeforeCollapsing,this.isCollapsed=false;else {let o=this.position;r=0,requestAnimationFrame(()=>{this.isCollapsed=true,this.positionBeforeCollapsing=o;});}this.position=ct(r,0,100);}}handleResize(t){let{width:r,height:e}=t[0].contentRect;this.size=this.vertical?e:r,(isNaN(this.cachedPositionInPixels)||this.position===1/0)&&(this.cachedPositionInPixels=Number(this.getAttribute("position-in-pixels")),this.positionInPixels=Number(this.getAttribute("position-in-pixels")),this.position=this.pixelsToPercentage(this.positionInPixels)),this.primary&&(this.position=this.pixelsToPercentage(this.cachedPositionInPixels));}handlePositionChange(){this.cachedPositionInPixels=this.percentageToPixels(this.position),this.isCollapsed=false,this.positionBeforeCollapsing=0,this.positionInPixels=this.percentageToPixels(this.position),this.emit("sl-reposition");}handlePositionInPixelsChange(){this.position=this.pixelsToPercentage(this.positionInPixels);}handleVerticalChange(){this.detectSize();}render(){let t=this.vertical?"gridTemplateRows":"gridTemplateColumns",r=this.vertical?"gridTemplateColumns":"gridTemplateRows",e=this.localize.dir()==="rtl",o=`
      clamp(
        0%,
        clamp(
          var(--min),
    ...
    `}};Lt.styles=[V,ul];l([$(".divider")],Lt.prototype,"divider",2);l([p({type:Number,reflect:true})],Lt.prototype,"position",2);l([p({attribute:"position-in-pixels",type:Number})],Lt.prototype,"positionInPixels",2);l([p({type:Boolean,reflect:true})],Lt.prototype,"vertical",2);l([p({type:Boolean,reflect:true})],Lt.prototype,"disabled",2);l([p()],Lt.prototype,"primary",2);l([p({reflect:true})],Lt.prototype,"snap",1);l([p({type:Number,attribute:"snap-threshold"})],Lt.prototype,"snapThreshold",2);l([A("position")],Lt.prototype,"handlePositionChange",1);l([A("positionInPixels")],Lt.prototype,"handlePositionInPixelsChange",1);l([A("vertical")],Lt.prototype,"handleVerticalChange",1);Lt.define("sl-split-panel");se.define("sl-tag");exports.AutoFieldList=class Ze extends R{constructor(){super(...arguments);this.selection=[];this.valueKey="id";this.labelKey="label";this.items=[];this.scrollbar=new Ie(this);this.scrollbars=[];this.selectedTips="";}getInitialOptions(){return {valueKey:"value",labelKey:"label",multiple:false,maxItems:0,minItems:0,showResults:false,itemTemplate:void 0,select:[]}}_createScrollbars(){this.shadowRoot?.querySelectorAll("sl-menu,.results")?.forEach(o=>{this.scrollbars.push(this.scrollbar.create(o,{width:"5px"}));});}_destoryScrollbars(){this.scrollbars?.forEach(e=>{e.destroy();});}connectedCallback(){if(super.connectedCallback(),this.options){this.valueKey=this.options.valueKey,this.labelKey=this.options.labelKey;let e=this.options.select;e&&(this.items=e,this.items.forEach(o=>{this.isItemSelected(o)&&this.selection.push(o[this.valueKey]);})),this.setPresetActions();}this.style.height="auto";}firstUpdated(){this._createScrollbars();}disconnectedCallback(){super.disconnectedCallback(),this._destoryScrollbars();}isItemSelected(e){return this.value===void 0?false:this.options.multiple===false?this.value===e[this.valueKey]:this.value.includes(e[this.valueKey])}_addSecectItem(e){this.selection.findIndex(i=>i[this.valueKey]===e[this.valueKey])===-1&&(this.options.multiple===false&&this.selection.length>0&&this.selection.splice(0,this.selection.length),this.selection.push(e[this.valueKey]));}_removeSelectItem(e){for(let o=this.selection.length-1;o>=0;o--)this.selection[o]===e&&this.selection.splice(o,1);this.onFieldChange(),this.requestUpdate();}_onSelectItem(e){let o=e.detail.item,i=o.dataset.index,s=this.items[i];s&&(o.checked?this._addSecectItem(s):this._removeSelectItem(s[this.valueKey]),this.selectedTips=`${this.selection.length}/${this.items.length}`,this.onFieldChange());}_renderWithSplitPanel(e){return this.options.showResults?u`<sl-split-panel position="60"> ${e} ${this.renderResults()} </sl-split-panel>`:e}_renderItem(e){let o=this.options.renderItem;return typeof o=="string"?u`${Ot(o.replace(/\{(.+?)\}/g,(i,s)=>e[s]))}`:typeof o=="function"?u`${Ot(o(e))}`:e.label}_onClickPresetAction(e){e==="all"?this.selection=this.items.map(o=>o[this.valueKey]):e==="reverse"?this.selection=this.items.filter(o=>!this.selection.includes(o[this.valueKey])).map(o=>o[this.valueKey]):e==="clear"&&(this.selection=[]),this.onFieldChange(),this.requestUpdate();}setPresetActions(){let e=[{id:"all",label:"\u5168\u9009",onClick:()=>this._onClickPresetAction("all")},{id:"reverse",label:"\u53CD\u9009",onClick:()=>this._onClickPresetAction("reverse")},{id:"clear",label:"\u6E05\u7A7A",onClick:()=>this._onClickPresetAction("clear")}],o=i=>{for(let s=e.length-1;s>=0;s--)if(e[s].id===i.id){let n=i.onClick;i.onClick=()=>{e[s].onClick(),n&&n.call(this,this.getInputValue());},e.splice(s,1);}};this.beforeActions&&this.beforeActions.length>0&&this.beforeActions.forEach(i=>{o(i);}),this.afterActions&&this.afterActions.length>0&&this.afterActions.forEach(i=>{o(i);}),e.length>0&&(this.afterActions||(this.beforeActions=[]),this.afterActions.splice(0,0,...e));}getInputValue(){return this.options.multiple?this.selection:this.selection.length>0?this.selection[0]:void 0}getShowLabel(e){let o=this.options.labelKey;if(o){if(o in e)return e[o]}else return e.label}renderResults(){return u`<div
        ...
        >
            ${et(this.items,(o,i)=>{let s=e.includes(o[this.valueKey]);return u`<sl-menu-item type="checkbox" data-index=${String(i)} .checked=${s}>
        ...
        `],v([k()],exports.AutoFieldList.prototype,"selectedTips",2),v([$("sl-menu")],exports.AutoFieldList.prototype,"menu",2),exports.AutoFieldList=v([I("auto-field-list")],exports.AutoFieldList);var ml=y`
  :host {
    display: inline-block;
  }
`;var fl=null,wi=class{};wi.render=function(t,r){fl(t,r);};self.QrCreator=wi;(function(t){function r(c,a,h,m){var d={},f=t(h,a);f.u(c),f.J(),m=m||0;var g=f.h(),b=f.h()+2*m;return d.text=c,d.level=a,d.version=h,d.O=b,d.a=function(x,T){return x-=m,T-=m,0>x||x>=g||0>T||T>=g?false:f.a(x,T)},d}function e(c,a,h,m,d,f,g,b,x,T){function E(S,O,_,C,M,H,U){S?(c.lineTo(O+H,_+U),c.arcTo(O,_,C,M,f)):c.lineTo(O,_);}g?c.moveTo(a+f,h):c.moveTo(a,h),E(b,m,h,m,d,-f,0),E(x,m,d,a,d,0,-f),E(T,a,d,a,h,f,0),E(g,a,h,m,h,0,f);}function o(c,a,h,m,d,f,g,b,x,T){function E(S,O,_,C){c.moveTo(S+_,O),c.lineTo(S,O),c.lineTo(S,O+C),c.arcTo(S,O,S+_,O,f);}g&&E(a,h,f,f),b&&E(m,h,-f,f),x&&E(m,d,-f,-f),T&&E(a,d,f,-f);}function i(c,a){var h=a.fill;if(typeof h=="string")c.fillStyle=h;else {var m=h.type,d=h.colorStops;if(h=h.position.map(g=>Math.round(g*a.size)),m==="linear-gradient")var f=c.createLinearGradient.apply(c,h);else if(m==="radial-gradient")f=c.createRadialGradient.apply(c,h);else throw Error("Unsupported fill");d.forEach(([g,b])=>{f.addColorStop(g,b);}),c.fillStyle=f;}}function s(c,a){t:{var h=a.text,m=a.v,d=a.N,f=a.K,g=a.P;for(d=Math.max(1,d||1),f=Math.min(40,f||40);d<=f;d+=1)try{var b=r(h,m,d,g);break t}catch{}b=void 0;}if(!b)return null;for(h=c.getContext("2d"),a.background&&(h.fillStyle=a.background,h.fillRect(a.left,a.top,a.size,a.size)),m=b.O,f=a.size/m,h.beginPath(),g=0;g<m;g+=1)for(d=0;d<m;d+=1){var x=h,T=a.left+d*f,E=a.top+g*f,S=g,O=d,_=b.a,C=T+f,M=E+f,H=S-1,U=S+1,D=O-1,P=O+1,pt=Math.floor(Math.min(.5,Math.max(0,a.R))*f),st=_(S,O),_t=_(H,D),Ct=_(H,O);H=_(H,P);var wt=_(S,P);P=_(U,P),O=_(U,O),U=_(U,D),S=_(S,D),T=Math.round(T),E=Math.round(E),C=Math.round(C),M=Math.round(M),st?e(x,T,E,C,M,pt,!Ct&&!S,!Ct&&!wt,!O&&!wt,!O&&!S):o(x,T,E,C,M,pt,Ct&&S&&_t,Ct&&wt&&H,O&&wt&&P,O&&S&&U);}return i(h,a),h.fill(),c}var n={minVersion:1,maxVersion:40,ecLevel:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",radius:.5,quiet:0};fl=function(c,a){var h={};Object.assign(h,n,c),h.N=h.minVersion,h.K=h.maxVersion,h.v=h.ecLevel,h.left=h.left,h.top=h.top,h.size=h.size,h.fill=h.fill,h.background=h.background,h.text=h.text,h.R=h.radius,h.P=h.quiet,a instanceof HTMLCanvasElement?((a.width!==h.size||a.height!==h.size)&&(a.width=h.size,a.height=h.size),a.getContext("2d").clearRect(0,0,a.width,a.height),s(a,h)):(c=document.createElement("canvas"),c.width=h.size,c.height=h.size,h=s(c,h),a.appendChild(h));};})(function(){function t(a){var h=e.s(a);return {S:function(){return 4},b:function(){return h.length},write:function(m){for(var d=0;d<h.length;d+=1)m.put(h[d],8);}}}function r(){var a=[],h=0,m={B:function(){return a},c:function(d){return (a[Math.floor(d/8)]>>>7-d%8&1)==1},put:function(d,f){for(var g=0;g<f;g+=1)m.m((d>>>f-g-1&1)==1);},f:function(){return h},m:function(d){var f=Math.floor(h/8);a.length<=f&&a.push(0),d&&(a[f]|=128>>>h%8),h+=1;}};return m}function e(a,h){function m(S,O){for(var _=-1;7>=_;_+=1)if(!(-1>=S+_||b<=S+_))for(var C=-1;7>=C;C+=1) -1>=O+C||b<=O+C||(g[S+_][O+C]=0<=_&&6>=_&&(C==0||C==6)||0<=C&&6>=C&&(_==0||_==6)||2<=_&&4>=_&&2<=C&&4>=C);}function d(S,O){for(var _=b=4*a+17,C=Array(_),M=0;M<_;M+=1){C[M]=Array(_);for(var H=0;H<_;H+=1)C[M][H]=null;}for(g=C,m(0,0),m(b-7,0),m(0,b-7),_=s.G(a),C=0;C<_.length;C+=1)for(M=0;M<_.length;M+=1){H=_[C];var U=_[M];if(g[H][U]==null)for(var D=-2;2>=D;D+=1)for(var P=-2;2>=P;P+=1)g[H+D][U+P]=D==-2||D==2||P==-2||P==2||D==0&&P==0;}for(_=8;_<b-8;_+=1)g[_][6]==null&&(g[_][6]=_%2==0);for(_=8;_<b-8;_+=1)g[6][_]==null&&(g[6][_]=_%2==0);for(_=s.w(f<<3|O),C=0;15>C;C+=1)M=!S&&(_>>C&1)==1,g[6>C?C:8>C?C+1:b-15+C][8]=M,g[8][8>C?b-C-1:9>C?15-C:14-C]=M;if(g[b-8][8]=!S,7<=a){for(_=s.A(a),C=0;18>C;C+=1)M=!S&&(_>>C&1)==1,g[Math.floor(C/3)][C%3+b-8-3]=M;for(C=0;18>C;C+=1)M=!S&&(_>>C&1)==1,g[C%3+b-8-3][Math.floor(C/3)]=M;}if(x==null){for(S=c.I(a,f),_=r(),C=0;C<T.length;C+=1)M=T[C],_.put(4,4),_.put(M.b(),s.f(4,a)),M.write(_);for(C=M=0;C<S.length;C+=1)M+=S[C].j;if(_.f()>8*M)throw Error("code length overflow. ("+_.f()+">"+8*M+")");for(_.f()+4<=8*M&&_.put(0,4);_.f()%8!=0;)_.m(false);for(;!(_.f()>=8*M)&&(_.put(236,8),!(_.f()>=8*M));)_.put(17,8);var pt=0;for(M=C=0,H=Array(S.length),U=Array(S.length),D=0;D<S.length;D+=1){var st=S[D].j,_t=S[D].o-st;for(C=Math.max(C,st),M=Math.max(M,_t),H[D]=Array(st),P=0;P<H[D].length;P+=1)H[D][P]=255&_.B()[P+pt];for(pt+=st,P=s.C(_t),st=o(H[D],P.b()-1).l(P),U[D]=Array(P.b()-1),P=0;P<U[D].length;P+=1)_t=P+st.b()-U[D].length,U[D][P]=0<=_t?st.c(_t):0;}for(P=_=0;P<S.length;P+=1)_+=S[P].o;for(_=Array(_),P=pt=0;P<C;P+=1)for(D=0;D<S.length;D+=1)P<H[D].length&&(_[pt]=H[D][P],pt+=1);for(P=0;P<M;P+=1)for(D=0;D<S.length;D+=1)P<U[D].length&&(_[pt]=U[D][P],pt+=1);x=_;}for(S=x,_=-1,C=b-1,M=7,H=0,O=s.F(O),U=b-1;0<U;U-=2)for(U==6&&--U;;){for(D=0;2>D;D+=1)g[C][U-D]==null&&(P=false,H<S.length&&(P=(S[H]>>>M&1)==1),O(C,U-D)&&(P=!P),g[C][U-D]=P,--M,M==-1&&(H+=1,M=7));if(C+=_,0>C||b<=C){C-=_,_=-_;break}}}var f=i[h],g=null,b=0,x=null,T=[],E={u:function(S){S=t(S),T.push(S),x=null;},a:function(S,O){if(0>S||b<=S||0>O||b<=O)throw Error(S+","+O);return g[S][O]},h:function(){return b},J:function(){for(var S=0,O=0,_=0;8>_;_+=1){d(true,_);var C=s.D(E);(_==0||S>C)&&(S=C,O=_);}d(false,O);}};return E}function o(a,h){if(typeof a.length>"u")throw Error(a.length+"/"+h);var m=function(){for(var f=0;f<a.length&&a[f]==0;)f+=1;for(var g=Array(a.length-f+h),b=0;b<a.length-f;b+=1)g[b]=a[b+f];return g}(),d={c:function(f){return m[f]},b:function(){return m.length},multiply:function(f){for(var g=Array(d.b()+f.b()-1),b=0;b<d.b();b+=1)for(var x=0;x<f.b();x+=1)g[b+x]^=n.i(n.g(d.c(b))+n.g(f.c(x)));return o(g,0)},l:function(f){if(0>d.b()-f.b())return d;for(var g=n.g(d.c(0))-n.g(f.c(0)),b=Array(d.b()),x=0;x<d.b();x+=1)b[x]=d.c(x);for(x=0;x<f.b();x+=1)b[x]^=n.i(n.g(f.c(x))+g);return o(b,0).l(f)}};return d}e.s=function(a){for(var h=[],m=0;m<a.length;m++){var d=a.charCodeAt(m);128>d?h.push(d):2048>d?h.push(192|d>>6,128|d&63):55296>d||57344<=d?h.push(224|d>>12,128|d>>6&63,128|d&63):(m++,d=65536+((d&1023)<<10|a.charCodeAt(m)&1023),h.push(240|d>>18,128|d>>12&63,128|d>>6&63,128|d&63));}return h};var i={L:1,M:0,Q:3,H:2},s=function(){function a(d){for(var f=0;d!=0;)f+=1,d>>>=1;return f}var h=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],m={w:function(d){for(var f=d<<10;0<=a(f)-a(1335);)f^=1335<<a(f)-a(1335);return (d<<10|f)^21522},A:function(d){for(var f=d<<12;0<=a(f)-a(7973);)f^=7973<<a(f)-a(7973);return d<<12|f},G:function(d){return h[d-1]},F:function(d){switch(d){case 0:return function(f,g){return (f+g)%2==0};case 1:return function(f){return f%2==0};case 2:return function(f,g){return g%3==0};case 3:return function(f,g){return (f+g)%3==0};case 4:return function(f,g){return (Math.floor(f/2)+Math.floor(g/3))%2==0};case 5:return function(f,g){return f*g%2+f*g%3==0};case 6:return function(f,g){return (f*g%2+f*g%3)%2==0};case 7:return function(f,g){return (f*g%3+(f+g)%2)%2==0};default:throw Error("bad maskPattern:"+d)}},C:function(d){for(var f=o([1],0),g=0;g<d;g+=1)f=f.multiply(o([1,n.i(g)],0));return f},f:function(d,f){if(d!=4||1>f||40<f)throw Error("mode: "+d+"; type: "+f);return 10>f?8:16},D:function(d){for(var f=d.h(),g=0,b=0;b<f;b+=1)for(var x=0;x<f;x+=1){for(var T=0,E=d.a(b,x),S=-1;1>=S;S+=1)if(!(0>b+S||f<=b+S))for(var O=-1;1>=O;O+=1)0>x+O||f<=x+O||(S!=0||O!=0)&&E==d.a(b+S,x+O)&&(T+=1);5<T&&(g+=3+T-5);}for(b=0;b<f-1;b+=1)for(x=0;x<f-1;x+=1)T=0,d.a(b,x)&&(T+=1),d.a(b+1,x)&&(T+=1),d.a(b,x+1)&&(T+=1),d.a(b+1,x+1)&&(T+=1),(T==0||T==4)&&(g+=3);for(b=0;b<f;b+=1)for(x=0;x<f-6;x+=1)d.a(b,x)&&!d.a(b,x+1)&&d.a(b,x+2)&&d.a(b,x+3)&&d.a(b,x+4)&&!d.a(b,x+5)&&d.a(b,x+6)&&(g+=40);for(x=0;x<f;x+=1)for(b=0;b<f-6;b+=1)d.a(b,x)&&!d.a(b+1,x)&&d.a(b+2,x)&&d.a(b+3,x)&&d.a(b+4,x)&&!d.a(b+5,x)&&d.a(b+6,x)&&(g+=40);for(x=T=0;x<f;x+=1)for(b=0;b<f;b+=1)d.a(b,x)&&(T+=1);return g+=Math.abs(100*T/f/f-50)/5*10}};return m}(),n=function(){for(var a=Array(256),h=Array(256),m=0;8>m;m+=1)a[m]=1<<m;for(m=8;256>m;m+=1)a[m]=a[m-4]^a[m-5]^a[m-6]^a[m-8];for(m=0;255>m;m+=1)h[a[m]]=m;return {g:function(d){if(1>d)throw Error("glog("+d+")");return h[d]},i:function(d){for(;0>d;)d+=255;for(;256<=d;)d-=255;return a[d]}}}(),c=function(){function a(d,f){switch(f){case i.L:return h[4*(d-1)];case i.M:return h[4*(d-1)+1];case i.Q:return h[4*(d-1)+2];case i.H:return h[4*(d-1)+3]}}var h=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],m={I:function(d,f){var g=a(d,f);if(typeof g>"u")throw Error("bad rs block @ typeNumber:"+d+"/errorCorrectLevel:"+f);d=g.length/3,f=[];for(var b=0;b<d;b+=1)for(var x=g[3*b],T=g[3*b+1],E=g[3*b+2],S=0;S<x;S+=1){var O=E,_={};_.o=T,_.j=O,f.push(_);}return f}};return m}();return e}());var gl=QrCreator;var Yt=class extends L{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H";}firstUpdated(){this.generate();}generate(){this.hasUpdated&&gl.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:this.background,size:this.size*2},this.canvas);}render(){var t;return u`
      <canvas
        part="base"
        class="qr-code"
        role="img"
      ...
      ></canvas>
    `}};Yt.styles=[V,ml];l([$("canvas")],Yt.prototype,"canvas",2);l([p()],Yt.prototype,"value",2);l([p()],Yt.prototype,"label",2);l([p({type:Number})],Yt.prototype,"size",2);l([p()],Yt.prototype,"fill",2);l([p()],Yt.prototype,"background",2);l([p({type:Number})],Yt.prototype,"radius",2);l([p({attribute:"error-correction"})],Yt.prototype,"errorCorrection",2);l([A(["background","errorCorrection","fill","radius","size","value"])],Yt.prototype,"generate",1);Yt.define("sl-qr-code");exports.AutoFieldQRCode=class Si extends R{getInitialOptions(){return {fill:"black",background:"white",radius:0,errorCorrection:"L",size:64}}renderInput(){return u`
            <sl-qr-code
                slot="value"
                name=${this.name}
                data-path=${this.path}
...
`;var rt=class Es extends L{constructor(){super(...arguments),this.localize=new W(this),this.indeterminate=false,this.isLeaf=false,this.loading=false,this.selectable=false,this.expanded=false,this.selected=false,this.disabled=false,this.lazy=false;}static isTreeItem(r){return r instanceof Element&&r.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children");}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange();}async animateCollapse(){this.emit("sl-collapse"),await Kt(this.childrenContainer);let{keyframes:r,options:e}=Ut(this,"tree-item.collapse",{dir:this.localize.dir()});await qt(this.childrenContainer,$r(r,this.childrenContainer.scrollHeight),e),this.childrenContainer.hidden=true,this.emit("sl-after-collapse");}isNestedItem(){let r=this.parentElement;return !!r&&Es.isTreeItem(r)}handleChildrenSlotChange(){this.loading=false,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0;}willUpdate(r){r.has("selected")&&!r.has("indeterminate")&&(this.indeterminate=false);}async animateExpand(){this.emit("sl-expand"),await Kt(this.childrenContainer),this.childrenContainer.hidden=false;let{keyframes:r,options:e}=Ut(this,"tree-item.expand",{dir:this.localize.dir()});await qt(this.childrenContainer,$r(r,this.childrenContainer.scrollHeight),e),this.childrenContainer.style.height="auto",this.emit("sl-after-expand");}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand();}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false");}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false");}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false");}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=true,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse();}handleLazyChange(){this.emit("sl-lazy-change");}getChildrenItems({includeDisabled:r=true}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:true})].filter(e=>Es.isTreeItem(e)&&(r||!e.disabled)):[]}render(){let r=this.localize.dir()==="rtl",e=!this.loading&&(!this.isLeaf||this.lazy);return u`
      <div
        part="base"
    ...
    `}};rt.styles=[V,bl];rt.dependencies={"sl-checkbox":ot,"sl-icon":q,"sl-spinner":ve};l([k()],rt.prototype,"indeterminate",2);l([k()],rt.prototype,"isLeaf",2);l([k()],rt.prototype,"loading",2);l([k()],rt.prototype,"selectable",2);l([p({type:Boolean,reflect:true})],rt.prototype,"expanded",2);l([p({type:Boolean,reflect:true})],rt.prototype,"selected",2);l([p({type:Boolean,reflect:true})],rt.prototype,"disabled",2);l([p({type:Boolean,reflect:true})],rt.prototype,"lazy",2);l([$("slot:not([name])")],rt.prototype,"defaultSlot",2);l([$("slot[name=children]")],rt.prototype,"childrenSlot",2);l([$(".tree-item__item")],rt.prototype,"itemElement",2);l([$(".tree-item__children")],rt.prototype,"childrenContainer",2);l([$(".tree-item__expand-button slot")],rt.prototype,"expandButtonSlot",2);l([A("loading",{waitUntilFirstUpdate:true})],rt.prototype,"handleLoadingChange",1);l([A("disabled")],rt.prototype,"handleDisabledChange",1);l([A("selected")],rt.prototype,"handleSelectedChange",1);l([A("expanded",{waitUntilFirstUpdate:true})],rt.prototype,"handleExpandedChange",1);l([A("expanded",{waitUntilFirstUpdate:true})],rt.prototype,"handleExpandAnimation",1);l([A("lazy",{waitUntilFirstUpdate:true})],rt.prototype,"handleLazyChange",1);var er=rt;Nt("tree-item.expand",{keyframes:[{height:"0",opacity:"0",overflow:"hidden"},{height:"auto",opacity:"1",overflow:"hidden"}],options:{duration:250,easing:"cubic-bezier(0.4, 0.0, 0.2, 1)"}});Nt("tree-item.collapse",{keyframes:[{height:"auto",opacity:"1",overflow:"hidden"},{height:"0",opacity:"0",overflow:"hidden"}],options:{duration:200,easing:"cubic-bezier(0.4, 0.0, 0.2, 1)"}});var vl=y`
  :host {
    /*
...
`;function yl(t,r=false){function e(s){let n=s.getChildrenItems({includeDisabled:false});if(n.length){let c=n.every(h=>h.selected),a=n.every(h=>!h.selected&&!h.indeterminate);s.selected=c,s.indeterminate=!c&&!a;}}function o(s){let n=s.parentElement;er.isTreeItem(n)&&(e(n),o(n));}function i(s){for(let n of s.getChildrenItems())n.selected=r?s.selected||n.selected:!n.disabled&&s.selected,i(n);r&&e(s);}i(t),o(t);}var Le=class extends L{constructor(){super(),this.selection="single",this.clickTarget=null,this.localize=new W(this),this.initTreeItem=t=>{t.selectable=this.selection==="multiple",["expand","collapse"].filter(r=>!!this.querySelector(`[slot="${r}-icon"]`)).forEach(r=>{let e=t.querySelector(`[slot="${r}-icon"]`),o=this.getExpandButtonIcon(r);o&&(e===null?t.append(o):e.hasAttribute("data-default")&&e.replaceWith(o));});},this.handleTreeChanged=t=>{for(let r of t){let e=[...r.addedNodes].filter(er.isTreeItem),o=[...r.removedNodes].filter(er.isTreeItem);e.forEach(this.initTreeItem),this.lastFocusedItem&&o.includes(this.lastFocusedItem)&&(this.lastFocusedItem=null);}},this.handleFocusOut=t=>{let r=t.relatedTarget;(!r||!this.contains(r))&&(this.tabIndex=0);},this.handleFocusIn=t=>{let r=t.target;t.target===this&&this.focusItem(this.lastFocusedItem||this.getAllTreeItems()[0]),er.isTreeItem(r)&&!r.disabled&&(this.lastFocusedItem&&(this.lastFocusedItem.tabIndex=-1),this.lastFocusedItem=r,this.tabIndex=-1,r.tabIndex=0);},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut),this.addEventListener("sl-lazy-change",this.handleSlotChange);}async connectedCallback(){super.connectedCallback(),this.setAttribute("role","tree"),this.setAttribute("tabindex","0"),await this.updateComplete,this.mutationObserver=new MutationObserver(this.handleTreeChanged),this.mutationObserver.observe(this,{childList:true,subtree:true});}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.mutationObserver)==null||t.disconnect();}getExpandButtonIcon(t){let e=(t==="expand"?this.expandedIconSlot:this.collapsedIconSlot).assignedElements({flatten:true})[0];if(e){let o=e.cloneNode(true);return [o,...o.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),o.setAttribute("data-default",""),o.slot=`${t}-icon`,o}return null}selectItem(t){let r=[...this.selectedItems];if(this.selection==="multiple")t.selected=!t.selected,t.lazy&&(t.expanded=true),yl(t);else if(this.selection==="single"||t.isLeaf){let o=this.getAllTreeItems();for(let i of o)i.selected=i===t;}else this.selection==="leaf"&&(t.expanded=!t.expanded);let e=this.selectedItems;(r.length!==e.length||e.some(o=>!r.includes(o)))&&Promise.all(e.map(o=>o.updateComplete)).then(()=>{this.emit("sl-selection-change",{detail:{selection:e}});});}getAllTreeItems(){return [...this.querySelectorAll("sl-tree-item")]}focusItem(t){t?.focus();}handleKeyDown(t){if(!["ArrowDown","ArrowUp","ArrowRight","ArrowLeft","Home","End","Enter"," "].includes(t.key)||t.composedPath().some(i=>{var s;return ["input","textarea"].includes((s=i?.tagName)==null?void 0:s.toLowerCase())}))return;let r=this.getFocusableItems(),e=this.localize.dir()==="ltr",o=this.localize.dir()==="rtl";if(r.length>0){t.preventDefault();let i=r.findIndex(a=>a.matches(":focus")),s=r[i],n=a=>{let h=r[ct(a,0,r.length-1)];this.focusItem(h);},c=a=>{s.expanded=a;};t.key==="ArrowDown"?n(i+1):t.key==="ArrowUp"?n(i-1):e&&t.key==="ArrowRight"||o&&t.key==="ArrowLeft"?!s||s.disabled||s.expanded||s.isLeaf&&!s.lazy?n(i+1):c(true):e&&t.key==="ArrowLeft"||o&&t.key==="ArrowRight"?!s||s.disabled||s.isLeaf||!s.expanded?n(i-1):c(false):t.key==="Home"?n(0):t.key==="End"?n(r.length-1):(t.key==="Enter"||t.key===" ")&&(s.disabled||this.selectItem(s));}}handleClick(t){let r=t.target,e=r.closest("sl-tree-item"),o=t.composedPath().some(i=>{var s;return (s=i?.classList)==null?void 0:s.contains("tree-item__expand-button")});!e||e.disabled||r!==this.clickTarget||(o?e.expanded=!e.expanded:this.selectItem(e));}handleMouseDown(t){this.clickTarget=t.target;}handleSlotChange(){this.getAllTreeItems().forEach(this.initTreeItem);}async handleSelectionChange(){let t=this.selection==="multiple",r=this.getAllTreeItems();this.setAttribute("aria-multiselectable",t?"true":"false");for(let e of r)e.selectable=t;t&&(await this.updateComplete,[...this.querySelectorAll(":scope > sl-tree-item")].forEach(e=>yl(e,true)));}get selectedItems(){let t=this.getAllTreeItems(),r=e=>e.selected;return t.filter(r)}getFocusableItems(){let t=this.getAllTreeItems(),r=new Set;return t.filter(e=>{var o;if(e.disabled)return  false;let i=(o=e.parentElement)==null?void 0:o.closest("[role=treeitem]");return i&&(!i.expanded||i.loading||r.has(i))&&r.add(e),!r.has(e)})}render(){return u`
      <div
        part="base"
        class="tree"
        @click=${this.handleClick}
    ...
    `}};Le.styles=[V,vl];l([$("slot:not([name])")],Le.prototype,"defaultSlot",2);l([$("slot[name=expand-icon]")],Le.prototype,"expandedIconSlot",2);l([$("slot[name=collapse-icon]")],Le.prototype,"collapsedIconSlot",2);l([p()],Le.prototype,"selection",2);l([A("selection")],Le.prototype,"handleSelectionChange",1);Le.define("sl-tree");er.define("sl-tree-item");exports.AutoFieldTreeSelect=class Ve extends R{constructor(){super(...arguments);this.nodes={};this.selection=[];this.idKey="id";this.valueKey="id";this.labelKey="label";}getInitialOptions(){return {items:[],idKey:"id",valueKey:"id",labelKey:"label",multiple:false,maxItems:0,minItems:0,onlySelectLeaf:false,showAsPath:false,onSelectionChange:()=>{}}}connectedCallback(){if(super.connectedCallback(),this.options){this.idKey=this.options.idKey,this.valueKey=this.options.valueKey,this.labelKey=this.options.labelKey;let e=this.options.items;e&&(this.nodes=e,this._forEachTree((o,i,s,n)=>{s<1&&o.expanded===void 0&&(o.expanded=true),this.isItemSelected(o)&&(o.selected=true,this.selection.push({id:o[this.idKey],value:o[this.valueKey],path:n.join("/")}));}));}}isItemSelected(e){return this.value===void 0?false:this.options.multiple===false?this.value===e[this.valueKey]:this.value.includes(e[this.valueKey])}getStateValue(){let e=super.getStateValue();return this.options.multiple?Array.isArray(e)?e:[e]:e}_forEachTree(e){let o=(s,n,c,a)=>{let h=[...a,s[this.labelKey]];if(e(s,n,c,h),s.children){let m=c+1;s.children.forEach(d=>{o(d,s,m,[...h]);});}};(Array.isArray(this.nodes)?this.nodes:[this.nodes]).forEach(s=>{o(s,void 0,0,[]);});}onSelectionChange(e){let o=Array.from(e.detail.selection);o&&(this.selection=o.map(i=>({id:i.dataset.id,value:i.dataset.value,path:i.dataset.path})),this.options&&typeof this.options.onSelectionChange=="function"&&this.options.onSelectionChange(this.selection),this.onFieldChange());}getInputValue(){return this.options.multiple?this.selection.map(e=>e.value):this.selection.length>0?this.selection[0].value:void 0}_renderNode(e,o,i){let s=o.includes(e[this.valueKey]),n=[...i,e[this.labelKey]];return u`<sl-tree-item
        ...
        `],v([$(".selection>.select-value")],exports.AutoFieldCombine.prototype,"selection",2),exports.AutoFieldCombine=v([I("auto-field-combine")],exports.AutoFieldCombine);var xp=["help","error","email","search","lock","user","globe","date","time","phone","copy","remove","refresh","datetime"];exports.AutoFieldIcons=class or extends Et{constructor(){super(...arguments);this.active=false;this.selected=[];this.icons=[];}getInitialOptions(){return {icons:[],size:"24px",multiple:false,dropdown:false,builtIn:true}}connectedCallback(){super.connectedCallback(),this.icons=Array.isArray(this.options.icons)?this.options.icons:this.options.icons.split(","),this.options.builtIn&&xp.forEach(e=>{this.icons.includes(e)||this.icons.push(e);}),this.selected=Array.isArray(this.value)?this.value:this.value.split(",");}renderView(){return this.renderIcons(this.selected)}_isSelected(e){return this.options.multiple?this.selected.includes(e):this.selected[0]===e}_onClickIcon(e){if(!this.context.viewonly)if(this.options.multiple){let o=this.selected.findIndex(i=>i===e);o>-1?this.selected.splice(o,1):this.selected.push(e),this.onFieldInput();}else this.selected.length===0?this.selected.push(e):this.selected[0]=e,this.onFieldInput();}getInputValue(){return this.options.multiple?this.selected:this.selected[0]}renderIcons(e,o=true){return u`<div class="icons" style="font-size:${this.options.size}">
            ${et(e,i=>{if(i!=="")return u`<span class="icon ${o&&this._isSelected(i)?"selected":void 0}" title="${i}" @click=${()=>this._onClickIcon(i)}
        ...
        `}renderDropdown(){let e=this.data[this.options.rootKey],o=this.focusItems;return u`<div class="levels">
            ${et(Array.from({length:this.options.maxLevel}),(i,s)=>{if(s===0)return this._renderLevel(e,s+1,this.options.rootKey);{let n=o[s-1],c=this.data[n];return c?this._renderLevel(c,s+1,n):this._renderLevel([],s+1,n)}})}
        </div>`}};exports.AutoFieldCascader.styles=[R.styles,Et.styles,Ie.styles,y`
            .levels {
                display: flex;
                flex-direction: row;
        ...
        `],v([cn("sl-input")],exports.AutoFieldDateRange.prototype,"inputs",2),exports.AutoFieldDateRange=v([I("auto-field-date-range")],exports.AutoFieldDateRange);var _l=y`
  :host {
    display: inline-block;
  }
...
`;var _p=0,Xt=class extends L{constructor(){super(...arguments),this.localize=new W(this),this.attrId=++_p,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=false,this.closable=false,this.disabled=false,this.tabIndex=0;}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab");}handleCloseClick(t){t.stopPropagation(),this.emit("sl-close");}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false");}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0;}render(){return this.id=this.id.length>0?this.id:this.componentId,u`
      <div
        part="base"
    ...
    `}};Xt.styles=[V,_l];Xt.dependencies={"sl-icon-button":lt};l([$(".tab")],Xt.prototype,"tab",2);l([p({reflect:true})],Xt.prototype,"panel",2);l([p({type:Boolean,reflect:true})],Xt.prototype,"active",2);l([p({type:Boolean,reflect:true})],Xt.prototype,"closable",2);l([p({type:Boolean,reflect:true})],Xt.prototype,"disabled",2);l([p({type:Number,reflect:true})],Xt.prototype,"tabIndex",2);l([A("active")],Xt.prototype,"handleActiveChange",1);l([A("disabled")],Xt.prototype,"handleDisabledChange",1);Xt.define("sl-tab");var wl=y`
  :host {
    --indicator-color: var(--sl-color-primary-600);
...
`;var wo=class extends L{constructor(){super(...arguments),this.observedElements=[],this.disabled=false;}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>{this.emit("sl-resize",{detail:{entries:t}});}),this.disabled||this.startObserver();}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver();}handleSlotChange(){this.disabled||this.startObserver();}startObserver(){let t=this.shadowRoot.querySelector("slot");if(t!==null){let r=t.assignedElements({flatten:true});this.observedElements.forEach(e=>this.resizeObserver.unobserve(e)),this.observedElements=[],r.forEach(e=>{this.resizeObserver.observe(e),this.observedElements.push(e);});}}stopObserver(){this.resizeObserver.disconnect();}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver();}render(){return u` <slot @slotchange=${this.handleSlotChange}></slot> `}};wo.styles=[V,Sl];l([p({type:Boolean,reflect:true})],wo.prototype,"disabled",2);l([A("disabled",{waitUntilFirstUpdate:true})],wo.prototype,"handleDisabledChange",1);var gt=class extends L{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new W(this),this.hasScrollControls=false,this.shouldHideScrollStartButton=false,this.shouldHideScrollEndButton=false,this.placement="top",this.activation="auto",this.noScrollControls=false,this.fixedScrollControls=false,this.scrollOffset=1;}connectedCallback(){let t=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls();}),this.mutationObserver=new MutationObserver(r=>{let e=r.filter(({target:o})=>{if(o===this)return  true;if(o.closest("sl-tab-group")!==this)return  false;let i=o.tagName.toLowerCase();return i==="sl-tab"||i==="sl-tab-panel"});if(e.length!==0){if(e.some(o=>!["aria-labelledby","aria-controls"].includes(o.attributeName))&&setTimeout(()=>this.setAriaLabels()),e.some(o=>o.attributeName==="disabled"))this.syncTabsAndPanels();else if(e.some(o=>o.attributeName==="active")){let i=e.filter(s=>s.attributeName==="active"&&s.target.tagName.toLowerCase()==="sl-tab").map(s=>s.target).find(s=>s.active);i&&this.setActiveTab(i);}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:true,attributeFilter:["active","disabled","name","panel"],childList:true,subtree:true}),this.resizeObserver.observe(this.nav),t.then(()=>{new IntersectionObserver((e,o)=>{var i;e[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab((i=this.getActiveTab())!=null?i:this.tabs[0],{emitEvents:false}),o.unobserve(e[0].target));}).observe(this.tabGroup);});});}disconnectedCallback(){var t,r;super.disconnectedCallback(),(t=this.mutationObserver)==null||t.disconnect(),this.nav&&((r=this.resizeObserver)==null||r.unobserve(this.nav));}getAllTabs(){return this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()}getAllPanels(){return [...this.body.assignedElements()].filter(t=>t.tagName.toLowerCase()==="sl-tab-panel")}getActiveTab(){return this.tabs.find(t=>t.active)}handleClick(t){let e=t.target.closest("sl-tab");e?.closest("sl-tab-group")===this&&e!==null&&this.setActiveTab(e,{scrollBehavior:"smooth"});}handleKeyDown(t){let e=t.target.closest("sl-tab");if(e?.closest("sl-tab-group")===this&&(["Enter"," "].includes(t.key)&&e!==null&&(this.setActiveTab(e,{scrollBehavior:"smooth"}),t.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(t.key))){let i=this.tabs.find(c=>c.matches(":focus")),s=this.localize.dir()==="rtl",n=null;if(i?.tagName.toLowerCase()==="sl-tab"){if(t.key==="Home")n=this.focusableTabs[0];else if(t.key==="End")n=this.focusableTabs[this.focusableTabs.length-1];else if(["top","bottom"].includes(this.placement)&&t.key===(s?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&t.key==="ArrowUp"){let c=this.tabs.findIndex(a=>a===i);n=this.findNextFocusableTab(c,"backward");}else if(["top","bottom"].includes(this.placement)&&t.key===(s?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&t.key==="ArrowDown"){let c=this.tabs.findIndex(a=>a===i);n=this.findNextFocusableTab(c,"forward");}if(!n)return;n.tabIndex=0,n.focus({preventScroll:true}),this.activation==="auto"?this.setActiveTab(n,{scrollBehavior:"smooth"}):this.tabs.forEach(c=>{c.tabIndex=c===n?0:-1;}),["top","bottom"].includes(this.placement)&&io(n,this.nav,"horizontal"),t.preventDefault();}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"});}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"});}setActiveTab(t,r){if(r=St({emitEvents:true,scrollBehavior:"auto"},r),t!==this.activeTab&&!t.disabled){let e=this.activeTab;this.activeTab=t,this.tabs.forEach(o=>{o.active=o===this.activeTab,o.tabIndex=o===this.activeTab?0:-1;}),this.panels.forEach(o=>{var i;return o.active=o.name===((i=this.activeTab)==null?void 0:i.panel)}),this.syncIndicator(),["top","bottom"].includes(this.placement)&&io(this.activeTab,this.nav,"horizontal",r.scrollBehavior),r.emitEvents&&(e&&this.emit("sl-tab-hide",{detail:{name:e.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}));}}setAriaLabels(){this.tabs.forEach(t=>{let r=this.panels.find(e=>e.name===t.panel);r&&(t.setAttribute("aria-controls",r.getAttribute("id")),r.setAttribute("aria-labelledby",t.getAttribute("id")));});}repositionIndicator(){let t=this.getActiveTab();if(!t)return;let r=t.clientWidth,e=t.clientHeight,o=this.localize.dir()==="rtl",i=this.getAllTabs(),n=i.slice(0,i.indexOf(t)).reduce((c,a)=>({left:c.left+a.clientWidth,top:c.top+a.clientHeight}),{left:0,top:0});switch(this.placement){case "top":case "bottom":this.indicator.style.width=`${r}px`,this.indicator.style.height="auto",this.indicator.style.translate=o?`${ -1*n.left}px`:`${n.left}px`;break;case "start":case "end":this.indicator.style.width="auto",this.indicator.style.height=`${e}px`,this.indicator.style.translate=`0 ${n.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(t=>!t.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls());}findNextFocusableTab(t,r){let e=null,o=r==="forward"?1:-1,i=t+o;for(;t<this.tabs.length;){if(e=this.tabs[i]||null,e===null){r==="forward"?e=this.focusableTabs[0]:e=this.focusableTabs[this.focusableTabs.length-1];break}if(!e.disabled)break;i+=o;}return e}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd());}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=false:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons();}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none";}show(t){let r=this.tabs.find(e=>e.panel===t);r&&this.setActiveTab(r,{scrollBehavior:"smooth"});}render(){let t=this.localize.dir()==="rtl";return u`
    ...
    `}};gt.styles=[V,wl];gt.dependencies={"sl-icon-button":lt,"sl-resize-observer":wo};l([$(".tab-group")],gt.prototype,"tabGroup",2);l([$(".tab-group__body")],gt.prototype,"body",2);l([$(".tab-group__nav")],gt.prototype,"nav",2);l([$(".tab-group__indicator")],gt.prototype,"indicator",2);l([k()],gt.prototype,"hasScrollControls",2);l([k()],gt.prototype,"shouldHideScrollStartButton",2);l([k()],gt.prototype,"shouldHideScrollEndButton",2);l([p()],gt.prototype,"placement",2);l([p()],gt.prototype,"activation",2);l([p({attribute:"no-scroll-controls",type:Boolean})],gt.prototype,"noScrollControls",2);l([p({attribute:"fixed-scroll-controls",type:Boolean})],gt.prototype,"fixedScrollControls",2);l([Ce({passive:true})],gt.prototype,"updateScrollButtons",1);l([A("noScrollControls",{waitUntilFirstUpdate:true})],gt.prototype,"updateScrollControls",1);l([A("placement",{waitUntilFirstUpdate:true})],gt.prototype,"syncIndicator",1);gt.define("sl-tab-group");var wp=(t,r)=>{let e=0;return function(...o){window.clearTimeout(e),e=window.setTimeout(()=>{t.call(this,...o);},r);}},Cl=(t,r,e)=>{let o=t[r];t[r]=function(...i){o.call(this,...i),e.call(this,o,...i);};};(()=>{if(typeof window>"u")return;if(!("onscrollend"in window)){let r=new Set,e=new WeakMap,o=s=>{for(let n of s.changedTouches)r.add(n.identifier);},i=s=>{for(let n of s.changedTouches)r.delete(n.identifier);};document.addEventListener("touchstart",o,true),document.addEventListener("touchend",i,true),document.addEventListener("touchcancel",i,true),Cl(EventTarget.prototype,"addEventListener",function(s,n){if(n!=="scrollend")return;let c=wp(()=>{r.size?c():this.dispatchEvent(new Event("scrollend"));},100);s.call(this,"scroll",c,{passive:true}),e.set(this,c);}),Cl(EventTarget.prototype,"removeEventListener",function(s,n){if(n!=="scrollend")return;let c=e.get(this);c&&s.call(this,"scroll",c,{passive:true});});}})();var kl=y`
  :host {
    --padding: 0;
...
`;var Sp=0,Ir=class extends L{constructor(){super(...arguments),this.attrId=++Sp,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=false;}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel");}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true");}render(){return u`
      <slot
        part="base"
        class=${z({"tab-panel":true,"tab-panel--active":this.active})}
      ></slot>
    `}};Ir.styles=[V,kl];l([p({reflect:true})],Ir.prototype,"name",2);l([p({type:Boolean,reflect:true})],Ir.prototype,"active",2);l([A("active")],Ir.prototype,"handleActiveChange",1);Ir.define("sl-tab-panel");q.define("sl-icon");var $l=y`
:root,
:host,
.sl-theme-light {
    color-scheme: light;
...
`;var re=class extends ut{constructor(){super();this.forms=[];hr();}static{this.styles=[ki,$i,y`
            :host {
                display: block;
                width: 100%;
                background-color: var(--auto-bgcolor);
        ...
        `}};v([$("slot")],re.prototype,"slotElement",2),v([p()],re.prototype,"active",2),v([k()],re.prototype,"forms",2);exports.AutoFormTabs=class ir extends re{constructor(){super(...arguments);this.direction="top";this.hideLabel=false;}_getPlacement(){return this.direction==="left"?"start":this.direction==="right"?"end":this.direction}renderGroups(){return u`
            <sl-tab-group
        ...
        `}};exports.AutoFormTabs.styles=[re.styles,y`
            auto-form {
                padding: 1.5em;
            }
            sl-tab-group {
        ...
        `],v([p({type:String,reflect:true})],exports.AutoFormTabs.prototype,"direction",2),v([p({type:Boolean,reflect:true})],exports.AutoFormTabs.prototype,"hideLabel",2),exports.AutoFormTabs=v([I("auto-form-tabs")],exports.AutoFormTabs);var El=y`
  :host {
    display: block;
  }
...
`;exports.AutoCollapse=class le extends ut{constructor(){super(...arguments);this.active="";this.accordion=false;this.panels=[];this._activeArray=[];}firstUpdated(){this.panels=this.getPanels();}connectedCallback(){super.connectedCallback(),hr(),this._activeArray=this.active?this.active.split(","):[];}getPanels(){let e=this.shadowRoot.querySelector("slot");return e?e.assignedElements({flatten:true}):[]}updated(e){e.has("active")&&typeof this.active=="string"&&(this._activeArray=this.active?this.active.split(","):[]),super.updated(e);}togglePanel(e){let o=this._activeArray.indexOf(e);if(o===-1)this.accordion?this._activeArray=[e]:this._activeArray=[...this._activeArray,e];else {let i=[...this._activeArray];i.splice(o,1),this._activeArray=i;}this.active=this._activeArray.join(","),this.dispatchEvent(new CustomEvent("change",{detail:{active:this.active}}));}isPanelActive(e){return this._activeArray.includes(e)}_onActionClick(e,o){let i=new CustomEvent("action-click",{detail:{name:e},composed:true,bubbles:true});o.stopPropagation(),this.dispatchEvent(i);}_renderHeaderActions(e){let o=(e.getAttribute("data-actions")||"").split(",");if(o.length>0)return et(o,i=>{let[s,n]=i.split(":");return u`<sl-icon
        ...
        `}};exports.AutoCollapse.styles=[Al],v([p({type:String,reflect:true})],exports.AutoCollapse.prototype,"active",2),v([p({type:String,reflect:true})],exports.AutoCollapse.prototype,"padding",2),v([p({type:Boolean,reflect:true})],exports.AutoCollapse.prototype,"accordion",2),v([k()],exports.AutoCollapse.prototype,"panels",2),v([k()],exports.AutoCollapse.prototype,"_activeArray",2),exports.AutoCollapse=v([I("auto-collapse")],exports.AutoCollapse);exports.AutoFormCollapse=class Pe extends re{constructor(){super(...arguments);this.active="";this.accordion=false;}renderGroups(){return u`
            <auto-collapse
        ...
        `}};exports.AutoFormCollapse.styles=[re.styles,y`
            auto-form {
                padding: 1.5em;
            }
            sl-details {
...
`;var So=class extends L{constructor(){super(...arguments),this.vertical=false;}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator");}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal");}};So.styles=[V,Tl];l([p({type:Boolean,reflect:true})],So.prototype,"vertical",2);l([A("vertical")],So.prototype,"handleVerticalChange",1);So.define("sl-divider");dt.define("sl-dropdown");ve.define("sl-spinner");lt.define("sl-icon-button");function Is(t,r){return t.length>r.length?false:t.every((e,o)=>e===r[o])}(t=>typeof Me<"u"?Me:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof Me<"u"?Me:r)[e]}):t)(function(t){if(typeof Me<"u")return Me.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var it=class it extends ut{constructor(){super(...arguments);this.classs=new Ae(this);this.ctxController=new gr(this);this.seq=++it.seq;this.context={};this.schemas=[];this.validAtInit=false;this.compact=false;this.validAt="lost-focus";this.border="grid";this.size="medium";this.labelPos="top";this.labelWidth="7em";this.dark=false;this.readonly=false;this.viewonly=false;this.viewAlign="right";this.layout="auto";this._loading=false;}static{this.seq=0;}static{this.styles=ki;}get dirty(){return this.context.dirty}get invalid(){return this.context.invalid}connectedCallback(){super.connectedCallback(),hr();}attributeChangedCallback(e,o,i){super.attributeChangedCallback(e,o,i),["group","sort","advanced","path"].includes(e)&&setTimeout(()=>this._load());}_initialContext(){Object.assign(this.context,{store:this.store,form:this,labelPos:this.labelPos,labelWidth:this.labelWidth,viewAlign:this.viewAlign,border:this.border,group:this.group,advanced:this.advanced,dark:this.dark,dirty:false,invalid:this._isValid(),validAtInit:this.validAtInit});}_isValid(){if(this.path){let e=this.store.schemas.errors||{};return Object.keys(e).some(o=>Is(this.path.split("."),o.split(".")))}else return Object.keys(this.store.schemas.errors).length>0}_load(e=true){if(this.store&&!this._loading)try{this._initialContext();let o=this.path?this.store.schemas.find(this.path):Object.values(this.store.schemas.store.state),i=s=>{if(!this.group||["default","general"].includes(this.group)&&s.group===void 0||["","*"].includes(this.group))return !0;let n=(s.group||"").split(","),c=this.group.split(",");return n.some(a=>c.includes(a))};this.schemas=Object.values(o).filter(s=>!(!i(s)||this.advanced===!1&&s.advanced)).sort((s,n)=>(s.order||0)-(n.order||0)),e&&this.requestUpdate();}finally{this._loading=false;}}bind(e){this.store=e,this._load();}clearErrors(){this.store.schemas.errors={},Array.from(this.shadowRoot.querySelectorAll(".fields > *")).forEach(o=>{o.tagName.startsWith("auto-field")&&(o.invalidTips=void 0);}),this.requestUpdate();}_renderFields(){return u` ${this.schemas.map(e=>u`${Ci(e,{attrs:{size:this.size}})}`)}`}render(){return this.classs.use(this.size,{dark:this.context.dark,[`${this.labelPos}-label`]:true,[`view-${this.viewAlign}`]:true,compact:this.compact,dirty:this.context.dirty,invalid:this.invalid}),u`
            <div class="actions header"></div>
            <div class="fields">${this._renderFields()}</div>
            <div class="actions footer"></div>
        `}reset(){this.store?.reset(),this._initialContext(),br(this,"dirty",false),br(this,"invalid",false);}submit(e){if(typeof e=="function"){let o=this.store?.schemas.getValues()||{},i=this.store?.schemas.errors;e(o,i);}}};v([Ji({context:Wo})],it.prototype,"context",2),v([p({type:Boolean,reflect:true})],it.prototype,"validAtInit",2),v([p({type:String,reflect:true})],it.prototype,"group",2),v([p({type:String,reflect:true})],it.prototype,"icon",2),v([p({type:String,reflect:true})],it.prototype,"path",2),v([p({type:Boolean,reflect:true})],it.prototype,"compact",2),v([p({type:Boolean,reflect:true})],it.prototype,"advanced",2),v([p({type:String,reflect:true})],it.prototype,"validAt",2),v([p({type:String,reflect:true})],it.prototype,"border",2),v([p({type:String})],it.prototype,"size",2),v([p({type:String,reflect:true})],it.prototype,"labelPos",2),v([p({type:String,reflect:true})],it.prototype,"labelWidth",2),v([p({type:Boolean,reflect:true})],it.prototype,"dark",2),v([p({type:Boolean,reflect:true})],it.prototype,"readonly",2),v([p({type:Boolean,reflect:true})],it.prototype,"viewonly",2),v([p({type:String,reflect:true})],it.prototype,"viewAlign",2),v([p({type:String,reflect:true})],it.prototype,"layout",2),v([p({type:String,reflect:true})],it.prototype,"icons",2);var zs=it;customElements.get("auto-form")||customElements.define("auto-form",zs);/*! Bundled license information:
...
lit-html/node/directives/ref.js:
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/exports.AutoField=R;exports.AutoForm=zs;return exports;})({});//# sourceMappingURL=index.global.js.map
