...
export type SchemaDateWidgetOptions = Omit<SchemaInputWidgetOptions, 'inputType' | 'maxLength' | 'minLength'>;
export type SchemaDateTimeWidgetOptions = Omit<SchemaInputWidgetOptions, 'inputType' | 'maxLength' | 'minLength'>;

export type SchemaTimeWidgetOptions = Omit<SchemaInputWidgetOptions, 'inputType' | 'min' | 'max' | 'maxLength' | 'minLength' | 'pattern'>;
...
export type SchemaURLWidgetOptions = Omit<SchemaInputWidgetOptions, 'inputType' | 'max' | 'min' | 'pattern'>;
export type SchemaNumberWidgetOptions = Omit<SchemaInputWidgetOptions, 'inputType' | 'maxLength' | 'minLength' | 'pattern'>;
export type SchemaPasswordWidgetOptions = Omit<SchemaInputWidgetOptions, 'inputType' | 'max' | 'min' | 'pattern'> & {
