import { OBSERVER_DESCRIPTOR_BUILDER_FLAG, OBSERVER_TYPE_FLAG } from "../consts";
...
export function watch<Value = any>() {
    ...
    descriptorBuilder[OBSERVER_TYPE_FLAG] = true;
    return descriptorBuilder as unknown as WatchDescriptorBuilder<Value>;
}
