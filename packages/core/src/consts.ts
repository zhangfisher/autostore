...
export const CONFIGURABLE_DESCRIPTOR_FLAG = 'CONFIGURABLE_DESCRIPTOR_FLAG';
export const CONFIGURABLE_DESCRIPTOR_BUILDER_FLAG = '__AS_CONFIGURABLE_DESCRIPTOR_BUILDER_FLAG__';
