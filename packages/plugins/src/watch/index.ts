...
import {installPlugin,AutoStore  } from "autostore";
 ...
 */
export function watchDescriptor(store: AnyAutoStore) {
    store.watchObjects = new WatchObjects(store);
    (AutoStore.observers as any)['watch']=(store: AnyAutoStore, descriptor: AnyObserverDescriptor, context: ObserverContext)=>{
