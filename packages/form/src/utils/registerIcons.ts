...
let iconSourceUrl: string = 'https://cdn.jsdelivr.net/npm/lucide-static@latest/icons/{name}.svg';
...
export function registerIcons(
    url: string = 'https://cdn.jsdelivr.net/npm/lucide-static@latest/icons/{name}.svg',
