...
export type FieldOptions<Options = unknown> = RequiredKeys<
    Omit<SchemaOptions, 'onFail' | 'onValidate' | 'invalidTips'>, // 排除校验相关
    // 一些公共选项
    | 'visible'
    | 'enable'
    | 'required'
