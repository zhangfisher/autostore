...
function parsePadding(padding: string) {
    const result = { top: 0, right: 0, bottom: 0, left: 0, unit: "px" };
...
@customElement("probe-widget-combine-x")
class ProbeWidgetCombineX extends LitElement {
    state = {
        form: {
...
declare global {
    interface HTMLElementTagNameMap {
        "probe-widget-combine-x": ProbeWidgetCombineX;
    }
}
export default ProbeWidgetCombineX;
