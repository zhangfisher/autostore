    ...
    render() {
        return html`
            <div style="display: grid; grid-template-columns: 3fr 2fr; gap: 1.5rem; height: 100%;">
                ...
                <auto-form .state="${this.state}" data-label="日期参数演示" style="min-height: 400px;">
                </auto-form>
...
declare global { interface HTMLElementTagNameMap { "example-widget-date": WidgetDateExample; } }
