 ...
 * 根据选择器获取store中的值
 * 
 * @param {VueAutoStore<State>} store - Vue的自动store对象，包含state
 ...
 */ 
export function getValueBySelector<State extends Dict>(store: VueAutoStore<State>, selector: StateValueSelector<State>, extandAsyncValue?: boolean, setError?: any): any {
